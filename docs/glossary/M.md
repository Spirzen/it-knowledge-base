...
**Microsoft Store** — магазин приложений и игр в Windows (UWP, Xbox, часть обновлений). Удаление Store ломает игровые сервисы и обновления — см. [1.035 / 207 — настройка Windows](/encyclopedia/1-basics/1-035-bazovaya-informatika/207), [GNU/Linux — рабочие столы и споры окружений](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/96). [Неолурк: Microsoft Store](https://neolurk.org/wiki/Microsoft_Store).
