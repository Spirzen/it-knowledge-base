...
<div class="callout callout--warning">
  ...
  Правило <code>requiresSecure()</code> заставит браузер ходить по <code>https://localhost</code>. Для <code>dev</code> вынесите настройку в профиль или отключите канал в <code>application-dev.yml</code>. В prod TLS обязателен на границе сети; см. также заголовок <code>Strict-Transport-Security</code> в [безопасности веб-приложений](./../../2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/116.md).
  </div>
</div>
