...
**Java** — "напиши один раз — запускай везде" на **JVM**: корпоративный бэкенд, большие кодовые базы, Android (исторически). Старт: **JDK**, IDE, класс с `public static void main(String[] args)`.
...
3. Веб: [Spring Boot](./271.md) после базового `main`.
