...
<FirstProgramPlay language="java" />
...
Оба создают **Maven-проект** с одной и той же структурой `src/main/java`. После Hello World логичный шаг — [отладка](./132.md), затем [Spring Boot](./271.md).
...
**IntelliJ IDEA Community** бесплатна и полностью подходит для Java + Maven. Скачивайте с [jetbrains.com/idea](https://www.jetbrains.com/idea/).
...
<InstallerWizardPlay
  appName="Установка JDK"
  productName="OpenJDK / Temurin"
  welcomeText="Мастер установит Java Development Kit. Запомните путь — его укажете в JAVA_HOME и в IDE."
  defaultPath="C:\\Program Files\\Eclipse Adoptium\\jdk-21"
  extraOptionsLabel="Установить переменные JAVA_HOME и обновить PATH"
  cardSubtitle="Шаг 5 в инструкции NetBeans — далее mvn и сборка"
/>
