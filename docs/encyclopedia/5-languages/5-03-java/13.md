...
Оба создают **Maven-проект** с одной и той же структурой `src/main/java`. После Hello World логичный шаг — [ввод и вывод](./102.md) (консоль, `Scanner`), затем [отладка](./132.md); Spring — после Core ([271.md](./271.md)).
