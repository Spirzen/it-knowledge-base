...
<div class="callout callout--info">
  ...
  Ветви <code>Error</code> и <code>Exception</code> отражают разделение «фатальный сбой JVM» и «сбой, который приложение может обработать». Практика <code>try</code> / <code>catch</code> — <a href="./21.md">Обработка исключений в Java</a>; термины — <a href="/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111">ошибки и исключения</a>.
</div>
  </div>
