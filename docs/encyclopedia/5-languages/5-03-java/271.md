...
<div class="callout callout--tip">
  ...
  Слоистый REST API (контроллер, сервис, репозиторий, тесты) по шагам — лабораторный кейс <a href="/lab/Кейсы/4">«Spring Boot приложение»</a>. Архитектурный контекст слоёв — <a href="/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design-patterns/intro">паттерны проектирования</a>; цепочка фильтров и обработчиков — <a href="/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design-patterns/122">Chain of Responsibility в Java</a>.
</div>
  </div>
