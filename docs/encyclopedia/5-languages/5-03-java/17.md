...
<div class="callout callout--tip">
  ...
  Сначала пишите вариант, который проще всего читать через месяц. Для большинства задач это `if-else` и обычный `for`, а не "умные" сокращения. Закрепить циклы на типовых задачах — [Lab — консольные задачи](/lab/Примеры/1131#стартовые-задачи). Следующий шаг с GUI — [Lab — Swing](/lab/Примеры/1143) (конвертер, список задач).
</div>
  </div>
