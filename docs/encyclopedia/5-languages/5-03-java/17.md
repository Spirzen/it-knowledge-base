...
```java
class Данные implements Cloneable {
    private int value;
    private String[] items;
    
    public Данные(int value, String[] items) {
        this.value = value;
        this.items = items;
    }
    ...
    protected Object clone() throws CloneNotSupportedException {
        Данные copy = (Данные) super.clone();
...
Данные original = new Данные(100, new String[]{"a", "b", "c"});
try {
    Данные copy = (Данные) original.clone();
    copy.setValue(200);
    copy.getItems()[0] = "x";
