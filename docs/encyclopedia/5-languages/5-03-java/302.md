...
description: "Теория GC и потоков — в JVM, память и потоки. Здесь — практика: какие команды ввести, когда приложение тормозит, «ест» память или упало с OutOfMemoryError."
  краткий сценарий JFR без перегруза теорией GC.
---
