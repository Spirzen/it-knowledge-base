...
public class NativeExample {
    ...
    static {
        ...
        Система.loadLibrary("native-lib");
    }
...
public class YoungGenExample {
    ...
    static void keepReference(byte[] Данные) {
...
public class GCLifecycle {
    public static void main(String[] args) {
        ...
        finalizable = null;
        Система.gc(); // вызовет finalize() перед удалением
    }
...
public class ObjectLifecycle {
    public static void main(String[] args) {
        ...
        Система.gc(); // рекомендация JVM, не команда
    ...
    static class Resource {
        private byte[] Данные = new byte[1024 * 1024];
