...
#### Сборщики и регионы G1 (шпаргалка)
...
<div class="callout callout--info">
  ...
  Классический <code>Thread</code> в этой главе — это <strong>platform thread</strong> (1:1 с потоком ОС). С Java 21 для массового блокирующего I/O добавлены <strong>virtual threads</strong>: JVM планирует их поверх небольшого пула carriers, а ядро видит только OS threads. Подробная схема — <a href="./308.md">Virtual Threads (Java 21+)</a>; выбор API — <a href="./298.md">асинхронность</a>.
  </div>
</div>
