...
![IntelliJ IDEA — проект spring-petclinic, редактор Java с аннотациями Spring, дерево проекта слева](/img/intellij-idea-spring-petclinic.png)
...
![IntelliJ IDEA — обзор интерфейса с подписями — редактор, Project, gutter, toolbar, VCS popup, status bar](/img/intellij-idea-ui-guided-tour.png)
