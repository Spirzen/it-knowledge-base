...
Краткая схема (совпадает с [Первая программа на Java](./13.md)):
...
| Консольный ввод-вывод | [Ввод и вывод в Java](./102.md) |
| Breakpoints и F8 | [Отладка Java-кода](./132.md) |
| Maven / Gradle | [Структура и сборки Java-проектов](./12.md) |
| Kotlin в той же IDE | [Первая программа на Kotlin](/encyclopedia/5-languages/5-09-kotlin/2) |
| Spring после Core | [Первая программа на Spring Framework](./271.md) |
