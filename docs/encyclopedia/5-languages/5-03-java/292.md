...
**Gradle** — вторая по популярности система сборки Java (наряду с [Maven](./12.md)). Spring Boot, Android и многие корпоративные репозитории используют Gradle за гибкость и скорость инкрементальных сборок.
