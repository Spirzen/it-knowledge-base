...
В Temurin/OpenJDK 11+ JFR доступен без коммерческой лицензии. Запись у работающего процесса — `jcmd` (см. [302](./302.md)).
...
|------|------------------------|
| Примитивы vs обёртки | Избегать лишнего boxing в горячих участках |
