...
Пошаговые рецепты для **JavaFX** (OpenJFX) и **Swing**. Каркас — [Первая программа на JavaFX](./3111.md), теория — [311.md](./311.md). Имена элементов — [Архитектура десктопных приложений](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/1#элементы-управления-и-ввод-данных); EDT и фоновые задачи — [112.md](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/112.md).
...
Каркас — [131.md — Swing](./131.md). Все изменения UI — в **EDT**: `SwingUtilities.invokeLater(() -> { ... })`.
...
- [JavaFX и GUI](./311.md) · [Первая программа](./3111.md) · [Swing — практика](./131.md)
