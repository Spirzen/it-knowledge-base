...
Обзор Swing, JavaFX и экосистемы GUI — в статьях [JavaFX и GUI](./311.md), [Первая программа на JavaFX](./3111.md), [Справочник JavaFX — элементы UI](./3112.md) и [Экосистема Java-приложений](./110.md). Общая теория десктопа — [Архитектура десктопных приложений](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/1).
