...
Этот набор хорошо подходит для домашних заданий после темы по ООП и коллекциям. Интерактивные версии — ниже.

<LangPracticeToysHub theme="java" toys={['quest', 'bugquiz', 'cipher']} />

<GameGenreToysStack theme="java" genres={['turnbased', 'puzzle', 'rpg']} />

### 1) Менеджер рейда

<RaidManagerPlay language="Java" />

- **Что тренирует:** классы, коллекции (`List`, `Map`), валидацию, файловое хранение.
- **Идея:** управление группой игроков: роли, посещаемость, распределение лута.
- **Расширение:** экспорт отчёта в CSV и фильтры по классам персонажей.

### 2) Битва сортировок

- **Что тренирует:** алгоритмы, `Comparator`, профилирование времени.
- **Идея:** "персонажи-алгоритмы" (QuickSort, MergeSort, BubbleSort) соревнуются на одинаковых массивах.
- **Расширение:** добавить визуализацию шагов в Swing.

### 3) Шифратор посланий гильдии

- **Что тренирует:** строки, циклы, функции, обработку ошибок.
- **Идея:** шифрование/дешифрование сообщений (Цезарь, Vigenere) для "тайного канала".
- **Расширение:** храните историю сообщений и ключи в отдельном файле.
