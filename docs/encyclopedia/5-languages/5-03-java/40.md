...
См. также: [Первая программа](./13.md) · [ввод и вывод](./102.md) · [путь от исходника до запуска](./1.md#put-isxodnika-do-zapuska) · [Python — аналог `__main__`](/encyclopedia/5-languages/5-02-python/40).
...
| Тема | Статья |
|------|--------|
| Первая программа, Maven, IDEA | [Первая программа на Java — Первая программа](./13.md) |
| Пакеты и classpath | [Структура и сборки Java-проектов — Структура и сборки](./12.md) |
