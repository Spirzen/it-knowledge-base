...
| Способ | Плюсы | Минусы |
|--------|-------|--------|
| Отладчик IDE | Визуальный анализ, пошаговое выполнение, все переменные в области видимости | Нужна настройка среды |
| `System.out.println()` | Просто, без специальных инструментов | Загромождает код, ограниченная информация |
