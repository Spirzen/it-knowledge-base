...
<div class="callout callout--tip">
  ...
  [Структуры данных — о разделе](/encyclopedia/3-data-markup/3-02-struktury-dannyh/intro) → [реализация и псевдокод операций](/encyclopedia/3-data-markup/3-02-struktury-dannyh/2#алгоритмический-справочник-псевдокод). Ниже — `List`, `Set`, `Map` в **Java**. Примеры `HashMap`, `HashSet`, подсчёт частот — <a href="/lab/Примеры/1131#2-коллекции-и-частоты">Lab / консольные задачи, раздел 2</a>.
</div>
  </div>
