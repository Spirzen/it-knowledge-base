...
<ExternalCodeEmbed example="java/java-503-303-001" title="Простой сервис (в памяти)" minHeight={498} />
...
<ExternalCodeEmbed example="java/java-503-303-002" title="Контроллер" minHeight={534} />
...
<ExternalCodeEmbed example="java/java-503-303-003" title="@ControllerAdvice" minHeight={660} />
...
- `DispatcherServlet` и `HandlerMapping` выбирают handler-метод; подробная схема — [жизненный цикл запроса](/encyclopedia/5-languages/5-03-java/27#spring-mvc-request-lifecycle).
