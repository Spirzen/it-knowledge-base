...
description: "Рабочий REST на Spring Boot возвращает предсказуемые ошибки: JSON с кодом и описанием, а не HTML-страницу Whitelabel с трассировкой."
  и понятные ответы 400/404 для Spring Boot API.
---
