...
- файл `$JAVA_HOME/conf/Безопасность/java.security` (ранее `$JAVA_HOME/lib/Безопасность/java.security`);
...
Расположение:  
- `$JAVA_HOME/conf/Безопасность/java.security` (Java ≥ 9)  
- `$JAVA_HOME/lib/Безопасность/java.security` (Java ≤ 8)
...
| `java.security.SecurityPermission` | Изменение Безопасность-подсистемы | `new SecurityPermission("putProviderProperty.SunJCE")` |
