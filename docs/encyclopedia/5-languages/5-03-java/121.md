...
<ExternalCodeEmbed example="text/java-503-121-001" title="3.2. Файлы политики (`.policy`)" minHeight={318} />
...
<ExternalCodeEmbed example="xml/java-503-121-002" title="4.3. Logback" minHeight={660} />
...
<ExternalCodeEmbed example="xml/java-503-121-003" title="4.4. Log4j 2" minHeight={678} />
...
<ExternalCodeEmbed example="bash/java-503-121-004" title="6.5. `jpackage` — сборка native-установщиков" minHeight={444} />
...
<ExternalCodeEmbed example="text/java-503-121-005" title="8.2. Синтаксис `application.properties` и `application.yml`" minHeight={336} />
...
<ExternalCodeEmbed example="yaml/java-503-121-006" title="8.2. Синтаксис `application.properties` и `application.yml`" minHeight={498} />
...
<ExternalCodeEmbed example="yaml/java-503-121-007" title="8.3. Профили (`spring.profiles.active`)" minHeight={444} />
...
<ExternalCodeEmbed example="java/java-503-121-008" title="9.4. Программное API — `Config`, `ConfigProvider`" minHeight={336} />
...
<ExternalCodeEmbed example="java/java-503-121-009" title="9.5. CDI-инъекция — `@ConfigProperty`" minHeight={408} />
...
<ExternalCodeEmbed example="java/java-503-121-010" title="9.7. Расширение — кастомные `ConfigSource`" minHeight={480} />
...
<ExternalCodeEmbed example="java/java-503-121-011" title="10.3. Прокси-настройки" minHeight={318} />
...
<ExternalCodeEmbed example="java/java-503-121-012" title="10.4. TLS/SSL-конфигурация" minHeight={354} />
...
<ExternalCodeEmbed example="java/java-503-121-013" title="10.4. TLS/SSL-конфигурация" minHeight={336} />
...
<ExternalCodeEmbed example="java/java-503-121-014" title="10.9. Диагностика и отладка" minHeight={318} />
