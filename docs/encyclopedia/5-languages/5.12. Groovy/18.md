...
description: Класс, интерфейс Назначение ----------------------------- Closure Аналог лямбда-выражений в Java, используется в Groovy активно. Map, List, Set Расширенные возможности работы с коллекциями. File,…
---
