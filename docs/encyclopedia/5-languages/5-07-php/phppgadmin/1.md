...
- **Выполнить ad-hoc SQL** — проверить запрос из приложения, посмотреть план через `EXPLAIN` (углублённо — [Оптимизация SQL-запросов](/encyclopedia/3-data-markup/3-07-sql/881), [практикум 8.11](/encyclopedia/8-infra-security/8-11-praktikum-postgresql/2)).
...
Теория SQL и типы Postgres — [PostgreSQL — практическая работа и API](/encyclopedia/3-data-markup/3-07-sql/888); после phpPgAdmin — [практикум PostgreSQL 8.11](/encyclopedia/8-infra-security/8-11-praktikum-postgresql/intro).
