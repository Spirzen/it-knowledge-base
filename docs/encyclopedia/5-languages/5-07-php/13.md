...
<InstallerWizardPlay
  appName="Установка XAMPP"
  productName="XAMPP"
  welcomeText="Мастер установит Apache, PHP и MariaDB в одну папку — удобно для первых PHP-страниц на localhost."
  defaultPath="C:\\xampp"
  extraOptionsLabel="Установить Apache и MySQL как службы Windows"
  cardSubtitle="Далее — настройка htdocs и первый index.php"
/>
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первая программа на Java](/encyclopedia/5-languages/5-03-java/13), [Первая программа на Go](/encyclopedia/5-languages/5-10-go/24), [Первая программа на Python](/encyclopedia/5-languages/5-02-python/16), [Первая программа на C#](/encyclopedia/5-languages/5-05-csharp/16), [Первая программа на C++](/encyclopedia/5-languages/5-06-cpp/1002), [Первая программа на TypeScript](/encyclopedia/5-languages/5-10-typescript/4).
