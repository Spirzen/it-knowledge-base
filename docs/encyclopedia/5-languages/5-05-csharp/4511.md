...
Соберём минимальный **REST API** на C# — без БД и облака. Сложный пример с PostgreSQL и S3: [453.md](./453.md). Обзор платформы: [ASP.NET](./451.md). UI: [Blazor](./4512.md) · [MAUI](./4513.md).
