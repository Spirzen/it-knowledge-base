...
- `Endpoint filter` и **policy pipeline** на первом проекте могут отсутствовать — их добавляют, когда проверок становится много (см. [451 — где жить логике](./451.md#где-жить-логике-middleware-endpoint-filters-policy-pipeline)).
