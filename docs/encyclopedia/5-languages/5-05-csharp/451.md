...
description: "ASP.NET Core: хостинг, middleware, endpoint filters, policy pipeline, MVC и современный стек .NET."
related:
...
<ExternalPlayEmbed example="languages/asp-net-architecture-play" title="Архитектура ASP.NET" minHeight={520} />

---

## ASP.NET

См. также: [Первая программа на ASP.NET Core](./4511.md) · [Minimal API и OpenAPI](./4517.md) · [FluentValidation, Polly и rate limiting](./4519.md) · [Razor Pages](./4514.md) · [Identity — JWT и cookie](./4515.md) · [MediatR и pipeline](./4518.md) · [тесты ASP.NET](./4516.md) · [Blazor](./4512.md) · [.NET MAUI](./4513.md) · [EF Core — первая программа](./441.md) · [EF Core — продвинутое](./443.md) · [Clean Architecture на ASP.NET Core](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/2143) · [Выбор архитектуры под сценарий](./476.md) · [Справочник](./452.md) · [Продвинутый пример с БД и S3](./453.md) · [Документация Microsoft Learn](./455.md).
...
<div class="callout callout--info">
  ...
  Сначала пройдите практические шаги из [Первая программа на ASP.NET Core](./4511.md) и [Razor Pages — первая программа](./4514.md), затем возвращайтесь к архитектурным разделам ниже. Такой порядок упрощает понимание терминов и решений по ходу чтения.
</div>
  </div>
...
Практика: [Minimal API — endpoint filters](./4517.md#endpoint-filters). Справочник по `AddEndpointFilter`: [Справочник по ASP.NET](./452.md).
...
| **MediatR** `IPipelineBehavior` | Clean Architecture: проверки вокруг `IRequest` в Application — см. [MediatR и pipeline в слое Application](./4518.md), [Clean Architecture на ASP.NET Core](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/2143). |
...
- **Фильтры MVC/Razor** — `ActionExecutingContext`, `PageHandlerExecutingContext` — параметры action, `ModelState`, результат, DI контроллера.
...
Типы фильтров MVC (`IAuthorizationFilter`, `IActionFilter`, `IExceptionFilter`) — в [документации Microsoft](https://learn.microsoft.com/ru-ru/aspnet/core/mvc/controllers/filters?view=aspnetcore-10.0). Логику action удобно проверять юнит-тестами с Moq; весь HTTP-pipeline — [Тесты ASP.NET Core — юнит и интеграция](./4516.md).

Пример policy в Application (упрощённо):



<ExternalCodeEmbed example="csharp/csharp-505-451-001" title="Где жить логике: Middleware, Endpoint Filters, Policy Pipeline" minHeight={426} />
...
<div class="callout callout--tip">
  ...
  <div class="callout-body">
  [Blazor — первая программа](./4512.md)

  [.NET MAUI — первая программа](./4513.md)
</div>
  </div>
...
<ExternalCodeEmbed example="csharp/csharp-505-451-002" title="Параметры маршрутов и ограничения" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-451-003" title="Создание кастомных поставщиков" minHeight={336} />
...
<ExternalCodeEmbed example="csharp/csharp-505-451-004" title="Создание кастомных поставщиков" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-451-005" title="DI в различных контекстах" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-451-006" title="DI в различных контекстах" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-451-007" title="Валидация — ModelState и политики" minHeight={318} />
...
3. **ADO.NET** — низкоуровневый доступ к БД через `SqlConnection`, `SqlCommand`, `SqlDataReader`.  
   ...
   **Когда использовать**: критически важные операции (bulk insert; теория — [Пакетная работа с данными](/encyclopedia/3-data-markup/3-11-analiz-dannyh/433)), интеграция с нестандартными СУБД, кастомные провайдеры.
