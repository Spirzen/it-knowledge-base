...
<ExternalPlayEmbed example="languages/csharp-database-play" title="C# и базы данных" minHeight={480} />
...
| API + PostgreSQL | [Приложение с S3, PostgreSQL и ASP.NET Core Web API](./453.md) |

Смежные темы: [LINQ](./29.md), [полный API-справочник LINQ](./291.md), [ASP.NET Core](./4511.md), [ADO.NET (платформа)](../5-04-platforma-dotnet/171.md).
...
|--------|------|----------------|
| **ADO.NET** | `Connection`, `Command`, `DataReader`, свой SQL | Отчёты, [bulk](/encyclopedia/3-data-markup/3-11-analiz-dannyh/433#sql-bulk), тонкая настройка, legacy |
...
<ExternalCodeEmbed example="csharp/csharp-505-44-001" title="Как подключиться к базе данных в С#" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-44-002" title="ORM и LINQ" minHeight={390} />
...
<ExternalCodeEmbed example="csharp/csharp-505-44-003" title="ORM и LINQ" minHeight={336} />
...
<ExternalCodeEmbed example="csharp/csharp-505-44-004" title="Entity Framework" minHeight={372} />
...
<ExternalCodeEmbed example="csharp/csharp-505-44-005" title="Модели данных" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-44-006" title="Атрибуты" minHeight={354} />
...
1. Пройдите [Entity Framework Core — первая программа](./441.md) и [ADO.NET и Dapper — первая программа](./442.md) на одной модели "Книга".
...
- [EF Core — первая программа](./441.md) · [EF Core — продвинутое](./443.md) · [ADO.NET / Dapper](./442.md)
- [LINQ](./29.md) · [Справочник LINQ](./291.md)
- [ASP.NET Core](./4511.md) · [FluentValidation, Polly, rate limiting](./4519.md) · [Пример API + PostgreSQL](./453.md)
- [Вопросы на собеседование](./474.md) · [Маршрут Junior → Senior](./475.md)
