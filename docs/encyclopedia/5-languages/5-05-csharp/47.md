...
<div class="callout callout--tip">
  ...
  Если вы только входите в ASP.NET Core, сначала пройдите [Первая программа ASP.NET Core](/encyclopedia/5-languages/5-05-csharp/4511), затем [ASP.NET — фреймворк для веб-приложений](/encyclopedia/5-languages/5-05-csharp/451), после этого вернитесь к этой статье и повторите шаги на своём мини-проекте.
</div>
  </div>
