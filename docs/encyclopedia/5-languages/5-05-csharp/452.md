...
description: Справочник-шпаргалка по ASP.NET — типы, синтаксис, стандартная библиотека, типовые паттерны. Не заменяет пошаговое обучение. Учебный курс — раздел.
...
Справочник-шпаргалка по **ASP.NET** — типы, синтаксис, стандартная библиотека, типовые паттерны. Не заменяет пошаговое обучение. Учебный курс: [раздел](/encyclopedia/5-languages/5-05-csharp/intro). Официальные учебники и хаб документации: [Документация и практика ASP.NET (Microsoft Learn) — Microsoft Learn](./455.md).
...
<ExternalCodeEmbed example="csharp/csharp-505-452-001" title="3. Внедрение зависимостей (`IServiceCollection`)" minHeight={354} />
...
Middleware — компоненты, обрабатывающие каждый HTTP-запрос и ответ в порядке регистрации ("луковичная" модель). **Когда middleware, а когда endpoint filter или policy pipeline** — критерии и полная схема запроса: [ASP.NET - фреймворк для веб-приложений — Middleware, Endpoint Filters, Policy Pipeline](./451.md#где-жить-логике-middleware-endpoint-filters-policy-pipeline).
...
<ExternalCodeEmbed example="csharp/csharp-505-452-002" title="4. Middleware" minHeight={372} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-003" title="5. Minimal APIs" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-004" title="7. Версионирование API" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-005" title="8. OpenAPI (Swagger) через Swashbuckle.AspNetCore" minHeight={720} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-006" title="1. Аутентификация (`IAuthenticationService`)" minHeight={534} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-007" title="1. Аутентификация (`IAuthenticationService`)" minHeight={336} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-008" title="2. Авторизация (`IAuthorizationService`)" minHeight={336} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-009" title="2. Авторизация (`IAuthorizationService`)" minHeight={426} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-010" title="3. Кэширование" minHeight={336} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-011" title="3. Кэширование" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-012" title="4. Логирование (`ILogger<T>`)" minHeight={444} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-013" title="1. SignalR" minHeight={552} />
...
<ExternalCodeEmbed example="text/csharp-505-452-014" title="2. gRPC" minHeight={390} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-015" title="2. gRPC" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-016" title="2. gRPC" minHeight={426} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-017" title="3. Health Checks" minHeight={408} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-018" title="3. Health Checks" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-019" title="4. Тестирование" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-020" title="4. Тестирование" minHeight={444} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-021" title="4. Тестирование" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-022" title="4. Тестирование" minHeight={390} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-023" title="4. Тестирование" minHeight={426} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-024" title="1. Локализация и интернационализация" minHeight={552} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-025" title="1. Локализация и интернационализация" minHeight={318} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-026" title="1. Локализация и интернационализация" minHeight={354} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-027" title="1. Локализация и интернационализация" minHeight={408} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-028" title="2. Фоновые задачи" minHeight={720} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-029" title="2. Фоновые задачи" minHeight={336} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-030" title="2. Фоновые задачи" minHeight={462} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-031" title="2. Фоновые задачи" minHeight={390} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-032" title="2. Фоновые задачи" minHeight={408} />
...
<ExternalCodeEmbed example="csharp/csharp-505-452-033" title="2. Фоновые задачи" minHeight={498} />
...
Полный навигатор с серией MVC и Docker: [Документация и практика ASP.NET (Microsoft Learn)](./455.md). Ниже — быстрые ссылки для работы со справочником.
...
| Раздел | URL |
|--------|-----|
| Документация (RU) | [aspnet/core](https://learn.microsoft.com/ru-ru/aspnet/core/?view=aspnetcore-10.0) |
| Fundamentals | [fundamentals](https://learn.microsoft.com/ru-ru/aspnet/core/fundamentals/?view=aspnetcore-10.0) |
| MVC overview | [mvc/overview](https://learn.microsoft.com/ru-ru/aspnet/core/mvc/overview?view=aspnetcore-10.0) |
| Routing | [mvc/controllers/routing](https://learn.microsoft.com/ru-ru/aspnet/core/mvc/controllers/routing?view=aspnetcore-10.0) |
| Razor syntax | [mvc/views/razor](https://learn.microsoft.com/ru-ru/aspnet/core/mvc/views/razor?view=aspnetcore-10.0) |
| Минимальные API | [fundamentals/apis](https://learn.microsoft.com/ru-ru/aspnet/core/fundamentals/apis?view=aspnetcore-10.0) |
| OpenAPI / Swagger | [web-api-help-pages-using-swagger](https://learn.microsoft.com/ru-ru/aspnet/core/tutorials/web-api-help-pages-using-swagger?view=aspnetcore-10.0) |
| Docker (Core) | [host-and-deploy/docker](https://learn.microsoft.com/ru-ru/aspnet/core/host-and-deploy/docker/?view=aspnetcore-10.0) |
| API browser | [dotnet/api](https://learn.microsoft.com/ru-ru/dotnet/api/?view=aspnetcore-10.0) |

---

### Серия Razor Pages RazorPagesMovie (практика)

Оглавление: [tutorials/razor-pages](https://learn.microsoft.com/ru-ru/aspnet/core/tutorials/razor-pages/?view=aspnetcore-10.0) — проект **RazorPagesMovie**, 8 частей (model, scaffold, SQL, search, validation). Рекомендуемый старт для новичков; таблица в [Документация и практика ASP.NET (Microsoft Learn)](./455.md).

---

### Серия MVC MvcMovie (практика)

Старт: [first-mvc-app/start-mvc](https://learn.microsoft.com/ru-ru/aspnet/core/tutorials/first-mvc-app/start-mvc?view=aspnetcore-10.0&tabs=visual-studio) — проект **MvcMovie**, .NET 10, далее controller/views, EF, search, validation (таблица частей в [Документация и практика ASP.NET (Microsoft Learn)](./455.md)).

---

### Legacy — ASP.NET MVC в Docker (Framework)

Для **.NET Framework + IIS**, не Core: [docker-aspnetmvc](https://learn.microsoft.com/ru-ru/aspnet/mvc/overview/deployment/docker-aspnetmvc). Образ `mcr.microsoft.com/dotnet/framework/aspnet:4.8`, публикация в `PublishOutput`, контейнеры Windows.
...
**Справочники** — [Справочник по LINQ](/encyclopedia/5-languages/5-05-csharp/291), [Справочник по C#](/encyclopedia/5-languages/5-05-csharp/471), [Справочник по конфигурациям в C#](/encyclopedia/5-languages/5-05-csharp/101), [Справочник по C++](/encyclopedia/5-languages/5-06-cpp/3), [Справочник по F#](/encyclopedia/5-languages/5-04-platforma-dotnet/181), [Справочник по PHP](/encyclopedia/5-languages/5-07-php/211).
