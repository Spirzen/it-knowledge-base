...
<div class="callout callout--info">
  ...
  Справочник типов для `catch`. Обработка в коде — [Обработка исключений в C#](./15.md)

  общая теория — [ошибки и исключения](/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111).
</div>
  </div>
