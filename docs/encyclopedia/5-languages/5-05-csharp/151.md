...
<div class="callout callout--info">
  ...
  Справочник типов для <code>catch</code>. Обработка в коде — <a href="./15.md">Обработка исключений в C#</a>; общая теория — <a href="/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111">ошибки и исключения</a>.
</div>
  </div>
