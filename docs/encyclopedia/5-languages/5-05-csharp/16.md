...
<InstallerWizardPlay
  ...
  welcomeText="Мастер загрузит компоненты .NET, компилятор C# и шаблоны консольных проектов."
  extraOptionsLabel="Рабочая нагрузка «Разработка классических приложений .NET»"
  cardSubtitle="Далее — пошаговое создание проекта в IDE"
/>
