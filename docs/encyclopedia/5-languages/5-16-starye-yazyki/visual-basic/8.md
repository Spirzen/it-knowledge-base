...
В Excel VBA до сих пор массово используют для отчётов, выгрузок, макросов кнопок и автоматизации таблиц — часто без отдельной "большой" IDE. Сначала освоите **формулы** в ячейках — [212 — Excel](/encyclopedia/1-basics/1-15-tekst/212), [1139 — формулы с разбором](/lab/Примеры/1139); VBA нужен, когда одних формул мало (кнопка «выгрузить отчёт», цикл по листам).
