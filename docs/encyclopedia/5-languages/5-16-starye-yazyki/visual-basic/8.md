...
- **VBScript** (Visual Basic Scripting Edition) — в **Internet Explorer 3+**, **Outlook** и сценариях Windows; близкий синтаксис, другая среда (без полноценной IDE Office).
- **Visual Basic .NET** (2002) — отдельная ветвь на CLR; макросы Office **остались на VBA**, совместимом с духом **VB6**, а не с VB.NET.

Сравнение ветвей: [о разделе](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/intro). Учебный курс VB.NET: [основы](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/2) → [первая программа](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/7).
