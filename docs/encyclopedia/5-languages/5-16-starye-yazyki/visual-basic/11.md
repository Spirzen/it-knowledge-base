...
<ExternalCodeEmbed example="vb/vb-516-11-001" title="Перегрузка операторов" minHeight={408} />
...
<ExternalCodeEmbed example="vb/vb-516-11-002" title="Индексатор (свойство по умолчанию)" minHeight={354} />
...
<ExternalCodeEmbed example="vb/vb-516-11-003" title="Своя коллекция и For Each" minHeight={552} />
