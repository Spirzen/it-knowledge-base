...
> Глава про **VB.NET**. Базовые типы и `Option Strict` — в [типах данных](./4.md).

---

Короткая глава: таблица value и reference → `CType` / `TryCast` → `Nothing` и nullable. Читайте после [типов](./4.md) и перед [управлением](./5.md).
...
| Тема | Статья |
|------|--------|
| Примитивы, `Option Strict` | [Типы](./4.md) |
| `If`, циклы | [Управляющие конструкции и операторы visual-basic](./5.md) |
| Коллекции, файлы | [Консоль, CLI, коллекции и файлы](./10.md) |
| Архитектура .NET | [Архитектура приложений на visual-basic](./3.md) |
