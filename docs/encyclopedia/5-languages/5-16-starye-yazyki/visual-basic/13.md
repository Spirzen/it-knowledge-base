...
В курсах информатики Access часто проходят через **таблицы, формы, отчёты и запросы**. Углубление в энциклопедии — [Основы баз данных](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/intro).
...
- **Макро-вирусы** (AutoOpen, заражение `.doc`) — см. [антивирус в базовой информатике](/encyclopedia/2-system-network/2-01-operatsionnaya-sistema/intro).
