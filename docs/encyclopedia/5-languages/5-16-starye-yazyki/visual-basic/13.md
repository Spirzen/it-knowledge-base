...
Расширенный справочник по конструкциям VBA (GoTo, `Type…End Type`, `Enum`, `Like`, `Mid`) — в [711](./711.md); для экзамена достаточно знать **`On Error`**, **`Set`** для объектов и **`For Each`**.
...
| 5 | VB.NET в Visual Studio | [7](./7.md) |
