...
В [базовой информатике — глава про ОС](/encyclopedia/2-system-network/2-01-operatsionnaya-sistema/intro) сценарии относят к **служебным программам**; антивирусы часто проверяют `.vbs` из вложений почты.
...
- [Базовая информатика — алгоритмы](/encyclopedia/4-code-dev/4-01-algoritmy/intro) — блок-схемы до кода
