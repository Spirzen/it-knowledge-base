...
description: "Справочник-шпаргалка по visual-basic: типы, синтаксис, стандартная библиотека и типовые паттерны. Не заменяет пошаговое обучение."
...
Справочник-шпаргалка по **visual-basic**: типы, синтаксис, стандартная библиотека, типовые паттерны. Не заменяет пошаговое обучение. Учебный курс: [раздел](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/intro); практика: [Значимые и ссылочные типы, преобразования](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/9)–[Лямбды, LINQ, операторы и свои коллекции](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/11).
...
<ExternalCodeEmbed example="vb/vb-516-711-001" title="Циклы" minHeight={336} />
...
<ExternalCodeEmbed example="vb/vb-516-711-002" title="Объявление класса" minHeight={354} />
...
Операторы объявляют `Shared`; типичные: `+`, `-`, `=`, `<>`, `CType`. Подробнее — [глава 11](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/11).
...
Учебный разбор: [глава 11](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/11).
...
Класс реализует `IEnumerable(Of T)` и `Iterator Function … Yield` — см. [глава 11](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/11).
...
Подробнее: [глава 10](/encyclopedia/5-languages/5-16-starye-yazyki/visual-basic/10).
...
3. Если контекста мало, откройте связанную главу:
   - [Управляющие конструкции и операторы visual-basic](./5.md) для ветвлений и циклов,
   - [Процедуры и события в visual-basic](./6.md) для процедур и событий,
   - [Консоль, CLI, коллекции и файлы](./10.md) для файлов и коллекций,
   - [Лямбды, LINQ, операторы и свои коллекции](./11.md) для лямбд и LINQ.
...
**Справочники** — [Справочник по Pascal](/encyclopedia/5-languages/5-16-starye-yazyki/Pascal/711), [Справочник по ассемблеру](/encyclopedia/5-languages/5-16-starye-yazyki/assembler/711), [Справочник по Lisp](/encyclopedia/5-languages/5-16-starye-yazyki/Lisp/811), [Справочник по языку С](/encyclopedia/5-languages/5-16-starye-yazyki/c-language/8), [Справочник по языку Fortran](/encyclopedia/5-languages/5-16-starye-yazyki/Fortran/811), [Справочник по нотации BPMN 2.0](/encyclopedia/7-project/7-04-analitika/129).
