...
3. Если контекста мало, откройте связанную главу:
   - [5](./5.md) для ветвлений и циклов,
   - [6](./6.md) для процедур и событий,
   - [10](./10.md) для файлов и коллекций,
   - [11](./11.md) для лямбд и LINQ.
