...
Это не линейный учебник, а рабочая "карта" для быстрых ответов:

- забыли синтаксис `PERFORM` или `EVALUATE` — идите в раздел 5;
- нужно вспомнить `PIC` / `USAGE` — раздел 4;
- работаете с файлами и `FILE STATUS` — раздел 7 и шаблоны из 16;
- сравниваете компиляторы — разделы 14 и 20.

Если вы только начинаете, сначала пройдите [Основы](./2.md), [Типы](./4.md), [Управление](./5.md), [Параграфы](./6.md), а затем возвращайтесь сюда как к шпаргалке.
...
<ExternalCodeEmbed example="cobol/cobol-516-711-001" title="11.1. Классы" minHeight={534} />
...
<ExternalCodeEmbed example="cobol/cobol-516-711-002" title="12.4. Курсоры для множественных строк" minHeight={318} />
...
<ExternalCodeEmbed example="cobol/cobol-516-711-003" title="16.1. Обработка ошибок файлов" minHeight={336} />
...
<ExternalCodeEmbed example="cobol/cobol-516-711-004" title="19.1. Структурные слова разделов и секций" minHeight={336} />
...
<ExternalCodeEmbed example="cobol/cobol-516-711-005" title="19.3. Описание данных" minHeight={408} />
...
|--------|---------------------------------|------------------------|
| Описать запись и поля | `4 DATA DIVISION`, `4.1`, `4.2` | [Типы данных](./4.md) |
| Сделать цикл и ветвление | `5.3` (`IF`, `EVALUATE`, `PERFORM`) | [Управление](./5.md) |
| Разбить логику на блоки | `5.2`, `8` | [Параграфы](./6.md) |
| Читать/писать файл и ловить ошибки | `7`, `16.1` | [Архитектура](./3.md) |
| Скомпилировать на GnuCOBOL | `Быстрый старт`, `14.2` | [Первая программа](./7.md) |
| Подготовить модернизацию legacy | `21`, `22`, `23` | [Итоги](./998.md) |
...
Для общей базы по терминам программирования: [Что такое код и как он работает](/encyclopedia/4-code-dev/4-02-chto-takoe-kod-i-kak-on-rabotaet/1), [Функции](/encyclopedia/4-code-dev/4-02-chto-takoe-kod-i-kak-on-rabotaet/4), [Операторы](/encyclopedia/4-code-dev/4-02-chto-takoe-kod-i-kak-on-rabotaet/33).
