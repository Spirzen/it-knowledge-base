...
Из-за этого основная сложность на практике — не мнемоники как таковые, а аккуратное соблюдение ABI и правил линковки PE-модуля. Как только эти правила фиксируются, остальной код становится довольно прямолинейным.
