...
**Теория:** [Обобщения и обобщённое программирование](/encyclopedia/4-code-dev/4-07-paradigmy-i-urovni-abstraktsii/114).
...
<div class="callout callout--info">
  ...
  Дженерики добавили выразительность без "шаблонного ада". Если задачу решает интерфейс из трёх методов — интерфейс предпочтительнее.

  Generics — для библиотечных алгоритмов и контейнеров, а не для всей доменной модели.
  </div>
</div>
...
<ExternalCodeEmbed example="go/go-510-31-001" title="Практический пример — generic-стек" minHeight={354} />
