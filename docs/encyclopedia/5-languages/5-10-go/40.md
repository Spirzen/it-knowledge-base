...
| Тема | Статья |
|------|--------|
| `go mod`, структура проекта | [Первая программа на Go — Первая программа](./24.md) |
| CLI cobra | [CLI на cobra и viper — CLI](./33.md) |
| HTTP сервер | [Первая программа на Gin — Gin](./2412.md) |
