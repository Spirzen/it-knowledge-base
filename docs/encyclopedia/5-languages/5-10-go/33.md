...
- Подробнее — [Модули, workspace, embed и slog](./29.md).
...
- `io.Reader` / `io.Writer` — см. [Важные интерфейсы и типы Go](./23.md).
...
- Store подменяют интерфейсом или temp-файлом — см. [Тестирование в Go](./192.md).
