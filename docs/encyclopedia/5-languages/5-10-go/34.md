...
<div class="callout callout--warning">
  ...
  WebSocket в браузере идёт как <code>wss://</code> поверх TLS. Сервер поднимают через <code>ListenAndServeTLS</code> или reverse proxy (nginx, Caddy), который проксирует Upgrade.
  </div>
</div>
