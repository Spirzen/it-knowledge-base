...
- В production endpoint изолируют firewall или отдельный admin-порт — см. [30.md](./30.md).
...
**Example-функции** (документация + тест) — см. [192.md](./192.md); **`testing/quick`** — случайные значения для property-подобных проверок без полноценного fuzz.
