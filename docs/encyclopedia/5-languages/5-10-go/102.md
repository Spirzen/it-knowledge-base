...
Обзор редакторов для power user — [VS Code, Vim, Notepad++](/encyclopedia/1-basics/1-035-bazovaya-informatika/503). В [первой программе](./24.md) подробно описан сценарий с VS Code; GoLand — альтернатива, когда нужна полноценная IDE.
