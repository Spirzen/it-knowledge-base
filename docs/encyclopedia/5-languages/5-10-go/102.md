...
![GoLand — отладка Go-кода, department.go, breakpoint, инспекция struct Employee, панели Frames и Threads & Variables](https://assets.spirzen.ru/encyclopedia/_shared/img/goland-debug-goroutines.png)
...
| Синтаксис, горутины | [Синтаксические конструкции Go](./14.md) |
| Стиль и идиомы | [Рекомендации по разработке на Go](./101.md) |
| HTTP API | [Gin](./2412.md) |
| Отладка Delve (теория) | [Экосистема приложений на Go](./111.md) |
| IntelliJ для сравнения | [IntelliJ IDEA — IDE для разработки на Java](/encyclopedia/5-languages/5-03-java/103) |
