...
Обзор редакторов для power user — [VS Code, Vim, Notepad++](/encyclopedia/4-code-dev/4-011-instrumenty-razrabotki/503). В [первой программе](./24.md) подробно описан сценарий с VS Code; GoLand — альтернатива, когда нужна полноценная IDE.
