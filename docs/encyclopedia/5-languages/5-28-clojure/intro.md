...
S-expressions (символьные выражения, от англ. Symbolic Expressions) — это способ записи данных или кода в виде вложенных списков, заключенных в круглые скобки.
