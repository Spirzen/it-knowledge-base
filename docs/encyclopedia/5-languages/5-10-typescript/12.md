...
> База JS: [условия и циклы](/encyclopedia/5-languages/5-01-javascript/20). Discriminated unions — [10.md](./10.md).
...
Тот же паттерн для UI — [10.md](./10.md), [17.md](./17.md).
...
- Предпочтительнее `as string[]` для внешних данных — [6.md](./6.md).
...
- Альтернатива — `throw` или `Result` — [27.md](./27.md).
...
3. Перепишите цепочку `if/else` на `switch` по `status` из [17.md](./17.md).
...
- JS: [20](/encyclopedia/5-languages/5-01-javascript/20)
