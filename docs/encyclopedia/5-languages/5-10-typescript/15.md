...
**Дальше:** [tsserver](./16.md) · [подключение](./9.md) · [30.md §компилятор](/encyclopedia/5-languages/5-01-javascript/30#компилятор-typescript)
...
**Маршрут:** [подключение](./9.md) → **компиляция** → [TypeScript Server](./16.md).
...
Связанный обзор в JS-курсе — [30.md §компилятор](/encyclopedia/5-languages/5-01-javascript/30#компилятор-typescript).
...
Компилятор строит граф пакетов и пересобирает только изменённые части. Подробнее — [9.md §monorepo](./9.md), [301 §project references](/encyclopedia/5-languages/5-01-javascript/301#project-references).
...
- [Рекомендации](./6.md)
- [30.md — компилятор](/encyclopedia/5-languages/5-01-javascript/30#компилятор-typescript)
- [301 §11](/encyclopedia/5-languages/5-01-javascript/301#11-конфигурация-typescript-tsconfigjson)
