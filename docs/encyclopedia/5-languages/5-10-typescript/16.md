...
**Дальше:** [компиляция](./15.md) · [экосистема](./3.md) · [30 §tsserver](/encyclopedia/5-languages/5-01-javascript/30#tsserver-typescript-server)
...
> Краткий указатель в JS-курсе — [30.md §tsserver](/encyclopedia/5-languages/5-01-javascript/30#tsserver-typescript-server). CLI `tsc` — [15.md](./15.md).
...
Для прикладного backend/frontend этот уровень не обязателен — достаточно [15.md](./15.md) и workspace `tsserver`. Таблицы и ссылки — [301 §18](/encyclopedia/5-languages/5-01-javascript/301#18-расширение-typescript).
...
- [Справочник](./2.md) — [30](/encyclopedia/5-languages/5-01-javascript/30), [301 §17](/encyclopedia/5-languages/5-01-javascript/301#17-инструменты-и-cli)
