...
- Подробнее о коллекциях — [19.md](./19.md).
...
- `await` внутри `map` без `Promise.all` даёт последовательность; параллель — [17.md](./17.md).
...
- Полный разбор генераторов — [25.md](./25.md); async — [17.md](./17.md).
...
- **Подробно в JS:** [23](/encyclopedia/5-languages/5-01-javascript/23)
