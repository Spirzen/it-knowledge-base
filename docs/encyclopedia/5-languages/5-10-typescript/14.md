...
Учебное раскрытие **[Справочник — функции](/encyclopedia/5-languages/5-01-javascript/301#4-функции)** — сигнатуры, overloads, `this`, generic-функции.
...
**Маршрут:** [Типы и типизация](./10.md) → **функции** → [дженерики](./24.md) → [асинхронность](./17.md).
...
- `onError` принимает `unknown`, не `any` — см. [Типы и типизация](./10.md) и [Обработка ошибок](./27.md).
