...
**Дальше:** [дженерики](./24.md) · [async](./17.md) · [классы](./18.md) · [справочник §4](/encyclopedia/5-languages/5-01-javascript/301#4-функции)

Учебное раскрытие **[301 §4 — функции](/encyclopedia/5-languages/5-01-javascript/301#4-функции)**: сигнатуры, overloads, `this`, generic-функции.
...
**Маршрут:** [типы](./10.md) → **функции** → [дженерики](./24.md) → [асинхронность](./17.md).
...
Таблицы сигнатур — [справочник §4–5](/encyclopedia/5-languages/5-01-javascript/301#4-функции).
...
- `onError` принимает `unknown`, не `any` — см. [типы](./10.md) и [ошибки](./27.md).
...
Не злоупотребляйте перегрузками: часто проще **один** аргумент-объект или discriminated union — [типы](./10.md).
...
Полный список — [справочник §7–8](/encyclopedia/5-languages/5-01-javascript/301#7-утилитарные-типы).
...
- [Справочник раздела](./2.md) · [301 §4](/encyclopedia/5-languages/5-01-javascript/301#4-функции)
- Обзор: [30.md — TypeScript](/encyclopedia/5-languages/5-01-javascript/30#typescript)
