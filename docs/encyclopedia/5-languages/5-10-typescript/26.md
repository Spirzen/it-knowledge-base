...
**Дальше:** [Node](./22.md) · [декораторы](./23.md) · [ошибки](./27.md)
...
**Маршрут:** [Node](./22.md) → **TypeORM**. Нужны [декораторы](./23.md) и `experimentalDecorators` в legacy-стеке.
...
- [Node](./22.md) · [Декораторы](./23.md) · [Ошибки](./27.md) · [Паттерны](./28.md)
