...
- `!` — поле инициализирует БД/ORM, не конструктор — [23.md](./23.md).
...
- `findOneBy` → `User | null` — обработайте null — [27.md](./27.md).
...
Не экспортируйте `Entity` напрямую в API-ответ — маппер `toDto(user)` — [22.md](./22.md), [28.md](./28.md).
...
Разделение: **controller** → **service** → **repository** — [22.md](./22.md).
