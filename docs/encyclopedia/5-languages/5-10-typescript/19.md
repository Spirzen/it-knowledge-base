...
JavaScript даёт **массивы**, **Map**, **Set** и обычные объекты-словари. TypeScript описывает **элементы и ключи** так, чтобы `map`, `filter` и доступ по индексу не превращались в `any`. Здесь — выбор структуры и типичные ошибки, без копирования всех таблиц из [Справочник по TypeScript](/encyclopedia/5-languages/5-01-javascript/301#2-составные-типы).
