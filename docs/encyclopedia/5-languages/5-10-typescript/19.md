...
**Дальше:** [дженерики](./24.md) · [классы](./18.md) · [функции](./14.md) · [справочник §2](/encyclopedia/5-languages/5-01-javascript/301#2-составные-типы)
...
**Маршрут:** [типы](./10.md) → **коллекции** → [дженерики](./24.md) → [классы](./18.md).
...
- Типы: `WeakMap<K extends object, V>`, `WeakSet<T extends object>` — [301 §2](/encyclopedia/5-languages/5-01-javascript/301#2-составные-типы).
...
- [Справочник](./2.md) — [301 §2](/encyclopedia/5-languages/5-01-javascript/301#2-составные-типы)
