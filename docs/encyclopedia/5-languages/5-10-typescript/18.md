...
- Различия `interface` vs `type` (union, merge) — [Синтаксис и пунктуация TypeScript](./8.md), не дублируем здесь.
...
- Классы уместны, когда нужны **инстансы с инвариантами** (подключение к БД, жизненный цикл) — [TypeORM](./26.md).
...
- JS runtime: [Работа с объектами и прототипами](/encyclopedia/5-languages/5-01-javascript/22) · C#: [Объектно-ориентированное программирование в C#](/encyclopedia/5-languages/5-05-csharp/25)
