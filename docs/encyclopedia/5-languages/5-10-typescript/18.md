...
**Дальше:** [коллекции](./19.md) · [паттерны](./28.md) · [синтаксис](./8.md) · [справочник §5–6](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы)

Учебное раскрытие **[301 §6 — классы](/encyclopedia/5-languages/5-01-javascript/301#6-классы)** и **[§5 — интерфейсы](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы)** ([синтаксис](./8.md)).
...
**Маршрут:** [типы](./10.md) → **объекты и классы** → [коллекции](./19.md) → [паттерны](./28.md).

> База JS: [классы и прототипы](/encyclopedia/5-languages/5-01-javascript/22). Для сравнения **номинальной** модели (C#) — [классы C#](/encyclopedia/5-languages/5-05-csharp/25). Таблицы модификаторов — [301 §6](/encyclopedia/5-languages/5-01-javascript/301#6-классы).
...
- Интерфейсы можно **расширять**: `interface Admin extends User { permissions: string[] }` — [301 §5](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы).
...
- [Справочник](./2.md) — [301 §5–6](/encyclopedia/5-languages/5-01-javascript/301)
