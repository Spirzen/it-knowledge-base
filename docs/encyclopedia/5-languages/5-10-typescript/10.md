...
**Дальше:** [переменные](./11.md) · [функции](./14.md) · [дженерики](./24.md) · [справочник §1–3](/encyclopedia/5-languages/5-01-javascript/301#1-основы-типизации)
...
TypeScript **включает** типы значений JS (`number`, `string`, `object`, …) и **добавляет** свои: `unknown`, union `|`, utility-типы, дженерики. Обзор в контексте курса JS — [30.md](/encyclopedia/5-languages/5-01-javascript/30#typescript); полный маршрут — [о разделе](./intro.md).
...
<div class="callout callout--info">
  ...
  Если двум типам с одинаковой формой нужны разные имена в проверке, используют <strong>branded types</strong> или классы — см. [паттерны](./28.md) и [справочник §15](/encyclopedia/5-languages/5-01-javascript/301#15-распространённые-паттерны).
</div>
</div>
...
Подробнее про `interface` vs `type` — [синтаксис](./8.md). Таблицы полей — [справочник §5](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы).

---

## Массивы и кортежи

> Полный разбор `Map`, `Set`, `Record` и выбор структуры — [коллекции](./19.md) ([301 §2](/encyclopedia/5-languages/5-01-javascript/301#2-составные-типы)).
...
Коллекции `Map`, `Set`, `Record` — [коллекции и массивы](./19.md), [справочник §2](/encyclopedia/5-languages/5-01-javascript/301#2-составные-типы).
...
- Подробнее в [ветвлениях](./12.md) и [async](./17.md) (ответ `fetch`).
...
Полный список и продвинутые (`ReturnType`, `Parameters`, `Awaited`, mapped types) — [справочник §7–8](/encyclopedia/5-languages/5-01-javascript/301#7-утилитарные-типы). Связки **generics + `Omit` + `keyof` + literal union** — [дженерики](./24.md).
...
- Обзор в контексте JS: [30.md](/encyclopedia/5-languages/5-01-javascript/30#typescript)
