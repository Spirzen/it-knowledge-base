...
Это отдельный учебный раздел: от [типов](./10.md) и [первой программы](./4.md) до [React](./21.md), [Node.js](./22.md) и [паттернов](./28.md). Краткий обзор внутри курса JavaScript — [статья 30](/encyclopedia/5-languages/5-01-javascript/30); таблицы и синтаксис — [справочник 301](/encyclopedia/5-languages/5-01-javascript/301).
...
| Статическая типизация, типобезопасность | [типы](./10.md), [рекомендации](./6.md) |
| Утиная vs структурная типизация | [типы](./10.md), [классы](./18.md) |
| Проектирование типов, LSP (Лисков) | [типы §проектирование](./10.md), [паттерны](./28.md) |
| Типы и значения, примитивы, enum, tuple | [типы](./10.md), [коллекции](./19.md) |
...
| Компилятор, флаги, Go 7.x, tsserver | [компиляция](./15.md), [tsserver](./16.md) |
| React / Node.js | [21](./21.md), [22](./22.md) |
| Дженерики, Omit, keyof, literal union, связанный выбор | [дженерики](./24.md), [типы](./10.md) |
...
| 7 | [React](./21.md) или [Node.js](./22.md) | Прикладной стек |

---

## Что входит в раздел

Раздел проходит путь от [синтаксиса](./8.md) и [типов](./10.md) через [функции](./14.md), [классы](./18.md) и [коллекции](./19.md) к [компиляции](./15.md), [`tsserver`](./16.md) и [экосистеме](./3.md). Прикладной блок — [React](./21.md), [Node.js](./22.md), [TypeORM](./26.md), [паттерны](./28.md) и [ошибки](./27.md). Навигация по таблицам — [индекс](./2.md) и [справочник 301](/encyclopedia/5-languages/5-01-javascript/301); в конце — [итоги](./998.md) и [чек-лист](./999.md).
