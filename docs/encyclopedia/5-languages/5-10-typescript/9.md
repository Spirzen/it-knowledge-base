...
**Дальше:** [компиляция](./15.md) · [рекомендации](./6.md) · [справочник §11](/encyclopedia/5-languages/5-01-javascript/301#11-конфигурация-typescript-tsconfigjson)
...
Полная таблица флагов — [301 §11](/encyclopedia/5-languages/5-01-javascript/301#11-конфигурация-typescript-tsconfigjson) и [официальный TSConfig Reference](https://www.typescriptlang.org/tsconfig).
...
| Нет типов нигде | свой `declare module "lib"` — [301 §10](/encyclopedia/5-languages/5-01-javascript/301#10-декларации) |
...
Сборка графа: `tsc -b`. Подробнее — [экосистема](./3.md), [301 §project references](/encyclopedia/5-languages/5-01-javascript/301#project-references).
...
В прикладных проектах предпочитайте **файлы-модули**; `namespace` встречается в старых библиотеках и при [слиянии деклараций](#декларации-типов-dts). Таблицы — [301 §9](/encyclopedia/5-languages/5-01-javascript/301#9-модули-и-пространства-имен).
...
Работает для **`interface`** и **`namespace`** — удобно дополнять типы библиотек. Для union и mapped types используйте `type`, не interface. Подробнее — [301 §10](/encyclopedia/5-languages/5-01-javascript/301#10-декларации), emit `.d.ts` — [15.md](./15.md).
...
- [Справочник 301 §9–11](/encyclopedia/5-languages/5-01-javascript/301#9-модули-и-пространства-имен)
