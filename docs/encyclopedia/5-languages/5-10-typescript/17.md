...
**Дальше:** [дженерики](./24.md) · [Node.js](./22.md) · [ошибки](./27.md) · [справочник §8](/encyclopedia/5-languages/5-01-javascript/301#8-расширенные-возможности-типов)
...
**Маршрут:** [типы](./10.md) → [функции](./14.md) → **async** → [React](./21.md) / [Node](./22.md).
...
Полезно в обёртках над `fetch` и в generic-хелперах — [301 §7](/encyclopedia/5-languages/5-01-javascript/301#7-утилитарные-типы).
