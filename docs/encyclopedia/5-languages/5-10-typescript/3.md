...
**Дальше:** [подключение](./9.md) · [tsserver](./16.md) · [30 §monorepo](/encyclopedia/5-languages/5-01-javascript/30#monorepo-и-публикация) · [справочник §11](/encyclopedia/5-languages/5-01-javascript/301#11-конфигурация-typescript-tsconfigjson)
...
**Маршрут:** [о разделе](./intro.md) → **экосистема** → [подключение](./9.md) → [компиляция](./15.md).

> Обзор без учебных деталей — [30.md](/encyclopedia/5-languages/5-01-javascript/30). Таблицы `tsconfig` — [301](/encyclopedia/5-languages/5-01-javascript/301).
...
Указатель в JS-курсе — [30 §monorepo](/encyclopedia/5-languages/5-01-javascript/30#monorepo-и-публикация). Таблицы — [301 §11](/encyclopedia/5-languages/5-01-javascript/301#11-конфигурация-typescript-tsconfigjson).
