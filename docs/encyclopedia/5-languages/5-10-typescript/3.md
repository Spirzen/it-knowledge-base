...
- [Форматы и подключение](./9.md) — `tsconfig`, ESM и CJS
- [Архитектура компиляции](./15.md) — emit, source maps
- [Обзор TypeScript в JS](/encyclopedia/5-languages/5-01-javascript/30) — краткий указатель в курсе JavaScript
- [Справочник по TypeScript](/encyclopedia/5-languages/5-01-javascript/301) — таблицы `tsconfig`
...
| `src/types/` | DTO, domain, shared unions — [Рекомендации §структура](./6.md#структура-типов-в-репозитории) |
...
| `*.d.ts` в корне | глобальные декларации (`global.d.ts`) — [Подключение](./9.md) |
