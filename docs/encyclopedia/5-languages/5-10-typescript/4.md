...
**Дальше:** [типы](./10.md) · [подключение](./9.md) · [компиляция](./15.md) · [справочник §17](/encyclopedia/5-languages/5-01-javascript/301#17-инструменты-и-cli)
...
**Маршрут:** [о разделе](./intro.md) → [карта раздела](./1.md) → **первая программа** → [типы](./10.md) → [подключение](./9.md).

> Аналог по шагам установки на другом языке — [первая программа на Python](/encyclopedia/5-languages/5-02-python/16). Обзор TypeScript внутри курса JS — [30.md](/encyclopedia/5-languages/5-01-javascript/30#typescript). Таблицы команд — [301 §17](/encyclopedia/5-languages/5-01-javascript/301#17-инструменты-и-cli).
...
Полный справочник флагов — [301 §11](/encyclopedia/5-languages/5-01-javascript/301#11-конфигурация-typescript-tsconfigjson), не дублируйте его здесь.
...
Базовые команды компилятора и проверки — первый слой [301 §17](/encyclopedia/5-languages/5-01-javascript/301#17-инструменты-и-cli).
...
- Обзор в курсе JS: [30.md](/encyclopedia/5-languages/5-01-javascript/30#typescript)
