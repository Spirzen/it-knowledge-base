...
related:
  ...
  - title: "Синтаксис JavaScript"
    doc: encyclopedia/5-languages/5-01-javascript/17
...
> База JS: [синтаксис JavaScript](/encyclopedia/5-languages/5-01-javascript/17). Таблицы конструкций — [Справочник — интерфейсы](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы).
