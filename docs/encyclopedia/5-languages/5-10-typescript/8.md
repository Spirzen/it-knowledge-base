...
**Дальше:** [типы](./10.md) · [функции](./14.md) · [классы](./18.md) · [справочник §5](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы)
...
**Маршрут:** [первая программа](./4.md) → **синтаксис** → [типы](./10.md) → [функции](./14.md).

> База JS: [синтаксис JavaScript](/encyclopedia/5-languages/5-01-javascript/17). Таблицы конструкций — [301 §5](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы).
...
Полный список возможностей интерфейса (индексные сигнатуры, callable) — [301 §5](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы).
...
- [Справочник](./2.md) — [301 §5–9](/encyclopedia/5-languages/5-01-javascript/301#5-интерфейсы)
