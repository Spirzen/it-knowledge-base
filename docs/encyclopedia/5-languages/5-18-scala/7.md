...
**Scala** сочетает **ООП** и **функциональное** программирование на **JVM** — тот же runtime, что у [Java](./13.md). Сборка через **sbt**, код в `src/main/scala`, REPL для экспериментов.
