...
<div class="callout callout--tip">
  ...
  Установите JDK и sbt, создайте проект по шагам ниже, запустите <code>sbt run</code>, затем откройте REPL командой <code>sbt console</code> и выполните <code>println("Hello from REPL")</code>.
</div>
