...
<ExternalPlayEmbed example="lab/first-program-play" title="Первая программа" minHeight={420} playProps={{ language: 'scala' }} />
...
Если хотите понять теорию до практики, сначала пройдите [основы языка Scala](/encyclopedia/5-languages/5-18-scala/2), а затем вернитесь к шагам установки.
...
1. [Основы языка Scala](/encyclopedia/5-languages/5-18-scala/2) — синтаксис, типы, коллекции.
2. [Типы и паттерн-матчинг](/encyclopedia/5-languages/5-18-scala/4) — ADT, `Option`, `Either`, `match`.
3. [Функции и функциональные конструкции](/encyclopedia/5-languages/5-18-scala/6) — композиция, `flatMap`, эффекты.
4. [Простые приложения на Scala](/encyclopedia/5-languages/5-18-scala/103) — практические мини-проекты.
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первая программа на Haskell](/encyclopedia/5-languages/5-17-haskell/7), [Первая программа на Elixir](/encyclopedia/5-languages/5-19-elixir/7), [Первая программа на Groovy](/encyclopedia/5-languages/5-12-groovy/2), [Первая программа на Zig](/encyclopedia/5-languages/5-20-zig/7), [Первая программа на Smalltalk](/encyclopedia/5-languages/5-08-smalltalk/11), [Первая программа на Nim](/encyclopedia/5-languages/5-21-nim/7).
