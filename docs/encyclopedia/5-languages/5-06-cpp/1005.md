...
int main() {
    TaskTracker tracker("Задачи.json");
...
public:
    ...
    ManagedArray(ManagedArray&& other) noexcept : Данные(other.Данные), size(other.size) {
        other.Данные = nullptr;
        other.size = 0;
    }
