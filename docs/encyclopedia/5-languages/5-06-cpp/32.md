...
<div class="callout callout--tip">
  ...
  Теория Debug/Release, CRT и toolset — в [Конфигурация и сборка](./1004.md). Практика CMake — в [CMake — первая программа](./1006.md). ABI между компиляторами — в [Углублённые темы](./28.md). Легаси Windows RAD (C++ Builder) — в [отдельной заметке](./33.md).
</div>
  </div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Линковать объект, собранный **GCC** с `libstdc++`, и код, собранный **Clang** с **libc++**, в одном процессе — рискованно. В одном продукте держите **один** toolchain и одну реализацию стандартной библиотеки. Подробнее про ABI — [статья 28](./28.md).
</div>
  </div>
...
- флаги и runtime (`/MT`, `/MD`, `/std:c++20`) отличаются от GCC/Clang — см. [1004](./1004.md).
...
| Статическая CRT (Windows) | — | `/MT` (см. [1004](./1004.md)) |
...
Один проект в CMake обычно задаёт эти флаги через `target_compile_features` и `target_compile_options`, а не вручную в IDE — см. [1006](./1006.md).
