...
Обзор desktop — [Desktop-приложения](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/intro). Исторический контекст PC-гейминга и эволюции API — [История DirectX](/encyclopedia/9-spinoff/9-03-igrovaya-industriya/11439). Toolchain — [Компиляторы и toolchain C++](./32.md). Кросс-платформа — [OpenGL](./2745.md) или [Vulkan](./29.md).
...
Полноценный desktop UI — [Qt](./27.md) или WinUI ([Разработка приложений для Windows (Microsoft Learn)](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/116)). WPF/WinUI тоже используют DirectX под капотом.
