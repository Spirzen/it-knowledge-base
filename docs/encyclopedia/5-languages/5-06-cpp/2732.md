...
<div class="callout callout--tip">
  ...
  **Qt Quick** — интерфейс на **QML** (как разметка), логика на **C++**.
  ...
  Виджетный путь — [Qt — первая программа](./2731.md).

  CMake — [CMake — первая программа](./1006.md).
</div>
  </div>
...
**Qt Quick** — UI для анимаций, touch-экранов, встраиваемых панелей и единого интерфейса на desktop и устройстве. Классические формы Windows чаще на **Qt Widgets** ([Qt — первая программа](./2731.md)).
...
В [Qt — первая программа](./2731.md) кнопки создавали в C++. Здесь:
...
| Старт | [Qt — первая программа](./2731.md) | эта статья |
...
- Виджеты и классический UI: [Qt — первая программа](./2731.md)
- Общий обзор Qt-экосистемы: [Qt - кроссплатформенный фреймворк на C++](./27.md)
- CMake и настройка сборки: [CMake — первая программа](./1006.md)
- Тестирование и практические задания: [Google Test и Catch2 в C++](./1007.md), [Практические задания по C++](./1008.md)
...
Тесты `Counter` без GUI — [Google Test и Catch2 в C++](./1007.md). Практика — задание 4.2 в [Практические задания по C++](./1008.md).

---

## Дальше

- `windeployqt` для QML-зависимостей — [Qt - кроссплатформенный фреймворк на C++](./27.md);
