...
**Правило выбора:** OpenGL — **учёба 3D** на Windows/Linux. Vulkan — свой движок ([29](./29.md)). DirectX — **Windows/Xbox** ([2746](./2746.md)). 2D без шейдеров — [Raylib](./2744.md) или [SFML](./2741.md).
...
Этапы GPU (подробнее — [18](/encyclopedia/9-spinoff/9-08-kompyuternaya-grafika/18)):
