...
<ExternalCodeEmbed example="text/py-502-39-001" title="pyproject.toml — современный манифест проекта" minHeight={336} />
...
| Тема | Статья |
|------|--------|
| Первая программа, установка Python | [Первая программа на Python — Первая программа](./16.md) |
| `if __name__ == "__main__"` | [if __name__ == \"__main__\" — точка входа при запуске файла — точка входа](./40.md) |
| Веб, FastAPI, Django | [Веб-разработка и REST API на Python — Веб и REST](./34.md) |
| Тесты (pytest ставится отдельно) | [Тестирование на pytest — pytest](./37.md) |
