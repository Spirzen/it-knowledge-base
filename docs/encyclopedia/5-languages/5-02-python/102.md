...
Клиент с графическим интерфейсом собран на **Tkinter**. Базовые виджеты, `pack`/`grid` и `mainloop` — в [3111.md](./3111.md) и [галерее примеров](/lab/Примеры/1124); здесь — связка GUI с сетью и потоками.
