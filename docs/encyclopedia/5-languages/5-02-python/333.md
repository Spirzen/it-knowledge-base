...
См. также: [практикум — цифры MNIST на PyTorch](./335.md) · [Классическое ML — scikit-learn](./332.md) · [Анализ данных](./33.md) · [NumPy — массивы и матрицы (Lab)](/lab/Примеры/1129) · [перцептрон на NumPy](/encyclopedia/6-ai/6-03-neyroseti/2) · [Keras и TensorFlow](/encyclopedia/6-ai/6-03-neyroseti/114) · [раздел "ИИ"](/encyclopedia/6-ai/6-01-vvedenie-v-ii/1)
