...
<div class="callout callout--info">
  ...
  База Python — <a href="./16.md">первая программа</a>, <a href="./40.md">точка входа <code>__main__</code></a>, <a href="./39.md">venv и <code>pip install</code></a>. Массивы для осей X и Y — <a href="/lab/Примеры/1129">примеры NumPy</a>. Таблицы перед графиком — <a href="/lab/Примеры/1113">примеры Pandas</a>, <a href="./33.md">NumPy и pandas</a>. Символьные формулы (корни, производная f′) перед построением кривой — <a href="/lab/Примеры/1118">SymPy — уравнения и производные</a>. Рисование фигур «от руки» — <a href="./32.md">Turtle</a>, в браузере — <a href="/lab/Примеры/1119">SVG</a> или <a href="/lab/Примеры/1114">p5.js</a>; статистические графики поверх Matplotlib — Seaborn в <a href="./33.md">том же разделе</a>.
</div>
</div>
