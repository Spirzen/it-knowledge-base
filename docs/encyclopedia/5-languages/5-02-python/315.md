...
<div class="callout callout--info">
  ...
  Модули без установки — <code>socket</code>, <code>ssl</code>, <code>asyncio</code>, <code>urllib</code>, <code>http.client</code>, <code>smtplib</code>, <code>ipaddress</code>. Остальное ставится через <code>pip install …</code>. Подробнее про установку — <a href="./11#kak-python-ishchet-moduli">как Python ищет модули</a>.
</div>
</div>
