...
<div class="callout callout--info">
  ...
  Механизм <code>try/except</code> и определения — [28](./28.md), общая теория — [111](/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111). Здесь — справочник <strong>типов</strong>.
</div>
</div>
