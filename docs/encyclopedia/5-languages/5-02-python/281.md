...
<div class="callout callout--info">
  ...
  Имена классов ниже — конкретизация <strong>исключительных ситуаций</strong> из общей модели (<a href="/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111">ошибки и исключения</a>). Синтаксис перехвата — <a href="./28.md">Обработка исключений в Python</a>.
</div>
  </div>
