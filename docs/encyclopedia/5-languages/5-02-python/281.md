...
<div class="callout callout--info">
  <div class="callout-title">Сначала</div>

  <div class="callout-body">
  Механизм <code>try/except</code> и определения — [Обработка исключений в Python](./28.md), общая теория — [Ошибки, исключения и отказоустойчивость](/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111). Здесь — справочник <strong>типов</strong>.
</div>
</div>
