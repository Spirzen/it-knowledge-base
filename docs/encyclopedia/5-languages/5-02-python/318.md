...
<div class="callout callout--info">
  ...
  База Python — <a href="./16.md">первая программа</a>, <a href="./40.md">точка входа <code>__main__</code></a>, <a href="./39.md">venv и зависимости</a>. Игровой цикл и события — <a href="./312.md">Pygame</a>. Графики функций и диаграммы — <a href="./319.md">Matplotlib</a>. Общая теория игр — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/intro">раздел «Разработка игр»</a>.
</div>
</div>
...
<div class="callout callout--tip">
  ...
  <div class="callout-body">
  Уместен для учебных 3D-проектов на Python, визуализаций, прототипов и инструментов, где важен код, а не визуальный редактор. Для коммерческого AAA или мобильного хита чаще смотрят на Unity, Unreal или Godot; для 2D — <a href="./312.md">Pygame</a> проще. Для **Unity + C# с редактором** — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/3">курс в редакторе</a> и <a href="/lab/Примеры/1136">готовые скрипты в Lab</a>.
</div>
</div>
