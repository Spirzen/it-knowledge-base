...
<ExternalCodeEmbed example="python/py-502-37-001" title="`parametrize` — одна функция, много кейсов" minHeight={354} />
...
<ExternalCodeEmbed example="python/py-502-37-002" title="FastAPI — `TestClient`" minHeight={498} />
...
<ExternalCodeEmbed example="python/py-502-37-003" title="JWT в тестах" minHeight={354} />
...
<ExternalCodeEmbed example="python/py-502-37-004" title="Flask — тестовый клиент" minHeight={336} />
