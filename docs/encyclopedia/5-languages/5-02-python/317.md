...
Путеводитель по инструментам: [Инструменты и среды](//tools/development/1). Раздел про скрапинг в контексте файлов и сети: [глава 31](./31.md).
...
<ExternalCodeEmbed example="python/py-502-316-001" title="Типовой сценарий — каталог" minHeight={552} />
...
- [Парсинг на Python](./316.md) — полный путеводитель по веб-парсингу
