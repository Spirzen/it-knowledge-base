...
Путеводитель: [Инструменты и среды](/encyclopedia/1-basics/1-035-bazovaya-informatika/9). HTTP в Python: [requests](./34.md), файлы и JSON: [Работа с файлами, сетью и внешними API](./31.md).
