...
|------|--------|----------|
| **JavaScript (Node)** | [48 — require.main и import.meta](/encyclopedia/5-languages/5-01-javascript/48) | `require.main === module`, ESM + `import.meta.url` |
| **Java** | [40 — public static void main](/encyclopedia/5-languages/5-03-java/40) | `public static void main(String[] args)` |
| **C#** | [49 — Main и top-level statements](/encyclopedia/5-languages/5-05-csharp/49) | `Program.cs`, `OutputType` Exe vs Library |
| **Go** | [40 — package main](/encyclopedia/5-languages/5-10-go/40) | `package main` + `func main()` |
| **Rust** | [40 — fn main()](/encyclopedia/5-languages/5-13-rust/40) | `src/main.rs` vs `src/lib.rs` |
| **Kotlin** | [40 — fun main()](/encyclopedia/5-languages/5-09-kotlin/40) | `fun main()` на JVM |
| **Ruby** | [40 — __FILE__ == $0](/encyclopedia/5-languages/5-11-ruby/40) | `if __FILE__ == $0` |
| **PHP** | [40 — index.php и require](/encyclopedia/5-languages/5-07-php/40) | `public/index.php`, чистые include |
...
| Тема | Статья |
|------|--------|
| Установка, первая `print`, IDE | [16 — Первая программа](./16.md) |
| Задачи ЕГЭ и олимпиад (скрипт целиком) | [Lab / 1122 — Алгоритмы на Python](/lab/Примеры/1122) |
| Импорт, `sys.path`, `.pyc` | [11 — Архитектура CPython](./11.md) |
| Зависимости и venv | [39 — requirements.txt](./39.md) |
| Функции и области видимости | [24 — Функции](./24.md) |
