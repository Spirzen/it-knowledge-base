...
Когда выбирать API-ключ, а когда JWT и OAuth — [авторизация в интеграционных сценариях](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/1121#tokens-i-api-keys).
...
<div class="callout callout--info">
  ...
  <p>Очередь, state machine, hard/soft bounce, suppression list, webhooks ESP и SPF/DKIM/DMARC — в главе <a href="/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/144">Email-рассылка как распределённая система</a>. Краткий разбор для system design — <a href="/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/143#primer-servis-email-rassylki">пример в карте system design</a>.</p>
</div>
  </div>
