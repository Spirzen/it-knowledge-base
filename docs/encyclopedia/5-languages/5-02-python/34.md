...
1. Протокол и транспорт (HTTP, методы, статусы) — см. [HTTP как основа веб-интеграций](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/118); smoke-test эндпоинтов из CLI — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133).
...
Метрики CPU, памяти и сетевой нагрузки хоста — в [Практикуме Prometheus и Grafana](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/intro).
