...
1. Протокол и транспорт (HTTP, методы, статусы) — см. [HTTP как основа веб-интеграций](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/118).
