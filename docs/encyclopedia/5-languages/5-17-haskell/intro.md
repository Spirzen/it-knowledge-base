...
Имя языка дано в честь логика **Хаскелла Карри** — исследователя теории типов и комбинаторной логики. Отличительная черта Haskell — серьёзное отношение к типизации: — — $3.
