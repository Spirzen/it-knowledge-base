...
Материалы по углублённым темам: [паттерны и switch](./8.md), [консоль, файлы и HTTP](./9.md), [классы и ООП](./10.md), [Flutter](./311.md), [галерея готовых виджетов (Lab)](/lab/Примеры/1154).
