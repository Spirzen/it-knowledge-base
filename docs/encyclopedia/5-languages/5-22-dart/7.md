...
Дальше: [раздел Dart](/encyclopedia/5-languages/5-22-dart/intro) и [Flutter](./311.md) в энциклопедии; экраны с разбором — [Flutter — готовые виджеты](/lab/Примеры/1154).
...
- Запуск: `dart run bin/hello_dart.dart Timur` → `Привет, Timur!`.
...
После "Hello, World" — [консоль, файлы и HTTP](./9.md), [классы и ООП](./10.md), [паттерны Dart 3](./8.md). Для мобильного UI — [Flutter](./311.md) и практическая галерея [Flutter — готовые виджеты](/lab/Примеры/1154). Закрепление — [чек-лист самопроверки](./999.md).
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первая программа на Nim](/encyclopedia/5-languages/5-21-nim/7), [Первая программа на R](/encyclopedia/5-languages/5-23-r/7), [Первая программа на Zig](/encyclopedia/5-languages/5-20-zig/7), [Первая программа на Julia](/encyclopedia/5-languages/5-24-julia/7), [Первая программа на Elixir](/encyclopedia/5-languages/5-19-elixir/7), [Первая программа на Bash](/encyclopedia/5-languages/5-25-bash/122).
