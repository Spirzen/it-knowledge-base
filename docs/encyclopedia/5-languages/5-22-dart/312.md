...
<div class="callout callout--tip">
  ...
  Запускайте <code>flutter run</code> в терминале или через IDE. После изменения моделей иногда нужен hot restart (<code>R</code> в консоли) — см. <a href="/encyclopedia/1-basics/1-035-bazovaya-informatika/208">запуск приложений</a>.
</div>
</div>
