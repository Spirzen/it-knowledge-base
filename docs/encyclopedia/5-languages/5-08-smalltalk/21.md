...
- Модели не импортируют Morphic — их можно unit-тестировать ([Рекомендации по разработке на Smalltalk](./101.md)).
...
| Индекс при удалении "мимо" | Путаница 0-based и 1-based | В Pharo `removeAt:` — с **1** ([Типы данных и переменные в Smalltalk](./33.md)) |
...
Справочник Morphic — [§12](./5.md#12-графическая-система-morphic). Стиль и протоколы — [Рекомендации по разработке на Smalltalk](./101.md). Следующий уровень UI — [Morphic](./15.md).
