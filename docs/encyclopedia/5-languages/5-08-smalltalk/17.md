...
**Glamorous Toolkit** (**GT**) — среда **moldable development** ("формуемой разработки") для **[Pharo](./13.md)**. Это не замена языка, а **надстройка над образом**: набор инструментов, которые можно **перестраивать под предметную область**, а не только смотреть универсальный список методов в Browser.
