...
description: Примеры с наиболее часто используемыми HTML-элементами, дополеными серверной логикой.
---
...
```html
<form id="uploadForm" method="POST" enctype="multipart/form-Данные" action="upload.php">
