...
Для учебных игр на коде без движка Unity/Unreal — [Разработка игр на Python](/encyclopedia/5-languages/5-02-python/312) и сквозные проекты в [Практикуме разработки игр](/encyclopedia/9-spinoff/9-04-razrabotka-igr/praktikum-razrabotki-igr/intro) (Python/Pygame, [Java Survivors](/encyclopedia/9-spinoff/9-04-razrabotka-igr/praktikum-razrabotki-igr/8), [Приключения Урала Батыра](https://spirzen.github.io/OnlineCardGame/) на [TypeScript](/encyclopedia/5-languages/5-01-javascript/30)).
