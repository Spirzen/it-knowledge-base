...
<div class="callout callout--tip">
  ...
  В вводных статьях языков сложные механизмы по возможности даются **сначала на русском псевдокоде**, затем — синтаксисом конкретного языка (блоки "Справочно на …"). На старте выберите **один** язык из маршрута и пройдите его intro → первую программу, не смешивая правила владения, GC и типов.
</div>
  </div>
