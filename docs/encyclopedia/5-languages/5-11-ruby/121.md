...
description: Ключевые слова Ruby - синтаксические конструкции, приоритет операторов и нюансы семантики языка.
---
...
| `alias` | Создание альтернативного имени для метода | `alias full_name name` |
