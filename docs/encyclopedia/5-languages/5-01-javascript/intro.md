...
| 7 | Promise, Worker | [§ Асинхронность с типами](./30.md#асинхронность-с-типами), [Асинхронное программирование в JavaScript](./21.md) |
...
| Шаг | Материал | Зачем |
|-----|----------|-------|
| 0 | [Ошибки и исключения (теория)](/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111) → [обработка в JS](./242.md), [типы Error](./241.md) | До углубления в async и фреймворки |
