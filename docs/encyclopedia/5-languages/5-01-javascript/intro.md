...
Подборка по **JavaScript** в энциклопедии: синтаксис, первая программа и смежные темы. Пройдите один маршрут до конца, не смешивая несколько языков на старте.
...
| Шаг | Материал | Зачем |
|-----|----------|-------|
| 1 | [Основы JavaScript](./1.md) | Браузер |
| 2 | [Node.js API](./262.md) | Углубление |
| 3 | [React](./272.md) | Углубление |
