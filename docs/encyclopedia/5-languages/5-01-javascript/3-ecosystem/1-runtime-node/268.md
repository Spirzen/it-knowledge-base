...
Практика с Express — [262.md](./262.md), [263.md](./263.md). Модули CJS/ESM — [26.md](./26.md). Справочник API — [261.md](./261.md).
...
Именно этот шаг разобран пошагово в [262.md](./262.md) перед Express.
...
Для dev-сервера чаще `node --watch` или nodemon — [267.md](./267.md).
...
Не передавайте пользовательский ввод в `exec` — риск command injection. Для CPU-нагрузки в JS — `worker_threads` (см. [26.md](./26.md)).
...
В `async`-маршрутах Express используйте `try/catch` или `asyncHandler` — [263.md](./263.md).
...
На уровне драйвера — параметризованные запросы `$1`, `$2`. Выше — Prisma, Drizzle, TypeORM. Практикум REST + PostgreSQL остаётся в связке [262](./262.md) → [263](./263.md); углублённый разбор слоёв — в [26.md](./26.md) (блок с PostgreSQL) и справочнике [261.md](./261.md#13-работа-с-базами-данных).
...
| Тема | Материал |
|------|----------|
| Express, middleware | [263.md](./263.md) |
| npm и зависимости | [265.md](./265.md) |
| A–Z API | [261.md](./261.md) |
