...
Установка Node и nvm — в [Node.js — основы](./26.md). npm-скрипты — [npm — команды, зависимости и lock-файлы](./265.md).
...
На Windows для env используйте `cross-env` — см. [npm — команды, зависимости и lock-файлы](./265.md).
...
Сравнение Express / Fastify / Nest — в [Node.js - серверный JavaScript](./26.md) и [Express — middleware, маршруты и ошибки](./263.md).
