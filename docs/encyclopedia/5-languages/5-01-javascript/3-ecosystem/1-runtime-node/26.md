...
| № | Тема | Статья |
|---|------|--------|
| 1 | Первая программа, Express API | [262.md](./262.md) |
| 2 | **Runtime, event loop, модули** | **вы здесь** |
| 3 | npm: install, scripts, audit | [265.md](./265.md) |
| 4 | Папки, package.json, env | [266.md](./266.md) |
| 5 | fs, http, потоки | [268.md](./268.md) |
| 6 | Express: middleware, CORS | [263.md](./263.md) |
| 7 | CLI, Docker, production | [267.md](./267.md) |
| 8 | API + фронт | [264.md](./264.md) |
| — | Шпаргалка API | [261.md](./261.md) |
...
Минимальный сервер на встроенном `http` (разбор построчно — [268.md](./268.md)):
...
Подробнее про `fs`, потоки и `http` — [268.md](./268.md).
...
Зависимости и `node_modules` — [265.md](./265.md). Структура проекта — [266.md](./266.md).
...
Учебный путь начинается с **Express** — [262.md](./262.md), [263.md](./263.md). Сравнение и production-паттерны — [267.md](./267.md).
...
Пошаговый код REST + PostgreSQL в учебнике — блоки в [262.md](./262.md) и раздел «Практикум» в исторической версии материала; слои `routes` / `models` — [266.md](./266.md).

---

## Как мыслить о Node в production

Чеклист перед production (подробнее — [267.md](./267.md)):
