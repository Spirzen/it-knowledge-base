...
Пошаговый старт с кодом: [Первая программа на Next.js](./2731.md). Сервер на Node: [262](../1-runtime-node/262.md). Склейка фронта и API: [264](../1-runtime-node/264.md).
...
| Порт 3000 занят API | Сдвиньте API на 3001 — см. [264](../1-runtime-node/264.md) |
