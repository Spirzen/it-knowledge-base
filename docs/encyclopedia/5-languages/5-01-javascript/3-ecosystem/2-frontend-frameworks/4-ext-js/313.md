...
Тот же REST "Заметки", что в [Первая программа на Node.js](../../1-runtime-node/262.md): настройте `url`, `rootProperty` и поля модели под ваш JSON.

---

## Связанные материалы

- [Первая программа на Ext JS](./312.md) — первый проект
- [Ext JS](./31.md) — архитектура MVC/MVVM
- [Справочник по Ext JS](./311.md)
