...
Учебный разбор — [27.md](./27.md#карта-тем-react), пошаговый старт — [272.md](../../272.md). **Готовые блоки UI** (счётчик, todo, форма, modal, Context, Router) с построчным разбором — [React — компоненты-рецепты](/lab/Примеры/1146).
...
В [Next.js](../3-meta-frameworks/273.md) часто комбинируют CSS Modules и Tailwind. Подробный контекст — [§ Экосистема в 27.md](./27.md#экосистема-react).
...
Разбор для новичка — [272.md](../../272.md#частые-ошибки) и [галерея типовых ошибок](/lab/Примеры/1146#частые-ошибки).
...
Связанное задание с API — [272.md — «Заметки»](../../272.md#задание-заметки). Готовые рецепты под лабораторную — [React — компоненты-рецепты](/lab/Примеры/1146) (todo, калькулятор, форма входа, список с `fetch`).
