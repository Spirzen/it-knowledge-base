...
Ставит зависимости, запускает скрипты, публикует пакеты. Разбор SemVer и lock-файлов — [265.md](../1-runtime-node/265.md).
...
|--------|----------------|
| Первый Node-проект | `node`, `npm init`, `npm install` → [262](../1-runtime-node/262.md) |
