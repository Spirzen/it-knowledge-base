...
Учебный разбор — [27.md](./27.md#карта-тем-react), практика — [272.md](./272.md).
...
| **Tailwind CSS** | Utility-классы | Часто с [shadcn/ui](https://ui.shadcn.com/) — копируемые компоненты на Radix |
...
Разбор для новичка — [272.md](./272.md#частые-ошибки).
...
Связанное задание с API — [272.md — «Заметки»](./272.md#задание-заметки).
