...
Справочник-шпаргалка по **React**: типы, синтаксис, стандартная библиотека, типовые паттерны. Не заменяет пошаговое обучение. Учебный курс: [раздел](/encyclopedia/5-languages/5-01-javascript/intro).

---

## Краткое пояснение

Шпаргалка по **React**: таблицы синтаксиса, API, команд и параметров — для быстрого поиска фактов.
...
В [Next.js](./273.md) часто комбинируют CSS Modules и Tailwind. Подробный контекст — [§ Экосистема в 27.md](./27.md#экосистема-react).
...
**Справочники** — [Справочник по Node](/encyclopedia/5-languages/5-01-javascript/261), [Справочник по Vue.js](/encyclopedia/5-languages/5-01-javascript/281), [Справочник по JavaScript](/encyclopedia/5-languages/5-01-javascript/251), [Справочник по Angular](/encyclopedia/5-languages/5-01-javascript/291), [Справочник-шпаргалка по Git](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/115), [Справочник по TypeScript](/encyclopedia/5-languages/5-01-javascript/301).
