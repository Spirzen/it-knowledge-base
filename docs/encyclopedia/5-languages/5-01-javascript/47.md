...
**См. также:** [Работа с HTML (DOM)](./102.md) · [События](./23.md) · [ResizeObserver](./38.md#resizeobserver) · [Применение JS в вебе](./14.md) · [Web API в браузере](/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/120)
...
<div class="callout callout--tip">
  ...
  Учебные фигуры на Canvas через библиотеку p5.js — квадрат, треугольник, цветок, фракталы, анимация — с построчным разбором в <a href="/lab/Примеры/1114">Примеры фигур на Processing/p5.js</a>. Те же фигуры <strong>векторной разметкой</strong> без Canvas — <a href="/lab/Примеры/1119">SVG — рисунки кодом</a> (иконки, масштаб без потерь). Теория API ниже; p5 — copy-paste в <a href="https://editor.p5js.org/" target="_blank" rel="noopener noreferrer">editor.p5js.org</a>.
</div>
</div>
...
<div class="callout callout--warning">
  ...
  <div class="callout-body">
  Если задать <code>canvas &#123; width: 800px; height: 600px; &#125;</code>, а атрибуты <code>width="400" height="300"</code>, браузер <strong>растянет</strong> bitmap — картинка будет размытой. Для Retina умножайте атрибуты на <code>devicePixelRatio</code> или синхронизируйте размеры в <a href="./38.md#resizeobserver">ResizeObserver</a>.
</div>
</div>
...
Краткий пример в справочнике BOM — [22.md, графика Canvas](./22.md); DOM и события — [102.md](./102.md), [23.md](./23.md).
