...
title: Практика
description: Настало время небольшой практики. Вернёмся к нашему проекту - калькулятор на HTML, и в файле script.js реализуем логику калькулятора — создайте новый файл script.js, получите элементы из DOM-дерева и…
---
# Практика
...
Promise.any([fetch('/mirror1/Данные'), fetch('/mirror2/Данные')])
  .then(response => response.json())
  .then(Данные => console.log('Получено:', Данные));
```
