...
related:
  - title: "Первая программа на Node.js"
    doc: encyclopedia/5-languages/5-01-javascript/262
  - title: "Node.js — серверный JavaScript"
    doc: encyclopedia/5-languages/5-01-javascript/26
...
См. также: [Первая программа на Node.js](./262.md) · [модули Node](./26.md) · [ESM в браузере](./40.md) · [Python — if __name__ == "__main__"](/encyclopedia/5-languages/5-02-python/40).
...
<div class="callout callout--info">
  ...
  В браузере скрипт подключают через <code>&lt;script type="module"&gt;</code> — там нет «импорта без запуска» того же файла как отдельной точки входа. Паттерн с <code>require.main</code> актуален для <strong>Node.js</strong>, CLI и тестов.
</div>
</div>
