...
<div class="callout callout--info">
  <div class="callout-title">Сначала — теория и синтаксис</div>

  <div class="callout-body">
  Определения «ошибка vs исключение» и раскрутка стека — <a href="/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111">4.06 / 111</a>.<br />
  Практика <code>try/catch</code>, <code>async/await</code>, <code>unhandledrejection</code> — <a href="./242.md">Обработка исключений в JavaScript</a>.
</div>
</div>
