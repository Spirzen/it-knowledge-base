...
<LanguageIntroPlay topic="javascript" />
...
Практика Node в энциклопедии: [первая программа](./3-ecosystem/1-runtime-node/262.md) → [обзор runtime](./3-ecosystem/1-runtime-node/26.md) → [npm](./3-ecosystem/1-runtime-node/265.md) → [Express](./3-ecosystem/1-runtime-node/263.md). Точка входа скрипта (`require.main`, ESM) — [48](./3-ecosystem/1-runtime-node/48.md). Полный маршрут — [Node.js](./3-ecosystem/1-runtime-node/intro.md).
