...
Справочник-шпаргалка по **Ext JS**: типы, синтаксис, стандартная библиотека, типовые паттерны. Не заменяет пошаговое обучение. Учебный курс: [раздел](/encyclopedia/5-languages/5-01-javascript/intro).

---

## Краткое пояснение

Система компонентов в этом фреймворке.
...
**Справочники** — [Справочник по TypeScript](/encyclopedia/5-languages/5-01-javascript/301), [Справочник по Django](/encyclopedia/5-languages/5-02-python/301), [Справочник по Angular](/encyclopedia/5-languages/5-01-javascript/291), [Справочник по модулю Turtle](/encyclopedia/5-languages/5-02-python/321), [Справочник по Vue.js](/encyclopedia/5-languages/5-01-javascript/281), [Справочник по Flask](/encyclopedia/5-languages/5-02-python/342).
