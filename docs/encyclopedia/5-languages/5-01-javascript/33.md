...
Связь с остальным разделом: [React](./3-ecosystem/2-frontend-frameworks/1-react/27.md), [Vue](./3-ecosystem/2-frontend-frameworks/2-vue/28.md), [Node.js](./3-ecosystem/1-runtime-node/26.md), [Первая программа на Node.js](./3-ecosystem/1-runtime-node/262.md), [раздел тестирования](/encyclopedia/7-project/7-05-testirovanie/intro).
...
Добавьте тест на `POST /notes` с телом `{ text: '…' }` — так вы закрепите [Express 263](./3-ecosystem/1-runtime-node/263.md).

---

## E2E — граница этой статьи

Сценарии "открыл Chrome → ввёл логин → увидел список" — **Playwright** или **Cypress**. Они медленнее и чувствительнее к вёрстке, зато ловят ошибки стыка фронта и бэка. Упоминаются в [Vue](./3-ecosystem/2-frontend-frameworks/2-vue/28.md) и [React](./3-ecosystem/2-frontend-frameworks/1-react/27.md).
