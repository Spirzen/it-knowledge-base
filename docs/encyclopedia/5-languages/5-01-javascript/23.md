...
<div class="callout callout--tip">
  ...
  События форм — <a href="./36.md">валидация</a>; окно и URL — <a href="./41.md">BOM</a>; перетаскивание файлов — <a href="./42.md">чтение файлов</a>; клик и системное «Поделиться» — <a href="./44.md">Web Share API</a>; обзор API браузера — <a href="/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/120">Web API в браузере</a>; кодовые примеры — <a href="/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/121">Web API на практике</a>.
</div>
  </div>
