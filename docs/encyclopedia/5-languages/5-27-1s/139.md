...
Automation и COM — **Windows**, разработка и эксплуатация на Linux-сервере **не** применимы. Для серверной интеграции — [129](129.md)–[131](131.md).
...
Или `Новый COMОбъект("Excel.Application")`. Только **Windows**, код в **`&НаКлиенте`**. Для серверной генерации файлов — табличный документ, [1310.md](1310.md) или HTTP API.
