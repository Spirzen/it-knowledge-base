...
Для больших таблиц данные лучше читать батчами, чтобы снизить нагрузку на память:
...
Смежные материалы: [Groovy и Java](/encyclopedia/5-languages/5-12-groovy/20), [Jenkins Pipeline](/encyclopedia/5-languages/5-12-groovy/22) для запуска миграций в CI.
...
Дальше по кейсу: [Spock](/encyclopedia/5-languages/5-12-groovy/21), [Jenkins Pipeline](/encyclopedia/5-languages/5-12-groovy/22).
