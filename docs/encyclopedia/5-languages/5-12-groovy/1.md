...
<ExternalPlayEmbed example="data-markup/language-intro-play" title="Обзор языка разметки/данных" minHeight={520} playProps={{ topic: 'groovy' }} />

<ExternalPlayEmbed example="basics/tech-history-play" title="История технологий" minHeight={420} playProps={{ topic: 'groovy' }} />
