...
Подробный справочник по всем конструкциям: [Справочник по Groovy](/encyclopedia/5-languages/5-12-groovy/3).
...
Частые операции через GDK (расширения к стандартным классам Java):
