...
| Кто вы | Маршрут |
|--------|---------|
| **Уже пишете на Java/Kotlin** | [Что требуется знать перед началом изучения языка программирования Groovy](./1001.md) → [Groovy и Java](./20.md) → [Основы языка Groovy](./11.md) (делегирование замыканий) → [Справочник по языку Groovy](./3.md) (Spock, Jenkins) |
...
| Сравнивать `==` с Java | В Groovy `==` → `equals` — [Groovy и Java — совместимость и отличия](./20.md) |
