...
<div class="callout callout--info">
  ...
  Groovy компилируется в байт-код JVM: исключения — те же классы <code>java.lang.*</code>, синтаксис <code>try</code> / <code>catch</code> / <code>finally</code>. Компилятор Groovy <strong>не требует</strong> объявлять проверяемые исключения, в отличие от Java. См. <a href="/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111">ошибки и исключения</a> и <a href="/encyclopedia/5-languages/5-03-java/211">иерархию в Java</a>.
</div>
  </div>
