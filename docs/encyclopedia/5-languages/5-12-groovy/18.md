...
<ExternalCodeEmbed example="groovy/groovy-512-18-001" title="Базовый синтаксис" minHeight={390} />
...
<ExternalCodeEmbed example="groovy/groovy-512-18-002" title="Базовый синтаксис" minHeight={408} />
...
| **FastJ** | 2D-игры на JVM | [Шаблон на Groovy](./24.md), Gradle, кроссплатформа |
...
| Продукт | Роль Groovy |
|---------|-------------|
| **Jenkins** | Pipeline, [Job DSL](./25.md), [shared libraries](./26.md), шаги автоматизации |
...
Связанные статьи — [Spock — первая спецификация](/encyclopedia/5-languages/5-12-groovy/21), [Gradle Groovy DSL](/encyclopedia/5-languages/5-12-groovy/23), [Jenkins Pipeline](/encyclopedia/5-languages/5-12-groovy/22), [Job DSL Playground](/encyclopedia/5-languages/5-12-groovy/25), [Jenkins Shared Library](/encyclopedia/5-languages/5-12-groovy/26).
...
<ExternalCodeEmbed example="groovy/groovy-512-18-003" title="Сквозной кейс — JSON-конвейер каталога" minHeight={336} />
