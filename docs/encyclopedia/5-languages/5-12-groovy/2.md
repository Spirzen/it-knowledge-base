...
<ExternalPlayEmbed example="lab/first-program-play" title="Первая программа" minHeight={420} playProps={{ language: 'groovy' }} />
...
<ExternalCodeEmbed example="groovy/groovy-512-2-001" title="Где применяют Groovy" minHeight={318} />
...
<ExternalPlayEmbed example="basics/installer-wizard-play" title="Мастер установки" minHeight={480} playProps={{ appName: 'Установка среды Groovy', productName: 'Apache NetBeans + JDK', welcomeText: 'Сначала JDK, затем NetBeans с поддержкой Java/Groovy. Groovy можно добавить через SDKMAN или встроенный Maven.', extraOptionsLabel: 'Установить Groovy plugin / поддержку Gradle', cardSubtitle: 'Шаг 1 — установка NetBeans ниже' }} />
...
![image.png](https://assets.spirzen.ru/encyclopedia/5-languages/5-12-groovy/image.png)
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первая программа на Smalltalk](/encyclopedia/5-languages/5-08-smalltalk/11), [Первая программа на Haskell](/encyclopedia/5-languages/5-17-haskell/7), [Первая программа на Lua](/encyclopedia/5-languages/5-15-lua-i-luau/13), [Первая программа на Scala](/encyclopedia/5-languages/5-18-scala/7), [Первая программа на Swift](/encyclopedia/5-languages/5-14-swift/20), [Первая программа на Elixir](/encyclopedia/5-languages/5-19-elixir/7).
