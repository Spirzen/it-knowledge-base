...
<InstallerWizardPlay
  appName="Установка среды Groovy"
  productName="Apache NetBeans + JDK"
  welcomeText="Сначала JDK, затем NetBeans с поддержкой Java/Groovy. Groovy можно добавить через SDKMAN или встроенный Maven."
  extraOptionsLabel="Установить Groovy plugin / поддержку Gradle"
  cardSubtitle="Шаг 1 — установка NetBeans ниже"
/>
