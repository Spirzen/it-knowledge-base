...
Перед стартом: [что знать перед Groovy](/encyclopedia/5-languages/5-12-groovy/1001). После Hello World логично перейти к [типам данных](/encyclopedia/5-languages/5-12-groovy/12) и [Groovy vs Java](/encyclopedia/5-languages/5-12-groovy/20).
