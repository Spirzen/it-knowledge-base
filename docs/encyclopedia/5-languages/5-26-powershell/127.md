...
Скрипт с `$password = 'P@ssw0rd'` работает на демо и ломает безопасность в продакшене. Автоматизация по [Практическая автоматизация — модель и окупаемость](/encyclopedia/5-languages/5-26-powershell/124) и [Триггеры — расписание и наблюдатели](/encyclopedia/5-languages/5-26-powershell/126) почти всегда требует учётных данных — SQL, SMTP, Azure, сетевые шары. Здесь — принципы и практика PowerShell.
...
| **Azure Automation** | Credential asset, Managed Identity — [Экосистема автоматизации на PowerShell](/encyclopedia/5-languages/5-26-powershell/11) | Runbook в облаке |
...
| Тема | Материал |
|------|----------|
| Конфиги без секретов в JSON | [Конфигурация и адаптивные скрипты](/encyclopedia/5-languages/5-26-powershell/128) |
| Триггеры и контекст УЗ | [Триггеры — расписание и наблюдатели](/encyclopedia/5-languages/5-26-powershell/126) |
| Azure Automation, runbook | [Экосистема автоматизации на PowerShell](/encyclopedia/5-languages/5-26-powershell/11) |
