...
<div class="callout callout--tip">
  ...
  [Практическая автоматизация — модель и окупаемость — модель](/encyclopedia/5-languages/5-26-powershell/124) → [Стандартные блоки и модули PowerShell — блоки и модули](/encyclopedia/5-languages/5-26-powershell/125) → **эта статья** → практика в [2.05/112](/encyclopedia/2-system-network/2-05-terminal/112#triggery-avtomatizatsii).
  </div>
</div>
...
<ExternalCodeEmbed example="powershell/powershell-526-126-001" title="Скрипт-наблюдатель и исполнитель" minHeight={480} />
...
| 6 | Секреты берутся из хранилища, а не из `.ps1`? — [Рекомендации по написанию PowerShell-скриптов](/encyclopedia/5-languages/5-26-powershell/111) |
...
| Конфигурация JSON | [Конфигурация и адаптивные скрипты](/encyclopedia/5-languages/5-26-powershell/128) |
| Тесты перед продакшеном | [Рекомендации по написанию PowerShell-скриптов — Pester](/encyclopedia/5-languages/5-26-powershell/111), [Автоматизация задач в Windows с помощью PowerShell — Pester](/encyclopedia/2-system-network/2-05-terminal/112) |
