...
<ExternalPlayEmbed example="languages/power-shell-shell-play" title="PowerShell Shell" minHeight={480} playProps={{ lesson: 'modules' }} />
...
<ExternalCodeEmbed example="powershell/powershell-526-121-001" title="Скрипт автоматического обновления ПО" minHeight={336} />
...
<ExternalCodeEmbed example="powershell/powershell-526-121-002" title="Скрипт резервного копирования сжатых архивов" minHeight={318} />
