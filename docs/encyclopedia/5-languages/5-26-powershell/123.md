...
<ExternalCodeEmbed example="powershell/powershell-526-123-001" title="Синтаксис объявления переменных" minHeight={390} />
...
| `|` | Передача объекта следующему командлету | `Get-Process | Where-Object ...` |
...
<ExternalCodeEmbed example="powershell/powershell-526-123-002" title="Определение функций" minHeight={336} />
...
Передача объектов между командами (поток Success). Подробнее — [основы](/encyclopedia/5-languages/5-26-powershell/112), углублённо — [объектная модель](/encyclopedia/5-languages/5-26-powershell/119).
...
<ExternalCodeEmbed example="powershell/powershell-526-123-003" title="XML и JSON" minHeight={318} />
...
<ExternalCodeEmbed example="powershell/powershell-526-123-004" title="Паттерн &quot;Pipeline Processing&quot;" minHeight={336} />
...
1. [Основы языка](/encyclopedia/5-languages/5-26-powershell/112)
2. [Синтаксис и операторы](/encyclopedia/5-languages/5-26-powershell/113)
3. [Обработка ошибок](/encyclopedia/5-languages/5-26-powershell/12)
4. [Функции и параметры](/encyclopedia/5-languages/5-26-powershell/118)

Так справочник становится не "стеной текста", а инструментом ежедневной разработки.
