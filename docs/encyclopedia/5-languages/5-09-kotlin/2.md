...
<InstallerWizardPlay
  appName="Установка JDK для Kotlin"
  productName="JDK 17+"
  welcomeText="Kotlin компилируется в байт-код JVM — нужен JDK. Затем установите IntelliJ IDEA с плагином Kotlin."
  extraOptionsLabel="Добавить JAVA_HOME в переменные среды"
  cardSubtitle="Далее — создание Maven-проекта в IDE"
/>
