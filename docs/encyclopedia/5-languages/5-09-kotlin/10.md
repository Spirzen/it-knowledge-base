...
**Javalin** — минималистичный HTTP-фреймворк поверх Jetty. Лаконичный API без тяжёлого DI — удобен для небольших REST-сервисов рядом с Ktor и Spring Boot. Сводная таблица — [Open-source веб-фреймворки](/encyclopedia/4-code-dev/4-17-veb-razrabotka/8).
