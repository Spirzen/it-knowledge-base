...
Теория Compose и Activity — [Jetpack Compose — первый экран](/encyclopedia/5-languages/5-09-kotlin/229). Общий маршрут мобильной разработки на Kotlin — [Мобильные приложения на Kotlin](/encyclopedia/5-languages/5-09-kotlin/234).
...
- Следующий шаг — [Kotlinochi](./23.md) (ViewModel + DataStore) или [Room, ViewModel и Compose — список заметок](./231.md) (Room).
...
<ExternalCodeEmbed example="kotlin/kotlin-509-22-001" title="Файл `app/build.gradle.kts`" minHeight={678} />
...
Подробнее про сборку APK — [Сборка и развёртывание мобильных приложений](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/112).
...
<ExternalCodeEmbed example="kotlin/kotlin-509-22-002" title="Код" minHeight={408} />
...
<ExternalCodeEmbed example="kotlin/kotlin-509-22-003" title="Код" minHeight={720} />
...
При **configuration change** (поворот, смена языка) Android уничтожает и создаёт Activity заново. Без `rememberSaveable` или ViewModel счётчик обнулится — типичная ошибка новичков ([Jetpack Compose — первый экран](/encyclopedia/5-languages/5-09-kotlin/229)).

### Код



<ExternalCodeEmbed example="kotlin/kotlin-509-22-004" title="Код" minHeight={390} />
...
Когда появятся сеть, БД или таймер — переносите state в **ViewModel** ([Kotlinochi](./23.md), [Room, ViewModel и Compose — список заметок](./231.md)).
...
- **Практика Android** — так делают production-приложения ([Kotlin в мобильных приложениях](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/1135)).
...
<ExternalCodeEmbed example="kotlin/kotlin-509-22-005" title="Использование в Compose" minHeight={408} />
...
| Сборка и USB-установка | [Отладка по USB на Android](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/1121) |
| Публикация в Store | [Публикация Android-приложения](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/1141) |
