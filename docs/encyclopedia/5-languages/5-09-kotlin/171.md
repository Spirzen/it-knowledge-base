...
<div class="callout callout--info">
  ...
  <a href="/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111">Ошибки, исключения и отказоустойчивость</a> — определения и раскрутка стека.<br />
  Практика <code>try/catch</code> на JVM — [Обработка исключений в Java](/encyclopedia/5-languages/5-03-java/21); в Kotlin все исключения в исходниках <strong>непроверяемые</strong>, для ожидаемых сбоев часто используют <code>Result</code>.
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Kotlin на JVM использует ту же модель **раскрутки стека**, что Java, но все исключения в исходниках Kotlin — **непроверяемые**: нет обязательного `throws`.

  При вызове Java-API с проверяемыми исключениями их всё равно можно перехватить в `try` / `catch`.

  Общие термины — [ошибки и исключения](/encyclopedia/4-code-dev/4-06-arhitektura-vypolneniya/111); практика на Java — [Обработка исключений в Java](/encyclopedia/5-languages/5-03-java/21).
</div>
  </div>
