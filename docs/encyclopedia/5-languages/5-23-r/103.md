...
Файл `tips.csv` проще всего получить из Python: `sns.load_dataset("tips").to_csv("tips.csv", index=False)` — см. [Python для анализа данных](/encyclopedia/3-data-markup/3-11-analiz-dannyh/424). Общий маршрут по инструментам — [Маршрут Excel → R → Python](/encyclopedia/3-data-markup/3-11-analiz-dannyh/430).
...
Теория — [основы статистики](/encyclopedia/3-data-markup/3-11-analiz-dannyh/42#pyat-shagov-statisticheskogo-vyvoda), регрессия в трёх средах — [Линейная регрессия — Excel, R и Python](/encyclopedia/3-data-markup/3-11-analiz-dannyh/432).
