...
<ExternalPlayEmbed example="languages/ado-data-access-play" title="ADO.NET — доступ к данным" minHeight={480} />
...
1. [ADO.NET и Dapper — первая программа](../5-05-csharp/442.md) — CRUD на ADO.NET и Dapper.
2. Тот же сценарий в [Entity Framework Core — первая программа](../5-05-csharp/441.md) на EF Core.
