...
Обёртки инкапсулируют шаблонный код и делают его переиспользуемым. Подробнее для новичков — [свойства-обёртки в Swift](/encyclopedia/5-languages/5-14-swift/25).
