...
<div class="callout callout--warning">
  ...
  Секреты API — не в бинарнике; используйте backend proxy (BFF) с аутентификацией пользователя. Подробнее — <a href="/encyclopedia/6-ai/6-10-bezopasnost-pri-rabote-s-ii/10">безопасная интеграция LLM в мобильные приложения</a>, <a href="/encyclopedia/4-code-dev/4-14-razrabotka-i-otladka/intro">разработка и отладка</a>.
</div>
</div>
