...
description: Ключевое слово Значение Пример ---------------------------------- async Указание асинхронной функции func fetchData() async - Данные await Ожидание завершения асинхронной операции let Данные = await…
---
...
| `case` | Вариант в операторе `switch` или `enum` | `case .success(let Данные): process(Данные)` |
...
| `throws` | Указание, что функция может генерировать ошибки | `func fetchData() throws -> Данные { }` |
...
| `try` | Вызов функции, которая может генерировать ошибки | `let Данные = try loadData()` |
...
| Ключевое слово | Значение | Пример |
|----------------|----------|--------|
| `async` | Указание асинхронной функции | `func fetchData() async -> Данные { }` |
| `await` | Ожидание завершения асинхронной операции | `let Данные = await fetchData()` |
