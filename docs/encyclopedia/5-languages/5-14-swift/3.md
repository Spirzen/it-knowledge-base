...
**Учебные статьи:** [Типы данных](./13.md) · [Работа с данными](./16.md).
...
**Операции** `Array` (изменяемый `var`):

| Действие | Метод / синтаксис |
|----------|-------------------|
| Добавить в конец | `append(value)`, `append(contentsOf:)` |
| Вставить по индексу | `insert(value, at: index)` |
| Прочитать | `array[index]` |
| Заменить | `array[index] = value` |
| Удалить | `remove(at:)`, `removeLast()` |
...
**Операции** — `dict[key] = value` (запись), `dict[key]` (чтение → `Optional`), `removeValue(forKey:)`, `updateValue(_:forKey:)`.
...
**Операции** — `insert(value)`, `remove(value)`, `contains(value)`.
...
<ExternalCodeEmbed example="swift/swift-514-3-001" title="1. Структуры (`struct`)" minHeight={336} />
...
<ExternalCodeEmbed example="swift/swift-514-3-002" title="2. Классы (`class`)" minHeight={372} />
...
<ExternalCodeEmbed example="swift/swift-514-3-003" title="7. Расширения (`extension`)" minHeight={318} />
...
<ExternalCodeEmbed example="swift/swift-514-3-004" title="2. Обобщённое программирование (`Generics`)" minHeight={318} />
...
<ExternalCodeEmbed example="swift/swift-514-3-005" title="5. Акторы (`Actor`)" minHeight={462} />
...
<ExternalCodeEmbed example="swift/swift-514-3-006" title="7. Паттерны проектирования в Swift" minHeight={408} />
...
<ExternalCodeEmbed example="swift/swift-514-3-007" title="7. Паттерны проектирования в Swift" minHeight={390} />
...
<ExternalCodeEmbed example="swift/swift-514-3-008" title="2. Тестирование" minHeight={390} />
...
<ExternalCodeEmbed example="swift/swift-514-3-009" title="3. Документирование кода" minHeight={318} />
...
<ExternalCodeEmbed example="swift/swift-514-3-010" title="4. Инструменты разработки" minHeight={354} />
...
**Справочники** — [Справочник по языку Rust](/encyclopedia/5-languages/5-13-rust/3), [Справочник по Lua](/encyclopedia/5-languages/5-15-lua-i-luau/3), [Справочник по языку Groovy](/encyclopedia/5-languages/5-12-groovy/3), [Справочник по COBOL](/encyclopedia/5-languages/5-16-starye-yazyki/Cobol/711), [Справочник по языку Ruby](/encyclopedia/5-languages/5-11-ruby/3), [Справочник по языку Fortran](/encyclopedia/5-languages/5-16-starye-yazyki/Fortran/811).
