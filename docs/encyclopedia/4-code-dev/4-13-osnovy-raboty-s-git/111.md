...
<div class="callout callout--tip">
  ...
  <div class="callout-body">
  <p>Команды <code>cd</code>, <code>ls</code>/<code>dir</code>, кавычки в путях — в разделе <a href="/encyclopedia/2-system-network/2-05-terminal/intro">«Терминал» (часть 2)</a>. Здесь — установка Git и доступ к серверу.</p>
</div>
  </div>
