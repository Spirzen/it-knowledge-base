...
Следующий шаг после настройки — ежедневные команды в [«Как работать с Git»](./112). Держать под рукой можно [12 команд](./115#12-komand) — `init`, `add`, `commit`, `push`, ветки и слияние.
