...
<InstallerWizardPlay
  appName="Установка Git for Windows"
  productName="Git"
  welcomeText="Мастер установит git.exe, Git Bash и опционально добавит Git в PATH для PowerShell и IDE."
  extraOptionsLabel="Git from the command line and also from 3rd-party software (рекомендуется)"
  cardSubtitle="Далее — пошаговая установка с git-scm.com"
/>
