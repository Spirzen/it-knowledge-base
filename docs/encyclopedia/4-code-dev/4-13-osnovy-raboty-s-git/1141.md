...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Готовые блоки команд с построчным разбором — <a href="/lab/Примеры/1123">лабораторная «Git — шпаргалка сценариев»</a> (<a href="/lab/Примеры/1123#push-отклонён">push отклонён</a>, <a href="/lab/Примеры/1123#откат-reset">откат</a>, <a href="/lab/Примеры/1123#stash-временно-спрятать-правки">stash</a>). Здесь — диагностика, зоны риска и пошаговые карточки.
</div>
</div>
