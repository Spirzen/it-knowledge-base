...
description: "Эта глава — практический справочник по симптомам: «случилось X → сначала проверь Y → сделай Z»."
...
<div class="callout callout--tip">
  ...
  Неотслеживаемые файлы <code>reset --hard</code> не трогает; для них — <code>git clean</code>. Оба действия необратимы без <code>reflog</code> / резервной копии.
</div>
