...
Эта глава — **практический справочник по симптомам**: "случилось X → сначала проверь Y → сделай Z". [12 команд на каждый день](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/115#12-komand) — карманный набор; полная шпаргалка по CLI — в [справочнике 115](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/115); базовый цикл и три зоны — в ["Как работать с Git"](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/112); команда и PR — в [рекомендациях](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/114); секреты и `.gitignore` — в [отдельном руководстве](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/116).
