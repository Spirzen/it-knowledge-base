...
description: ".gitignore — текстовый файл в корне (или в подпапках) репозитория Git. В нём перечисляют файлы и каталоги, которые не нужно хранить в истории версий: секреты, кэш, сборки, локальные настройки IDE."
...
- [ ] `.gitignore` создан в **корне** реpositория
