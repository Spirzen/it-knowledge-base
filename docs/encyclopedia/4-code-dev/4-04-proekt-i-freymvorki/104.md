...
Цепочка развёртывания bare metal → ВМ → контейнер — [четыре модели](/encyclopedia/1-basics/1-035-bazovaya-informatika/508#chetiryre-modeli-razvertyvaniya).
...
Перед первым запуском — [Запуск и перезапуск приложений](/encyclopedia/1-basics/1-035-bazovaya-informatika/208) (терминал, порты, остановка).
...
[Запуск приложений](/encyclopedia/1-basics/1-035-bazovaya-informatika/208).
