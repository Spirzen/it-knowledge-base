...
<div class="callout callout--info">
  ...
  Здесь — <strong>пакеты из реестра</strong> (pip, npm, NuGet). Про связи между классами и модулями в архитектуре — раздел <a href="/encyclopedia/4-code-dev/4-09-zavisimosti/intro">Зависимости (DIP, DI)</a>. Про сами библиотеки как понятие — <a href="/encyclopedia/4-code-dev/4-04-proekt-i-freymvorki/101">Библиотека</a>.
</div>
</div>
...
| Тема | Статья |
|------|--------|
| Python, pip, пример с `requests` | [39 — Зависимости Python](/encyclopedia/5-languages/5-02-python/39) |
