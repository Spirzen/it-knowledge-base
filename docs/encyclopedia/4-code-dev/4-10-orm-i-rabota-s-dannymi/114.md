...
<ExternalPlayEmbed example="code-dev/orm-demo" title="ORM — сопоставление" minHeight={560} />

<ExternalPlayEmbed example="code-dev/orm-migration-play" title="Code First / Database First" minHeight={560} />
