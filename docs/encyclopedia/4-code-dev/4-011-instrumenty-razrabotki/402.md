...
Подробнее об экосистемах — [Python](/encyclopedia/5-languages/5-02-python/intro), [Bash](/encyclopedia/5-languages/5-25-bash/intro), [PowerShell](/encyclopedia/5-languages/5-26-powershell/intro). Обзор инструментов — в [главе про софт](/encyclopedia/1-basics/1-035-bazovaya-informatika/intro).
