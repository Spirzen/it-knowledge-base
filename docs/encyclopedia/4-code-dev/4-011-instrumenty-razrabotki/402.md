...
Подробнее об экосистемах — [Python](/encyclopedia/5-languages/5-02-python/intro), [Bash](/encyclopedia/5-languages/5-25-bash/intro), [PowerShell](/encyclopedia/5-languages/5-26-powershell/intro). Обзор инструментов — в [главе про софт](/encyclopedia/1-basics/1-035-bazovaya-informatika/506).
...
Путь `/mnt/d/` — диск `D:` Windows. Скрипты из WSL удобно вызывать из [Task Scheduler](/encyclopedia/4-code-dev/4-011-instrumenty-razrabotki/402): `wsl.exe -e bash /home/user/backup.sh`.
...
Храните `.ahk` в `Documents\Scripts`, автозапуск через ярлык в `shell:startup` или [Task Scheduler](/encyclopedia/1-basics/1-035-bazovaya-informatika/506).
...
**Следующий шаг по карте:** [виртуальные машины и Home Lab](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/10) — место, где скрипты разворачивают сервисы без риска для основной системы.
