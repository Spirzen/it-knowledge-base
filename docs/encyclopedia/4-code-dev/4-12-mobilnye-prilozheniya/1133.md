...
Статья полезна в двух сценариях: миграция команды .NET в мобильную разработку и поддержка единой кодовой базы для Android, iOS и desktop. Для быстрого старта используйте этот материал вместе с [.NET MAUI — первая программа](/encyclopedia/5-languages/5-05-csharp/4513) и [публикацией Android](./1141.md).
...
Для команд на **.NET** release-сборка MAUI обычно **проще**, чем у [React Native](./1131.md) или [Expo](./1132.md) на том же Windows-хосте:
...
Общая таблица стеков и советы для Windows — [Сборка и развёртывание](./112.md#slozhnost-sborki-sravnenie-stekov).
