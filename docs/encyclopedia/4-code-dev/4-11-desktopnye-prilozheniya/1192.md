...
Пошаговые рецепты **WPF** — в первую очередь **XAML** + при необходимости code-behind. Практикум — [Первая форма WPF — XAML, стили и шаблоны](./119.md), платформа — [Разработка приложений для Windows (Microsoft Learn)](./116.md). **Готовые окна с разбором** — [C# WinForms и WPF — простые окна](/lab/Примеры/1138). Синтаксис XAML — [справочник XAML](/encyclopedia/3-data-markup/3-04-konfiguratsii-i-dannye/6). Общие имена элементов — [Архитектура десктопных приложений](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/1#элементы-управления-и-ввод-данных); UI-поток — [Особенности разработки десктопных приложений](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/112.md). Язык C# — [раздел C#](/encyclopedia/5-languages/5-05-csharp/intro).
...
<ExternalCodeEmbed example="xml/code-411-1192-001" title="Контейнер (Grid / StackPanel)" minHeight={354} />
...
Шаблон элемента — **DataTemplate** (см. [Первая форма WPF — XAML, стили и шаблоны](./119.md)).
