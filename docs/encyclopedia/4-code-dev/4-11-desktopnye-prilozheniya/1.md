...
Подробнее о DirectX и выборе платформы — [116.md](./116.md).
...
3. [Electron](./114.md), [WinForms](./115.md) ([Lab — примеры](/lab/Примеры/1138)), [Tkinter](/encyclopedia/5-languages/5-02-python/3111) ([примеры](/lab/Примеры/1124)), [Java Swing](/encyclopedia/5-languages/5-03-java/311) ([примеры](/lab/Примеры/1143)) или [React + Electron](/lab/Примеры/1146) → [118](./118.md) — выбрать стек.
