...
**Подход:** WinForms или WPF на .NET, часто с MVP или MVVM, SQL Server и стандартный CI для сборки MSI/MSIX.  
...
3. [Windows Forms (WinForms)](./115.md) — быстрые Windows-интерфейсы.
...
7. [Первая форма WPF — XAML, стили и шаблоны](./119.md) — практикум по WPF.
...
- **Windows Forms (WinForms)** — учебная статья: [Windows Forms (WinForms)](./115.md).  
