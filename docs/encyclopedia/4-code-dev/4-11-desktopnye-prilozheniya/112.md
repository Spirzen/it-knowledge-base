...
**Подход:** [WinForms](./115.md) или [WPF](./119.md) на .NET, часто с MVP или MVVM, SQL Server и стандартный CI для сборки MSI/MSIX. Рецепты по элементам UI — [1152](./1152.md), [1192](./1192.md).  
...
3. [Windows Forms (WinForms)](./115.md) — быстрые Windows-интерфейсы; [элементы UI](./1152.md).
...
7. [Первая форма WPF — XAML, стили и шаблоны](./119.md) — практикум по WPF; [элементы UI](./1192.md).

**Практика по языкам:** Python [311 → 3111 → 3112](/encyclopedia/5-languages/5-02-python/311) · Java [311 → 3111 → 3112](/encyclopedia/5-languages/5-03-java/311) · C# WinForms/WPF — [115](./115.md) / [119](./119.md) и справочники [1152](./1152.md) / [1192](./1192.md).
...
Раздел: [десктоп — intro](./intro.md) · архитектура: [1.md](./1.md).
...
- **Windows Forms (WinForms)** — учебная статья: [Windows Forms (WinForms)](./115.md); **рецепты по элементам UI** — [1152.md](./1152.md).  
...
- **WPF (Windows Presentation Foundation)** — практикум: [119.md](./119.md); **элементы UI** — [1192.md](./1192.md).  
...
- **Swing** — обзор и примеры: [JavaFX и GUI](/encyclopedia/5-languages/5-03-java/311.md), [Практические примеры — Swing](/encyclopedia/5-languages/5-03-java/131.md); **элементы UI** — [3112.md](/encyclopedia/5-languages/5-03-java/3112.md).  
...
- **JavaFX** — теория: [311.md](/encyclopedia/5-languages/5-03-java/311.md); первая программа: [3111.md](/encyclopedia/5-languages/5-03-java/3111.md); **элементы UI** — [3112.md](/encyclopedia/5-languages/5-03-java/3112.md).  
...
- **Tkinter** — теория: [311.md](/encyclopedia/5-languages/5-02-python/311.md); первая программа: [3111.md](/encyclopedia/5-languages/5-02-python/3111.md); **элементы UI** — [3112.md](/encyclopedia/5-languages/5-02-python/3112.md). Богаче UI: [PyQt, PySide и Flet](/encyclopedia/5-languages/5-02-python/313.md).
