...
> **Практикум, шаг 5 из 6.** Проверяем API и ViewModel без ручного клика по UI. Подробнее про ASP.NET-тесты — [4516](/encyclopedia/5-languages/5-05-csharp/4516); контекст десктопа — [112.md](../112.md#тестирование-десктопных-приложений).
