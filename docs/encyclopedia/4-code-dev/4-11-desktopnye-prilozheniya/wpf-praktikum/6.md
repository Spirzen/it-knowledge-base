...
1. **SQLite + EF Core** на API вместо in-memory ([453](/encyclopedia/5-languages/5-05-csharp/453)).
2. **JWT** — login в клиенте, защищённые эндпоинты ([4515](/encyclopedia/5-languages/5-05-csharp/4515)).
3. **Второй регион Prism** — master/detail (список + карточка задачи).
4. **Фильтр по статусу** — ComboBox в View, query `?status=` на API.
5. **Публикация** — `dotnet publish` клиента self-contained + MSI ([117.md](../117.md)).
...
|------------|-----------------|
| WPF UI | [1192.md](../1192.md), [119.md](../119.md) |
| Потоки, память | [112.md](../112.md) |
| Clean Architecture API | [2143](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/2143) |
| MAUI (кроссплатформа) | [4513](/encyclopedia/5-languages/5-05-csharp/4513) |
| Electron (веб в десктопе) | [118.md](../118.md) |
