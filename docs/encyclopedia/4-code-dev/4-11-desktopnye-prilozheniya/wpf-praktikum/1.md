...
> **Практикум, шаг 1 из 6.** Фиксируем базовую модель WPF перед MVVM и клиент-серверной частью. Полный локальный практикум с нуля — [119.md](../119.md); обзор платформы Windows — [116.md](../116.md).
