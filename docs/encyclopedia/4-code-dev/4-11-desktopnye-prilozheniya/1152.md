...
Пошаговые рецепты **Windows Forms** на C#. Обзор платформы — [115.md](./115.md); первая форма — там же. **Готовые мини-приложения с разбором каждой строки** — [C# WinForms и WPF — простые окна](/lab/Примеры/1138) (калькулятор, конвертер, список задач); на Java (Swing) — [Lab — 1143](/lab/Примеры/1143). Имена элементов — [Архитектура десктопных приложений](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/1#элементы-управления-и-ввод-данных); UI-поток — [112.md](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/112.md). Язык C# — [раздел C#](/encyclopedia/5-languages/5-05-csharp/intro).
