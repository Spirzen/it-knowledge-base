...
Теория Electron — [114.md](./114.md); общая архитектура десктопа — [1.md](./1.md). База по React — [272](/encyclopedia/5-languages/5-01-javascript/272) и [галерея компонентов](/lab/Примеры/1146).
