...
description: "Обзор раздела с материалами по выполнению программ, управлению памятью, отладке, обработке ошибок и культурам повышения производительности кода."
...
| Шаг | Материал | Зачем |
|-----|----------|-------|
| 1 | [Архитектура выполнения программ](./1.md) | Производительность, виртуальная память, GC, потоки, синхронизация; сравнение Java/Python/Go — [4.15](../4-15-sborka-musora/4) |
| 2 | [Битовые операции](./2.md) | Представление чисел в памяти |
| 3 | [Ошибки и исключения](./111.md) | Определения, стек, `try/catch`; отказоустойчивость сервисов — ссылки из статьи |
...
<div class="callout callout--tip">
  ...
  Блоки "Справочно на …" можно читать как иллюстрацию идей. Вызовы и стек — в [выполнении кода](/encyclopedia/4-code-dev/4-03-vypolnenie-koda/2)

  асинхронность — в [разделе 4.05](/encyclopedia/4-code-dev/4-05-asinhronnost/intro)

  параллелизм на кластерах — в [параллельных вычислениях](/encyclopedia/4-code-dev/4-16-parallelnye-vychisleniya/intro).
</div>
  </div>
