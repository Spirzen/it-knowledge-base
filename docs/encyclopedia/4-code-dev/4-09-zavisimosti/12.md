...
description: Dependency Inversion - это принцип проектирования, а Dependency Injection - паттерн проектирования. DIP говорит что делать, DI - как делать.
---
...
Как раз способ, показанный со Switch - это конструктор. В классе нужно написать поле с типом данных абстракции, и в конструкторе добавить аргумент с сопоставлением поля и переменной. Как это работает? 

<DIDemo />

Давайте на примере C#.
```csharp
