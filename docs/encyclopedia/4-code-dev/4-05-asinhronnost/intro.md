...
description: "Подборка материалов раздела Асинхронность в энциклопедии Вселенная IT."
sidebar_label: Асинхронность — о разделе
related:
  - title: "Практикум — последовательное и параллельное выполнение"
    doc: encyclopedia/4-code-dev/4-05-asinhronnost/3
...
| Шаг | Статья | Зачем |
|-----|--------|-------|
| 1 | [Асинхронность простым языком](./2) | Зачем это в коде, живые примеры, практикум |
| 2 | [Практикум — последовательное и параллельное выполнение](./3) | Один сценарий на Python, Java, C#, JS, Go и др. |
| 3 | [Процессы и потоки](./1) | Как устроено в ОС |
| 4 | [Асинхронное выполнение](./12) | Event loop, async/await, веб |
| 5 | [Управление потоками](./11) | Синхронизация, гонки, deadlock |
| 6 | [IPC](./13) | Обмен между процессами и сервисами |
| 7 | [Итоги и FAQ](./998) | Типичные ошибки и ответы |

| Тема | Где в энциклопедии |
|------|-------------------|
| Программа на диске, процесс в RAM, потоки | [Что такое программа?](/encyclopedia/1-basics/1-19-programma/1#programma-protsess-potok) |
| Поток выполнения, многозадачность, переключение контекста | [Процессы и потоки](./1) |
| Мьютекс, семафор, гонки, deadlock | [Управление потоками](./11) |
| Pipe, сокеты, RPC, разделяемая память, сигналы | [Межпроцессное взаимодействие](./13) |
