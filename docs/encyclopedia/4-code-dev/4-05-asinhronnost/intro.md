...
| 2 | [Процессы и потоки](./1) | Как устроено в ОС |
| 3 | [Асинхронное выполнение](./12) | Event loop, async/await, веб |
| 4 | [Управление потоками](./11) | Синхронизация, гонки, deadlock |
| 5 | [IPC](./13) | Обмен между процессами и сервисами |
| 6 | [Итоги и FAQ](./998) | Типичные ошибки и ответы |
