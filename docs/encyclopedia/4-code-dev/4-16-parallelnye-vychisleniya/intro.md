...
<div class="callout callout--tip">
  ...
  <div class="callout-body">
  Статьи 1–10 и опциональная <a href="./12.md">12</a> — на псевдокоде и схемах. Статья <a href="./11.md">11</a> и фрагменты в <a href="./8.md">8</a>, <a href="./9.md">9</a> содержат блоки "Справочно на C/C++" — их удобно читать как иллюстрацию идей, не заучивая синтаксис. Полноценная работа с потоками — в разделе <a href="/encyclopedia/5-languages/5-06-cpp/20">C++</a> и <a href="/encyclopedia/5-languages/5-16-starye-yazyki/Fortran/811">Fortran HPC</a>.
</div>
  </div>
