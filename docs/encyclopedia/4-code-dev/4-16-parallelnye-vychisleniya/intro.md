...
Если вы новичок в теме — это нормально — раздел построен по нарастающей, от интуиции к строгому анализу.
...
Идея маршрута простая — сначала вы понимаете «**что именно** нужно распараллеливать», потом — «**как это доказать и посчитать**», и только после этого — «**как реализовать в коде**».
