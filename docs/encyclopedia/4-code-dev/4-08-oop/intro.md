...
Раздел про **объектно-ориентированное программирование** без привязки к одному языку: класс и объект, четыре столпа, инструменты проектирования. Синтаксис C++ — в [разделе C++](/encyclopedia/5-languages/5-06-cpp/intro).
