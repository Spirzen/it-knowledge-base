...
Подробнее про путь от файла до экрана — [Как работают сайты](/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/intro).
...
4. Откройте [DevTools](/encyclopedia/4-code-dev/4-14-razrabotka-i-otladka/1116) и посмотрите DOM и применённые стили.

Дальше — [HTTP и API](./1.md), [этапы проекта](./6.md) или [основы дизайна](./7.md).
