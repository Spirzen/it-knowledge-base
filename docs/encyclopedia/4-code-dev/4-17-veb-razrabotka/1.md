...
1. [Три слоя](./5.md) — одна статическая страница — [HTML intro](/encyclopedia/3-data-markup/3-09-html/intro), [CSS](/encyclopedia/3-data-markup/3-10-css/intro).
2. [Wireframe и оформление](./7.md) — макет до кода.
3. Кнопка меняет текст на странице — [JavaScript intro](/encyclopedia/5-languages/5-01-javascript/intro).
4. [Этапы проекта](./6.md) — выбрать путь: статика, CMS или API.
5. Простой API на Python или Node — CRUD задач, ответ в JSON — [ORM](/encyclopedia/4-code-dev/4-10-orm-i-rabota-s-dannymi/intro) или [SQL](/encyclopedia/3-data-markup/3-07-sql/887).
6. Фронт вызывает API через `fetch`; отладка в DevTools.
7. Git, [первый PR](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/117), [тесты](/encyclopedia/4-code-dev/4-14-razrabotka-i-otladka/1117).
8. Публикация статики — [GitHub Pages](/lab/Кейсы/3) или [React — компоненты](/lab/Примеры/1146).
