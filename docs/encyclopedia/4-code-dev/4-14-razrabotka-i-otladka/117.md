...
![Скриншот приложения](https://example.com/docs/images/screenshot.png)
```
...
MIT — см. [Лицензия проекта](/about/license)
```
...
Шаблоны `compose.yaml` для локального стека (Postgres, app+db) — [Docker Compose — готовые стеки](/lab/Примеры/11111). Dockerfile для сервиса с `build: .` — [Dockerfile — 10 типовых образов](/lab/Примеры/11113).
...
<ExternalCodeEmbed example="text/code-414-117-001" title="Пример — pet-проект новичка" minHeight={354} />
...
![Главный экран](https://example.com/docs/screenshot-main.png)
...
<ExternalCodeEmbed example="text/code-414-117-002" title="Пример — монорепозиторий" minHeight={318} />
...
<ExternalCodeEmbed example="text/code-414-117-003" title="Пример — внутренний корпоративный проект" minHeight={516} />
...
**Дальше:** [.gitignore](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/116) · [pet-проекты](/encyclopedia/4-code-dev/4-14-razrabotka-i-otladka/114) · [Git для команды](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/114) · [лаборатория — git add, commit, push](/lab/Примеры/1123)
