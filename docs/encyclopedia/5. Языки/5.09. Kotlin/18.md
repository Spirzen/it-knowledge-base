---
title: 5.09. Работа с БД в Kotlin
---
...
**Exposed** (разрабатывается JetBrains) — это не ORM в классическом понимании, а *типобезопасный DSL для SQL*, сочетающий два режима работы:
