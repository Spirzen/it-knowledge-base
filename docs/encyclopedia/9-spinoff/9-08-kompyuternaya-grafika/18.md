...
<div class="callout callout--tip">
  ...
  C++ + CMake + **GLFW** + **GLEW** + **GLM** + OpenGL 3.3 core — типичный учебный стек для первых проектов. Низкоуровневый контроль без OpenGL — [Vulkan](/encyclopedia/5-languages/5-06-cpp/29). В браузере — WebGL / WebGPU ([13.md](./13.md)).
</div>
  </div>
...
| **Depth test** | Z-buffer ([17.md](./17.md)) |
...
- **PBR** — metallic/roughness + Cook–Torrance в fragment shader ([13.md](./13.md)).

В Blender те же приёмы — ноды и Eevee/Cycles ([131.md](./131.md)).
...
| Vulkan | Кросс, Android | Явная память и sync ([29.md](/encyclopedia/5-languages/5-06-cpp/29)) |
