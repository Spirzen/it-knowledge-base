...
related:
  - title: "Adobe Photoshop 2021 — конспект"
    doc: encyclopedia/1-basics/1-16-grafika/71
...
Горячие клавиши, команды и форматы **Adobe Photoshop** для ежедневной работы. Пошаговый конспект (17 тем) — [Adobe Photoshop 2021](/encyclopedia/1-basics/1-16-grafika/71). Оглавление раздела ПО — [9.06](/encyclopedia/9-spinoff/9-06-otraslevoe-po/intro).
...
<ExternalCodeEmbed example="javascript/sp-9-9-06-otraslevoe-po-111-001" title="5.3. Автоматизация — Actions (`.ATN`)" minHeight={318} />
...
<ExternalCodeEmbed example="javascript/sp-9-9-06-otraslevoe-po-111-002" title="5.4. Скрипты — ExtendScript и UXP" minHeight={336} />
