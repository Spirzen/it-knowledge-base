...
description: "На <a href=\"https://scratch.mit.edu/starter-projects\" target=\"_blank\" rel=\"noopener noreferrer\">scratch.mit.edu/starter-projects</a> MIT собрал <strong>готовые проекты с подсказками внутри."
  анимация, игры, музыка, истори, координаты и расширения Scratch.
---
...
<div class="callout callout--info">
  ...
  На <a href="https://scratch.mit.edu/starter-projects" target="_blank" rel="noopener noreferrer">scratch.mit.edu/starter-projects</a> MIT собрал <strong>готовые проекты с подсказками внутри кода</strong>. Их удобно открывать после <a href="/encyclopedia/9-spinoff/9-11-dlya-detey/5-kod/3">главы про Scratch</a> — не с пустого листа, а с рабочим примером.
</div>
...
Каждый проект на Scratch начинается с **Кота Scratch**. Стартовые шаблоны показывают, как из нескольких блоков получаются истори, игры, анимация и музыка. Ниже — каталог с прямыми ссылками (актуально для [официальной страницы starter projects](https://scratch.mit.edu/starter-projects)).
...
| Piano | Ноты, клавиши-спрайты | [Piano](https://scratch.mit.edu/projects/1106245381) |
...
| Community Quiz | Вопросы и ответы | [Community Quiz](https://scratch.mit.edu/projects/1106806960) |
