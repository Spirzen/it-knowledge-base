...
title: PascalABC.NET
description: >-
  PascalABC.NET — среда Pascal на .NET для школ России: первая программа,
...
Путеводитель: [Инструменты и среды](/encyclopedia/1-basics/1-035-bazovaya-informatika/9). Алгоритмы в курсе: [Базовая информатика, глава 4](/encyclopedia/1-basics/1-035-bazovaya-informatika/4).
