...
Путеводитель: [Инструменты и среды](//tools/development/1). Алгоритмы в курсе: [Базовая информатика, глава 4](/encyclopedia/4-code-dev/4-01-algoritmy/intro). **Типовые программы с разбором** (те же конструкции, что на уроках) — [Lab / 1140](/lab/Примеры/1140#стартовые-задачи).
...
Блок-схемы из [главы 4](/encyclopedia/4-code-dev/4-01-algoritmy/intro) переносятся на Pascal почти один в один.
...
- [Visual Basic в учебной программе](/encyclopedia/4-code-dev/4-01-algoritmy/intro#visual-basic-в-учебной-программе)
