...
description: "В <a href=\"/encyclopedia/9-spinoff/9-11-dlya-detey/5-kod/3\">Scratch</a> вы собирали блоки."
  для школьников и школьных проектов.
---
...
> *При нажати пробела → герой прыгает*  
> *При столкновени с монеткой → счёт +1*
...
4. Прикрепите скрипт движения (шаблон **2D Platformer** в документаци Godot).
5. F5 — запуск сцены.

**Когда выбирать:** готовы к коду, нужен экспорт без подписки, планируете 3D или open-source портфолио.

Подробнее для разработчиков: [Godot в разделе игр](/encyclopedia/9-spinoff/9-04-razrabotka-igr/113.md#godot), [инструменты /games](/tools/games/1).
