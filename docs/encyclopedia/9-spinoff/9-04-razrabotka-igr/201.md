...
Горячие клавиши, команды и форматы **Roblox** для ежедневной работы. Учебный маршрут: [Studio](./203) → [практикум «обби»](./204) → [архитектура](./2). Экономика: [202](./202). Справочник API — эта статья.
