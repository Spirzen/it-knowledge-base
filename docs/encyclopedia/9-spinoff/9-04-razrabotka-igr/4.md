...
title: Unreal Engine
description: Обзор Unreal Engine 5 (и анонс UE6 в 2026) — установка, архитектура, Blueprints и C++, подсистемы рендеринга, физики, сети и типичные ошибки начинающих.
---
...
<div class="callout callout--info">
  <div class="callout-title">Актуально: Unreal Engine 6</div>

  <div class="callout-body">
  В **мае 2026** Epic Games анонсировала **Unreal Engine 6** на Rocket League Paris Major: в трейлере показали обновлённую *Rocket League* с графикой в реальном времени на UE6. Для учебных проектов по-прежнему ставьте стабильную **UE 5.x** из Epic Games Launcher, пока не выйдут официальные гайды по миграции и публичный SDK UE6.
</div>
  </div>
...
| **UE6** | 2026 (анонс) | Показан на Paris Major на обновлённой *Rocket League*; даты релиза редактора и SDK на момент анонса нет |
