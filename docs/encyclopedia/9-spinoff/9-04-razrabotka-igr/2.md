...
<div class="callout callout--tip">
  ...
  Эта статья — справочник по архитектуре и API. Для первой игры идите по порядку: <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/203">Studio и Place</a> → <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/204">практикум «обби»</a> → по желанию <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/205">королевская битва</a> и <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/206">механика и продвижение</a>. Полный маршрут — в <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/intro">о разделе</a>.
</div>
</div>
