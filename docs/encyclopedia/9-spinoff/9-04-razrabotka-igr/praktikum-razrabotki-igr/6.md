...
<div class="callout callout--info">
  ...
  <ul>
    <li>Гарантированно запускаемые эталоны для сверки: <a href="./1.md#full-revision">Battle City</a>, <a href="./2.md#full-revision">Match3</a>, <a href="./3.md#full-revision">Ping Pong</a>, <a href="./4.md#full-revision">Racing</a>, <a href="./5.md#full-revision">Tetris</a>, <a href="./6.md#full-revision">диаблоид</a> (<code>#full-revision</code> в каждой статье).</li>
...
Эталоны других треков с тем же форматом: [Battle City](./1.md#full-revision), [Tetris](./5.md#full-revision), [Racing](./4.md#full-revision).
...
**Почему не `x += dx` напрямую.** Игрок — не точка, а круг с радиусом `ENTITY_RADIUS`. Перед шагом проверяем **несколько точек** вокруг центра (`can_occupy`).
...
Серия ударов — не отдельная анимация, а **повторный вызов** одной и той же логики с кулдауном — простой и рабочий приём для прототипа.
---
...
<div class="callout callout--tip">
  <div class="callout-title">Полный эталон</div>
