...
Каркас `while running` → события → рисование → `flip` повторяется во всех играх на Pygame — см. [312](/encyclopedia/5-languages/5-02-python/312).
...
**Порядок в цикле важен:** `clock.tick` → события → `update` → `draw` → `flip`. События до `update` — стандарт Pygame ([312](/encyclopedia/5-languages/5-02-python/312), [Ping Pong](./3.md)).
...
<div class="callout callout--note">
  ...
  <div class="callout-body">
  Запишите GIF геймплея с каскадом и drag, выложите <code>match3/</code> на GitHub с README (<code>pip install pygame</code>, <code>python match3.py</code>) — наглядный пункт для junior game dev рядом с <a href="./1.md">Battle City</a> или <a href="./5.md">Tetris</a>.
  </div>
</div>
...
| 3 | Звук match | wav при удалении | [312](/encyclopedia/5-languages/5-02-python/312), mixer |
...
- [Python — Battle City](./1.md) · [Python — Tetris](./5.md) · [Python — Ping Pong](./3.md)
