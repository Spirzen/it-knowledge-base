...
related:
  ...
  - title: "Python — Battle City"
    doc: encyclopedia/9-spinoff/9-04-razrabotka-igr/praktikum-razrabotki-igr/1
...
<div class="callout callout--info">
  ...
  <ul>
    <li>Гарантированно запускаемые эталоны для сверки: <a href="./1.md#full-revision">Battle City</a>, <a href="./2.md#full-revision">Match3</a>, <a href="./3.md#full-revision">Ping Pong</a>, <a href="./5.md#full-revision">Tetris</a>, <a href="./4.md#full-revision">Racing</a> (<code>#full-revision</code>).</li>
...
- Если застряли — методология в разделе [Практикум разработки игр — о разделе](./intro.md); для сверки — [полная ревизия](#full-revision) в конце этой статьи и эталоны [Battle City](./1.md#full-revision), [Match3](./2.md#full-revision), [Ping Pong](./3.md#full-revision).
...
После [этапов 15–16](#stage-15) дополнительно: HUD с позицией, мини-карта, nitro по `Shift`, следы при заносе.
...
- [Python — Battle City](/encyclopedia/9-spinoff/9-04-razrabotka-igr/praktikum-razrabotki-igr/1) — похожая поэтапная структура с коллизиями.
