...
tags: [inprogress]
title: "Python — Racing"
description: "Пошаговый практикум — гоночная мини-игра на Python и Pygame: архитектура, физика, зависимости, 16 этапов до заезда с кругами, таймером, соперниками и полировкой."
related:
...
5. [Этапы 15–16](#stage-15) — позиция в гонке, nitro и полировка.
6. [Настройка «руления»](#tuning) — таблица параметров физики.
7. [Отладка на трассе](#debug-mode) — визуализация секторов и waypoints.
8. [Итоговая структура и самопроверка](#final-checklist).
