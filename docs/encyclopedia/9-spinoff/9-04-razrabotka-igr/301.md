...
Горячие клавиши, команды и форматы **Unity** для ежедневной работы. Учебный курс: [раздел](/encyclopedia/9-spinoff/9-04-razrabotka-igr/intro).
...
<div class="callout callout--warning">
  ...
  Пошаговые примеры — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/3">Разработка на Unity</a>.
</div>
</div>
