...
| **Практика на устройстве** | [Как работать с сетью](./81.md) → [Ускорение интернета](./220.md) → [Диагностические утилиты](./505.md) → [Приватность и self-hosting](./404.md) | Настройки ОС, инструменты, домашний периметр |
