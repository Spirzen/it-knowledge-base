...
Подробнее про флаги, методы и отладку — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133). Методы, коды и заголовки — в таблицах ниже; в браузере — DevTools → Network.
