...
| Этап | Статьи | Зачем |
| :--- | :--- | :--- |
| 1. Основы | [1](./1.md), [11](./11.md) | Клиент–сервер, HTTP, URL |
| 2. Инфраструктура | [112](./112.md), [1112](./1112.md) | Веб-серверы, CDN, ошибки `ERR_*` |
| 3. Приложения | [111](./111.md), [114](./114.md), [115](./115.md) | SPA, SSR, Service Worker, Fetch |
...
| 6. Интерфейс | [2](./2.md) | UX/UI и структура страницы |

Опционально: [117](./117.md) (PWA, push), [118](./118.md), [120](./120.md) (Web API браузера), [121](./121.md) (Web API с кодом), [1111](./1111.md) (DevTools). Итоги — [998](./998.md), самопроверка — [999](./999.md). По платформенному запуску без кода смотрите [Справочник по Tilda](./122.md).
