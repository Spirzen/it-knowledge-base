...
Опционально: [117](./117.md) (PWA, push), [118](./118.md), [129](./129.md) (polling, SSE, webhook), [120](./120.md) (Web API браузера), [121](./121.md) (Web API с кодом), [123](./123.md) (BB-код на форумах), [124](./124.md) (история браузера и приватность), [127](./127.md) (движки и линейки браузеров), [128](./128.md) (HTTPS и TLS), [125](./125.md) (мост с интернет-культурой), [DevTools в браузере](/encyclopedia/4-code-dev/4-14-razrabotka-i-otladka/1116). Итоги — [998](./998.md), самопроверка — [999](./999.md). По платформенному запуску без кода смотрите [Справочник по Tilda](./122.md).
