...
Сценарии с пагинацией удобно собирать в коллекции Postman — см. [Postman и curl](./2.md#rest-url-cheatsheet). Синтаксис `curl` для offset/cursor и заголовков — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133).
