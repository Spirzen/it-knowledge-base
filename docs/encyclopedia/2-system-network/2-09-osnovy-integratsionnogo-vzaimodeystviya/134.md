...
Полноценный учебный стенд на **TypeScript** (Redis, Pub/Sub, Streams) — [129.md](./129.md). **Java + Kafka + PostgreSQL** — [практикум 1191](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1191).
