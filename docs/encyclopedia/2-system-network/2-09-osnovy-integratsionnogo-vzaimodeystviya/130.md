...
**Плюсы:** простая модель, кэширование `GET`, широкая поддержка инструментов (`curl`, Postman, OpenAPI; см. [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133)), понятен внешним интеграторам.
