...
| 3 | [ИТ-инфраструктура](./3.md) | Железо, софт, сеть, процессы |
...
Дальше — углубление: [планировщики](./8.md), [ошибки и логи](./9.md), [Linux в админской практике](./93.md), [СУБД](./91.md), [мониторинг](./92.md), [GPO](./411.md), [сетевые аномалии](./31.md).

## Windows и Linux

- **Корпоративный офис (СНГ)** в примерах часто описан через **Windows Server** и **Active Directory** — см. [4](./4.md), [5](./5.md), [411](./411.md).
- **Серверы и облако** нередко на **Linux** — [93](./93.md); сеть и диагностика — [6](./6.md).
