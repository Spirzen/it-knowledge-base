...
В [техподдержке](/encyclopedia/2-system-network/2-07-tehnicheskaya-podderzhka/118) описано создание инцидента из Zabbix по webhook. На практике action вызывает **script media** или **webhook** (Jira, GLPI, ServiceNow).
