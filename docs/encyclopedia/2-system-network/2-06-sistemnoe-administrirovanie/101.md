...
| **Microsoft Entra ID** (облако) | Azure / M365 | Облачный каталог, SAML/OIDC; см. [62](./62.md) |
...
Полный справочник портов — в [618](/encyclopedia/2-system-network/2-03-set-i-internet/618).
...
| **Гибрид с облаком** | Azure AD Connect / Entra Connect Sync — см. [62](./62.md) |
...
| GPO | *Group Policy Management* (`gpmc.msc`) — см. [411](./411.md) |
