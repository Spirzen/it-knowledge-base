...
**Grafana** связывает все три в Explore и на дашбордах. Стек Grafana Labs часто называют **LGTM** (Loki, Grafana, Tempo, Mimir). Базовые дашборды и Explore — [Практикум Grafana — шаг 4](./4.md); маршрут — [о разделе](./intro.md).

![Дашборд Grafana — метрики производительности хоста для корреляции с логами и трейсами](https://assets.spirzen.ru/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/image.png)
...
Сравнение с ELK — в [Мониторинг, метрики и логирование систем](../92.md#elk-stack).
...
![Мониторинг нагрузки и метрик в Grafana — старт расследования инцидента](https://assets.spirzen.ru/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/image.png)
