...
Метрики и нагрузку с этих агентов сводят на дашбордах Grafana — [Практикум Grafana — шаг 4](./4.md); полный маршрут — [о разделе](./intro.md).

![Дашборд Grafana — CPU, сеть и производительность хоста под мониторингом](image.png)
...
![Мониторинг метрик нагрузки в Grafana — CPU и сеть хоста](image.png)
