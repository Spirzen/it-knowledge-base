...
Документация — [Alertmanager](https://prometheus.io/docs/alerting/latest/alertmanager/), [Tutorial alerting](https://prometheus.io/docs/tutorials/alerting_based_on_metrics/).
