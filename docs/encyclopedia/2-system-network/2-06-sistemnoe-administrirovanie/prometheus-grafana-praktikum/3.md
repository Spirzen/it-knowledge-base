...
<div class="callout callout--tip">
  ...
  В UI Prometheus (:9090) выполните запросы из [workshop.md](https://github.com/juliusv/prometheus_workshop/blob/master/workshop.md) (раздел PromQL). Добавьте `node_exporter` на [шаге 5](./5.md) и постройте график CPU и disk.
</div>
