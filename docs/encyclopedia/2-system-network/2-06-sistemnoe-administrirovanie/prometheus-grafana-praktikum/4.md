...
![Дашборд Grafana — метрики CPU, сети, диска и нагрузка хоста (Windows Exporter)](https://assets.spirzen.ru/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/image.png)
