...
![Дашборд Grafana после windows_exporter — мониторинг CPU, памяти и сетевой нагрузки](https://assets.spirzen.ru/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/image.png)
