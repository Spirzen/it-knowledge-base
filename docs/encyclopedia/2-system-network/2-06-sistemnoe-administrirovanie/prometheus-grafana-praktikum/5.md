...
**Exporter** — отдельный процесс с HTTP `/metrics`, который переводит статистику системы в формат Prometheus. Сервер **pull**-ит exporter так же, как приложение. Собранные метрики визуализируют в Grafana — [Практикум Grafana — шаг 4](./4.md), полный маршрут — [о разделе](./intro.md).
