...
В рунете вокруг Windows много **бытовых** тем: "оптимизированная сборка", "антивирус тормозит", "диспетчер не убивает процесс", "Store не нужен". В [131](/encyclopedia/9-spinoff/9-10-internet-kultura/131) это часто сводят к "переустанови"; здесь разбираем, **что стоит за этими словами** и куда смотреть в энциклопедии.
...
<div class="callout callout--warning">
  ...
  Удаление Store и связанных служб ломает лицензии игр, античит и обновления UWP. Разбор — [1.12 / 11](/encyclopedia/1-basics/1-12-sovety-dlya-novichka/11).
  </div>
</div>
...
**Текстовый редактор** в смысле Блокнота и Notepad++ — не диспетчер; для кода см. [1.19](/encyclopedia/1-basics/1-19-programma/intro), [51 / офис vs редактор](/encyclopedia/1-basics/1-11-soft-ryadovogo-polzovatelya/51). [Неолурк: Текстовый редактор](https://neolurk.org/wiki/%D0%A2%D0%B5%D0%BA%D1%81%D1%82%D0%BE%D0%B2%D1%8B%D0%B9_%D1%80%D0%B5%D0%B4%D0%B0%D0%BA%D1%82%D0%BE%D1%80).
...
Для учёбы и работы — **официальный носитель** или корпоративный образ IT-отдела. Мемы — [131](/encyclopedia/9-spinoff/9-10-internet-kultura/131), карточка — [глоссарий: сборки Windows](/glossary/С#сборки-windows).

---

## Связанные материалы

- [95 — жизненный цикл Windows](./95)
- [133 — Open Source, GitHub, DevOps](/encyclopedia/9-spinoff/9-10-internet-kultura/133)
