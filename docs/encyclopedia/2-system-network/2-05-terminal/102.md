...
description: Команды, пути, службы и параметры Основные команды Windows — для администрирования и работы в терминале. Учебный курс — раздел.
...
Команды, пути, службы и параметры **Основные команды Windows** — для администрирования и работы в терминале. Учебный курс: [раздел](/encyclopedia/2-system-network/2-05-terminal/intro).
...
Pinging google.com [142.250.180.78] with 32 bytes of Данные:
...
| Область | Примечание |
|---------|------------|
| Версии | актуальные LTS/стабильные релизы **Основные команды Windows** |
