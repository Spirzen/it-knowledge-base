...
<div class="callout callout--warning">
  ...
  <p><code>rd /s /q</code> и <code>Remove-Item -Recurse -Force</code> необратимы при неверном пути. См. также <a href="/encyclopedia/8-infra-security/8-03-zabota-o-kode-i-dannyh/101">Опасные скрипты</a>.</p>
</div>
  </div>
