...
description: Автоматизация в Windows на PowerShell - написание скриптов, настройка политик выполнения, безопасный запуск задач и оптимизация ежедневных административных операций.
---
...
<ExternalPlayEmbed example="tools-automation/cron-schedule-play" title="Cron Schedule" minHeight={480} />
...
Скрипт `.ps1` — это **действия** в модели автоматизации. Запускает его **триггер**. Концепция целиком — в [124 PowerShell](/encyclopedia/5-languages/5-26-powershell/124); углублённо — [Триггеры — расписание и наблюдатели](/encyclopedia/5-languages/5-26-powershell/126). Здесь — практика в Windows.
