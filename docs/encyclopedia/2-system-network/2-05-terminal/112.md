...
<div class="callout callout--tip">
  ...
  [Терминал и CMD](/encyclopedia/2-system-network/2-05-terminal/1) → [справочник команд](/encyclopedia/2-system-network/2-05-terminal/102) → простые цепочки в [BAT](/encyclopedia/2-system-network/2-05-terminal/103) → этот материал про <code>.ps1</code>. Сначала о модели автоматизации — [124 PowerShell](/encyclopedia/5-languages/5-26-powershell/124). Для Linux-серверов параллельный путь — [скрипты Unix](/encyclopedia/2-system-network/2-05-terminal/111).
</div>
  </div>
