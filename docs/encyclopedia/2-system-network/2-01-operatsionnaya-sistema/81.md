...
В разговорах **Android** часто противопоставляют iPhone как «открытость vs закрытость», хотя речь идёт о разных моделях обновлений, магазинов приложений и политик Google. Мемы про «всё гуглит» и фрагментацию версий отражают боль разработчиков (много OEM, отставание патчей), а не приговор платформе.

Для администратора и разработчика важнее **API level**, подпись сборки, разрешения в манифесте и политика `networkSecurityConfig`, чем спор в чате. Связка с Linux на серверах — [Администрирование Linux](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/93#в-рунет-дискурсе). Указатель — [Неолурк (Android)](https://neolurk.org/wiki/Android).
...
**Справочники** — [Справочник по iOS](/encyclopedia/2-system-network/2-01-operatsionnaya-sistema/71), [Основы IP-адресации](/encyclopedia/2-system-network/2-03-set-i-internet/41), [Справочник по Linux](/encyclopedia/2-system-network/2-01-operatsionnaya-sistema/51), [Справочник по HTTP-протоколу](/encyclopedia/2-system-network/2-03-set-i-internet/611), [Справочник по Windows 11](/encyclopedia/2-system-network/2-01-operatsionnaya-sistema/41), [Основные команды в Linux](/encyclopedia/2-system-network/2-05-terminal/101).

**Мобильная разработка** — [Справочник по iOS](/encyclopedia/2-system-network/2-01-operatsionnaya-sistema/71), [Kotlin — о разделе](/encyclopedia/5-languages/5-09-kotlin/intro), [Мобильные игры](/encyclopedia/9-spinoff/9-04-razrabotka-igr/122), [Swift — о разделе](/encyclopedia/5-languages/5-14-swift/intro), [Особенности тестирования мобильных приложений](/encyclopedia/7-project/7-05-testirovanie/124), [Беспроводные технологии - Bluetooth, Zigbee, NFC](/encyclopedia/2-system-network/2-10-zhelezo/119).
