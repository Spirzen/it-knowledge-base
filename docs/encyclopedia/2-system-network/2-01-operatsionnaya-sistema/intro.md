...
| 10 | Управление памятью | [5116](./5116), [5112](./5112) |
| 11 | Аппаратная поддержка (MMU, TLB) | [5116](./5116) |
| 12 | Замещение страниц, виртуальная память | [5121](./5121), [5116](./5116) |
| 13 | Ввод-вывод и устройства | [5120](./5120) |
| 14 | Современные ОС и практика | [2](./2), [51](./51), [41](./41) |

После маршрута B пройдите [чек-лист](./99) — вопросы 81–98 добавлены под учебные темы.
