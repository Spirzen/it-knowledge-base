...
Игры через **Steam Proton** — обёртка Wine с трансляцией DirectX в Vulkan; разбор — [413](./413).
...
На 64-битной Windows 32-битные программы идут через **WOW64** — подсистема совместимости, а не "виртуальная машина целиком". См. [411](./411).
