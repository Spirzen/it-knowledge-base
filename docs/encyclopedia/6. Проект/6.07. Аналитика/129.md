---
title: 6.07. Справочник по BPMN 2.0
---
...
|-------------|------------|--------|---------|-------------|-----------|-------------------|-----------------------------------|
| **Start Event** | `bpmn:startEvent` | ![image-8.png](image-8.png) отсутствует, timer, message, signal, error, escalation, conditional, link, multiple | Тонкая | Белое | Инициирует процесс или подпроцесс | `isInterrupting` (только для attached) | `true` (по умолчанию для start), `false` (только у attached intermediate) |
