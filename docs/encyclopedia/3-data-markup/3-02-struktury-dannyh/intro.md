...
| Шаг | Статья | Зачем |
|-----|--------|--------|
| 0 | [Базовая информатика — программирование](/encyclopedia/1-basics/1-035-bazovaya-informatika/1#программирование) | Типы данных, линейные/нелинейные структуры (школа) |
