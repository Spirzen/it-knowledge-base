...
- [Системные цвета (CSS Система Colors)](#системные-цвета-css-система-colors)
...
| `attr()` | `attr(Данные-size px)` | Только в `content`, `counter-reset` (и в будущем — везде) |
...
### Системные цвета (CSS Система Colors)
- `Canvas`, `CanvasText`  
