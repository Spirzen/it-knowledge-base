...
description: "CSS анимации и трансформации - свойства transition и animation, transform, градиенты, позиционирование, perspective и готовые паттерны визуальных эффектов."
related:
...
<ExternalPlayEmbed example="lab/css-transition-play" title="CSS-анимации" minHeight={420} />
...
<ExternalCodeEmbed example="css/css-6-001" title="Анимация градиента (shimmer)" minHeight={336} />
...
<ExternalCodeEmbed example="css/css-6-002" title="Баннеры и промо-блоки" minHeight={516} />
