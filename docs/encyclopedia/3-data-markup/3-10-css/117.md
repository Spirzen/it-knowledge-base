...
Готовый каркас страницы с блоком `prefers-reduced-motion` и разбором — в [CSS-анимации — готовые эффекты](/lab/Примеры/1116#обязательный-каркас).
...
<ExternalCodeEmbed example="css/css-117-001" title="prefers-color-scheme" minHeight={372} />
...
Полные таблицы по свойствам (макет, viewport, производительность, организация кода) — в главе [Практические рекомендации по CSS](./118.md).
