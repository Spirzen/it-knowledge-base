...
<div class="html-inline-demo">
<style>
.html-inline-demo .css3-card-demo {
  font-size: 1rem;
...
.html-inline-demo .css3-card-demo__title {
  font-size: 1.5em;
  font-weight: bold;
  margin: 0 0 0.5em;
}
.html-inline-demo .css3-card-demo p { margin: 0; }
</style>
...
<div class="html-inline-demo">
<div style="background: #dbeafe; margin-bottom: 20px; padding: 8px 12px;">Блок A — margin-bottom: 20px</div>
<div style="background: #bfdbfe; margin-top: 30px; padding: 8px 12px;">Блок B — margin-top: 30px</div>
</div>
...
<div class="html-inline-demo">
<div style="background: #6366f1; color: #fff; padding: 15px; display: inline-block; border-radius: 6px;">Текст с padding: 15px</div>
</div>
...
<div class="html-inline-demo" style="display: flex; flex-wrap: wrap; gap: 10px;">
...
<div class="html-inline-demo">
<div style="position: relative; max-width: 260px; padding: 1rem 2.5rem 1rem 1rem; border: 1px solid var(--ifm-color-emphasis-300); border-radius: 8px; background: var(--ifm-background-color);">
  <button type="button" style="position: absolute; top: 0.5rem; right: 0.5rem; width: 28px; height: 28px; border: 1px solid #ccc; border-radius: 4px; background: #f8f9fa; cursor: pointer; line-height: 1;">×</button>
...
<div class="html-inline-demo">
<p style="text-align: left; margin: 0 0 6px; border: 1px dashed var(--ifm-color-emphasis-300); padding: 4px;">left</p>
<p style="text-align: center; margin: 0 0 6px; border: 1px dashed var(--ifm-color-emphasis-300); padding: 4px;">center</p>
<p style="text-align: right; margin: 0; border: 1px dashed var(--ifm-color-emphasis-300); padding: 4px;">right</p>
</div>
...
<div class="html-inline-demo">
<p style="margin: 0 0 6px; text-decoration: underline;">Подчёркнутый текст</p>
<p style="margin: 0 0 6px; text-decoration: overline;">Надчёркнутый текст</p>
<p style="margin: 0; text-decoration: line-through;">Зачёркнутый текст</p>
</div>
...
<div class="html-inline-demo">
<div style="padding: 16px 20px; background: var(--ifm-background-color); border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.15); display: inline-block;">Карточка с тенью</div>
</div>
