...
Полный разбор класса и методов `init` / `destroy` — в главе [Виджеты интерфейса на ванильном JavaScript](/encyclopedia/5-languages/5-01-javascript/34). Анимации `@keyframes` и `transition` подробнее — в [§ Анимации, переходы и трансформации](./6.md).

<BannerCarouselPlay />

### Зачем не один статичный баннер
