...
<div class="callout callout--info">
  ...
  Раздел для <strong>логистики, исследования операций и углублённой математики</strong> — не нужен для освоения SQL, HTML или аналитики на Excel/Python. Вернитесь сюда, если учебный план или работа требуют оптимизационных моделей.
  </div>
</div>
