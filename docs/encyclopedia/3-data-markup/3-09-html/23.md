...
Связь: [основные теги](./2.md), [виджеты на JavaScript](/encyclopedia/5-languages/5-01-javascript/34.md), [валидация форм](/encyclopedia/5-languages/5-01-javascript/36.md). Базовая форма в одном `.html` — [HTML-страницы целиком (форма)](/lab/Примеры/1153#html-forma).
