...
| 13 | EDA, t-тест, регрессия, split | [Python для анализа данных](/encyclopedia/3-data-markup/3-11-analiz-dannyh/424), [текст как признаки (TF-IDF)](/encyclopedia/3-data-markup/3-11-analiz-dannyh/424#tekst-kak-priznaki), [тональность на PyTorch](/encyclopedia/5-languages/5-02-python/336), [6-ai / ML](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/intro) (введение) |
