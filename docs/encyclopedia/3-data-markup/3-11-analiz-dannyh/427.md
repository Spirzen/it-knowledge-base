...
Предполагается, что `DataFrame` уже загружен (`pd.read_csv` и другие `read_*` — в [типовых операциях Pandas](/encyclopedia/3-data-markup/3-11-analiz-dannyh/428#zagruzka-dannyh) и [напоминалке по четырём инструментам](/encyclopedia/3-data-markup/3-11-analiz-dannyh/426#napominalka-tablichnye-dannye)). Разбор идей импутации и группировки подробнее — в [главе про pandas и NumPy](/encyclopedia/5-languages/5-02-python/33#podgotovka-dannyh).
