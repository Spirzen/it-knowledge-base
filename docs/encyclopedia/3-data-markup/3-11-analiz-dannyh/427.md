...
Сравнение `merge`, `concat` и `groupby` с **Polars**, **SQL** и **PySpark** — [426](/encyclopedia/3-data-markup/3-11-analiz-dannyh/426#napominalka-tablichnye-dannye). Своды и pivot — [объединение таблиц в Pandas](/encyclopedia/5-languages/5-02-python/331).
