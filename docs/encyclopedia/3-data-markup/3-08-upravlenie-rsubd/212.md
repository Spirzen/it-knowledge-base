...
description: "В энциклопедии ниже — справочник по T-SQL и объектам SQL Server на русском."
---
...
**[Документация по Microsoft SQL](https://learn.microsoft.com/ru-ru/sql/?view=sql-server-ver17)** — хаб: SQL Server on Windows/Linux, Azure SQL, Fabric, миграция, разработка и развёртывание.
...
|-----|-------------------|----------------------|
| 1 | [СУБД — обзор](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/2) | [Движок СУБД Microsoft SQL](https://learn.microsoft.com/ru-ru/sql/database-engine/sql-database-engine?view=sql-server-ver17) |
| 2 | [SQL — первые шаги](/encyclopedia/3-data-markup/3-07-sql/101) | [Учебник: написание Transact-SQL](https://learn.microsoft.com/ru-ru/sql/t-sql/tutorial-writing-transact-sql-statements?view=sql-server-ver17) |
| 3 | [Процедурные расширения — T-SQL](/encyclopedia/3-data-markup/3-07-sql/882) | [Схема: запросы на Transact-SQL](https://learn.microsoft.com/ru-ru/training/paths/get-started-querying-with-transact-sql/) |
| 4 | Эта глава (справочник) | [Справочник T-SQL](https://learn.microsoft.com/ru-ru/sql/t-sql/language-reference?view=sql-server-ver17) |
| 5 | [Взаимодействие с СУБД](/encyclopedia/3-data-markup/3-07-sql/4) | [Подключение к Database Engine](https://learn.microsoft.com/ru-ru/sql/sql-server/connect-to-database-engine?view=sql-server-ver17) |

Дополнительно: [советы по навигации в документации SQL](https://learn.microsoft.com/ru-ru/sql/sql-server/sql-docs-navigation-guide?view=sql-server-ver17), [обучающие ресурсы](https://learn.microsoft.com/ru-ru/sql/sql-server/educational-sql-resources?view=sql-server-ver17).
...
| Задача | Ссылка Learn |
|--------|----------------|
| Подключиться к экземпляру (Windows auth, Azure SQL, Docker) | [connect-to-database-engine](https://learn.microsoft.com/ru-ru/sql/sql-server/connect-to-database-engine?view=sql-server-ver17) |
| SSMS: подключение и запрос | [ssms-connect-query-sql-server](https://learn.microsoft.com/ru-ru/ssms/quickstarts/ssms-connect-query-sql-server?view=sql-server-ver17) |
| Azure SQL / локальный сервер в VS Code | [connect-query-vscode](https://learn.microsoft.com/ru-ru/azure/azure-sql/database/connect-query-vscode?view=azuresql) |
| Примеры БД (AdventureWorks и др.) | [sql-samples-where-are](https://learn.microsoft.com/ru-ru/sql/samples/sql-samples-where-are?view=sql-server-ver17) |

---

### Инструменты SQL Server

Обзор бесплатных и платных средств: **[overview-sql-tools](https://learn.microsoft.com/ru-ru/sql/tools/overview-sql-tools?view=sql-server-ver17)** (вкладки DBA / разработчик / аналитик).

| Инструмент | Назначение | Документация |
|------------|------------|--------------|
| **SSMS** | Администрирование, T-SQL, планы выполнения | [Установка SSMS](https://learn.microsoft.com/ru-ru/ssms/install/install?view=sql-server-ver17) · [скачать](https://learn.microsoft.com/ru-ru/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-ver17) |
| **Azure Data Studio** | Кросс-платформенный клиент, заметки, графики | см. [overview-sql-tools](https://learn.microsoft.com/ru-ru/sql/tools/overview-sql-tools?view=sql-server-ver17&tabs=dba) |
| **SSDT** | Проекты схемы БД в Visual Studio, DACPAC | [sql-server-data-tools](https://learn.microsoft.com/ru-ru/sql/ssdt/sql-server-data-tools?view=sql-server-ver17) |
| **sqlcmd / bcp** | Скрипты и автоматизация из CLI | раздел "Утилиты" в [overview-sql-tools](https://learn.microsoft.com/ru-ru/sql/tools/overview-sql-tools?view=sql-server-ver17) |
| **SqlPackage** | Экспорт/импорт BACPAC, CI/CD схемы | [sqlpackage](https://learn.microsoft.com/ru-ru/sql/tools/sqlpackage/sqlpackage?view=sql-server-ver17) |
| **SQL PowerShell** | `Invoke-Sqlcmd`, бэкапы, управление | [sql-server-powershell](https://learn.microsoft.com/ru-ru/powershell/sql-server/sql-server-powershell?view=sqlserver-ps) |
...
| Материал | Ссылка |
|----------|--------|
| Учебник (3 занятия: DDL/DML, права, очистка) | [tutorial-writing-transact-sql-statements](https://learn.microsoft.com/ru-ru/sql/t-sql/tutorial-writing-transact-sql-statements?view=sql-server-ver17) |
| Занятие 1 — объекты и запросы | [lesson-1-creating-database-objects](https://learn.microsoft.com/ru-ru/sql/t-sql/lesson-1-creating-database-objects?view=sql-server-ver17) |
| Занятие 2 — разрешения, VIEW, процедуры | [lesson-2-configuring-permissions-on-database-objects](https://learn.microsoft.com/ru-ru/sql/t-sql/lesson-2-configuring-permissions-on-database-objects?view=sql-server-ver17) |
| Занятие 3 — удаление объектов | [lesson-3-deleting-database-objects](https://learn.microsoft.com/ru-ru/sql/t-sql/lesson-3-deleting-database-objects?view=sql-server-ver17) |
| Справочник языка (алфавитный) | [t-sql/language-reference](https://learn.microsoft.com/ru-ru/sql/t-sql/language-reference?view=sql-server-ver17) |
| Функции | [t-sql/functions](https://learn.microsoft.com/ru-ru/sql/t-sql/functions/functions?view=sql-server-ver17) |
| Интерактивная практика | [Get started querying with T-SQL](https://learn.microsoft.com/ru-ru/training/paths/get-started-querying-with-transact-sql/) |

Сравнение синтаксиса PL/SQL и T-SQL в энциклопедии: [Процедурные расширения - PL/pgSQL, T-SQL — процедурные расширения](/encyclopedia/3-data-markup/3-07-sql/882).
...
| Сценарий | Ссылка |
|----------|--------|
| SQL Server на Windows | [install-sql-server](https://learn.microsoft.com/ru-ru/sql/database-engine/install-windows/install-sql-server?view=sql-server-ver17) |
| Express / Developer (бесплатно) | [скачать SQL Server](https://www.microsoft.com/sql-server/sql-server-downloads) |
| Драйверы и библиотеки (.NET, JDBC, ODBC, Node и др.) | [sql/connect](https://learn.microsoft.com/ru-ru/sql/connect/?view=sql-server-ver17) |

---

### Практика после теории в энциклопедии

1. Установите **SQL Server Express** или **Developer** и **SSMS** (ссылки выше).
2. Пройдите [быстрый старт SSMS](https://learn.microsoft.com/ru-ru/ssms/quickstarts/ssms-connect-query-sql-server?view=sql-server-ver17) и учебник T-SQL (занятия 1–3).
3. Разверните [образцы БД](https://learn.microsoft.com/ru-ru/sql/samples/sql-samples-where-are?view=sql-server-ver17) и сверяйте конструкции с разделами 1–31 ниже.
4. Для .NET-приложений — [драйверы подключения](https://learn.microsoft.com/ru-ru/sql/connect/?view=sql-server-ver17) и главу [4.10 — код и СУБД](/encyclopedia/4-code-dev/4-10-orm-i-rabota-s-dannymi/111).
...
- Приоритет при взаимоблокировках:
