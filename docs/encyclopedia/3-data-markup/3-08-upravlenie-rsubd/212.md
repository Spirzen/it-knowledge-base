...
- Включает:
  ...
  - Query Editor
  - Activity Monitor
  - Profiler (через расширения или Azure Данные Studio)
  - Template Explorer
  - Registered Servers
...
### 17.3. Row-Level Безопасность (RLS)
...
### 17.4. Transparent Данные Encryption (TDE)
...
- **Azure Данные Studio** + расширения — для анализа совместимости
...
- Избегать запуска от `Local Система` в production
