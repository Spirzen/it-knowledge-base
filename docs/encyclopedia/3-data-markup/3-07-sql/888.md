...
**Другие СУБД в этом цикле:** [SQLite](./887.md) · [MySQL](./889.md) · [Microsoft SQL Server](./890.md) · [SQL — о разделе](./intro.md) · [Практикум demo — авиакомпания](./891.md) · [Практикум PostgreSQL по JSONB](./66.md).
...
Маршрут для новичка по PostgreSQL — в [SQL — о разделе](./intro.md): [101](./101.md) (установка и psql) → эта глава → [демобаза авиакомпании](./891.md) → [справочник администратора](/encyclopedia/3-data-markup/3-08-upravlenie-rsubd/2.md).
...
Развитием руководит **PostgreSQL Global Development Group**; релиз major-версии выходит примерно раз в год (сейчас актуальна **16**). Среди ключевых механизмов ядра — **MVCC**, **WAL** и **vacuum**; к экосистеме относятся полнотекстовый поиск, типы **JSON/JSONB** и семейства индексов **GiST/GIN**.
