...
<div class="callout callout--tip">
  ...
  <p>PostgreSQL — рекомендуемая СУБД для практики <strong>всем</strong> в IT, независимо от языка программирования. Поставьте сервер на свой компьютер, откройте psql и пройдите маршрут ниже. Обзор установки — <a href="/tools/data/1">СУБД в Инструментах</a>.</p>
</div>
  </div>
...
10. [Шпаргалка типичных задач](./885.md) — после основ; рецепты на схеме магазина, не замена главам 107–108  
