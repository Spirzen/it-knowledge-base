...
3. [Первые шаги с SQL](./101.md) — **проектирование ER → SQLite (DB Browser) → установка PostgreSQL** → [Практикум shop_data](./111.md) → [SQL — реальные кейсы](/lab/Примеры/1152) → [Словарь данных и каталоги](./105.md)  
   **PostgreSQL:** после [Первые шаги с SQL](./101.md) (SQLite-проект, установка, psql, [pgAdmin](./101.md#pgadmin-4)) — [PostgreSQL — практическая работа и API](./888.md) → [phpPgAdmin](/encyclopedia/5-languages/5-07-php/phppgadmin/intro) → [демобаза demo](./891.md) → [справочник администратора](/encyclopedia/3-data-markup/3-08-upravlenie-rsubd/2.md). Продвинутая эксплуатация — [практикум PostgreSQL 8.11](/encyclopedia/8-infra-security/8-11-praktikum-postgresql/intro).
...
11. Табличные операции в Python (Pandas, Polars, PySpark) рядом с SQL — [напоминалка](/encyclopedia/3-data-markup/3-11-analiz-dannyh/426); типовые вызовы только в Pandas — [Pandas — типовые операции при анализе данных](/encyclopedia/3-data-markup/3-11-analiz-dannyh/428)
