...
1. [Эволюция систем хранения данных](./102.md) → [Реляционная модель](./103.md) (отношения, ключи) → [Нормализация](./104.md) (1НФ–3НФ, денормализация)
...
5. [Транзакции](./77.md) → [Конкурентный доступ (теория)](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/7.md) → [блокировки](./110.md) → [оптимизация](./881.md) → [сложные индексы](./884.md) → [восстановление после сбоя](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/8.md) → [резервное копирование](./106.md)
