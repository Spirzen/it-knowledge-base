...
3. [Первые шаги с SQL](./101.md) → [Практикум shop_data](./111.md) → [Словарь данных и каталоги](./105.md)  
   **PostgreSQL:** после [101](./101.md) (установка, psql, [pgAdmin](./101.md#pgadmin-4)) — [888](./888.md) (сервер, psql, API) → [демобаза demo — авиакомпания](./891.md) → [справочник администратора](/encyclopedia/3-data-markup/3-08-upravlenie-rsubd/2.md).
