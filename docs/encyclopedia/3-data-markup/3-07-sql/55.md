...
| **CROSS JOIN** | Декартово произведение (каждая со каждой) | Редко; осознанно, без случайного `CROSS` |
...
<div class="callout callout--info">
  ...
  <strong>FULL</strong> — LEFT и RIGHT вместе, без потери строк с любой стороны.
  </div>
</div>
