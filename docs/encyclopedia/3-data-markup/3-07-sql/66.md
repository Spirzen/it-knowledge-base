...
JSONB в PostgreSQL закрывает частую задачу интеграций: хранить структурированные данные в одном поле, быстро фильтровать по вложенным ключам и агрегировать значения в SQL.
