...
Это **шпаргалка рецептов**: одна учебная схема и типовые задачи — от `SELECT` до администрирования PostgreSQL. С нуля — по [дорожной карте](./intro.md); здесь удобно искать "как сделать X", когда основы пройдены.
