...
Полный пошаговый практикум по PostgreSQL JSONB с таблицей, 10 большими JSON-записями, `JOIN`, `CROSS JOIN`, `HAVING`, `RETURNING`, индексами и `EXPLAIN` — в главе [Практикум PostgreSQL по JSONB](./66.md).
