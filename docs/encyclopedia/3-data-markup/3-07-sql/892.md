...
<div class="callout callout--tip">
  ...
  Рецепты на схеме интернет-магазина (categories, orders, …) — [885](./885.md). Подключение, API и углубление по каждой СУБД — [SQLite](./887.md), [PostgreSQL](./888.md), [MySQL](./889.md), [Microsoft SQL Server](./890.md). Теория JOIN — [55](./55.md); VIEW — [8](./8.md); порядок выполнения SELECT — [107](./107.md) и [2](./2.md).
</div>
