...
<ExternalPlayEmbed example="data-markup/sql-insert-trainer" title="SQL INSERT — тренажёр" minHeight={480} />
...
<ExternalPlayEmbed example="data-markup/sql-update-trainer" title="SQL UPDATE — тренажёр" minHeight={480} />
...
<ExternalPlayEmbed example="data-markup/sql-delete-trainer" title="SQL DELETE — тренажёр" minHeight={480} />
...
- [SQL — реальные кейсы](/lab/Примеры/1152) — `INSERT`, `UPDATE`, `DELETE` и параметризованные запросы с разбором
