...
description: В контексте SQL и реляционных баз данных термин процедура почти всегда означает хранимую процедуру (stored procedure) — программный объект, хранящийся в каталоге СУБД и выполняемый на сервере.…
---
