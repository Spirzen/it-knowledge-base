...
<ExternalPlayEmbed example="data-markup/sql-window-functions-play" title="SQL — оконные функции" minHeight={480} />
...
<ExternalCodeEmbed example="sql/sql-7-001" title="Ранжирование и нумерация строк" minHeight={318} />
...
<ExternalCodeEmbed example="sql/sql-7-002" title="Аналитические отчёты без Excel" minHeight={720} />
...
<ExternalCodeEmbed example="sql/sql-7-003" title="Практика — разбор кейсов" minHeight={336} />
...
Дополнительная практика: [демобаза demo (авиакомпания)](./891.md) (доли пассажиров), [вопросы для самопроверки](/lab/questions/117#оконные-функции-и-аналитические-запросы), [SQL — реальные кейсы](/lab/Примеры/1152) (JOIN, `GROUP BY`, суммы на схеме магазина), [примеры SQL в лаборатории](/lab/examples/118).
