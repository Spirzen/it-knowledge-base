...
<ExternalPlayEmbed example="data-markup/protobuf-wire-play" title="Protobuf wire format" minHeight={480} />
...
Текстовые форматы: [JSON](./3.md), [YAML](./4.md). В PostgreSQL документы того же вида хранят как [JSONB](./217.md) (не путать с BSON MongoDB). Использование в API: [интеграции](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/117).
