...
Текстовый обмен данными между системами по-прежнему описан в статье [JSON](./3.md). JSONB — **способ хранить и запрашивать те же структуры внутри реляционной БД**, когда схема гибкая или приходит "как есть" из интеграций.
