...
|---------|-----|--------------------|----------|
| `Emoji` | Boolean | `Yes` / `No` | Является ли символ базовым эмодзи (см. `Emoji=Yes` в `emoji-Данные.txt`) |
...
### Данные стандарта — `emoji-Данные.txt`, `emoji-sequences.txt`, `emoji-variation-sequences.txt`
...
|------|-------------|------------|
| `emoji-Данные.txt` | [`emoji-Данные.txt`](https://www.unicode.org/Public/emoji/15.1/emoji-Данные.txt) | Свойства `Emoji`, `Emoji_Presentation`, `Emoji_Modifier`, `Emoji_Modifier_Base`, `Emoji_Component`, `Extended_Pictographic` для отдельных кодпойнтов |
...
> - C#: [`EmojiData`](https://github.com/neosmart/EmojiData) (библиотека с embedded emoji-Данные.txt)
