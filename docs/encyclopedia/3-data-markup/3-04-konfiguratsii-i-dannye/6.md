...
- **WPF** — классические desktop-приложения Windows ([обзор WPF](https://learn.microsoft.com/ru-ru/dotnet/desktop/wpf/overview/)); готовые окна с разбором XAML — [C# WinForms и WPF (Lab)](/lab/Примеры/1138), практикум — [Первая форма WPF — XAML, стили и шаблоны](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/119);
