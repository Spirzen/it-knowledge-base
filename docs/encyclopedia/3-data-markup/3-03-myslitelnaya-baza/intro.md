...
description: Когнитивистика, математика для IT, теория автоматов и семантика данных — маршруты чтения раздела.
...
<div class="callout callout--info">
  ...
  Раздел <strong>не входит</strong> в базовый маршрут "данные и SQL для новичка". Читайте выборочно, если интересны когнитивистика, дискретная математика или формальные автоматы — или когда упрётесь в теорию на курсах/олимпиадах. Краткий обзор по **графам** — <a href="/encyclopedia/1-basics/1-035-bazovaya-informatika/1#графы">раздел 22 «Базовой информатики»</a> (этап 28).
  </div>
</div>
...
<div class="callout callout--tip">
  <div class="callout-title">Дорожка 4 — семантика и представление знаний</div>

  <div class="callout-body">
  <p>Для аналитиков, архитекторов данных и тех, кто строит глоссарии, схемы и графы знаний. Желательно пройти <a href="./31">логику</a> и <a href="./323">графы</a>; <a href="./322">реляционную алгебру</a> — если идёте к БД.</p>
  <p><strong>Маршрут:</strong> <a href="./326">326</a> (семантика — хаб) → <a href="./327">327</a> (представление знаний) → <a href="./328">328</a> (онтология) → <a href="./329">329</a> (концептуальные схемы) → <a href="./330">330</a> (семантический веб, продвинуто). Термины маршрута — <a href="./331">словарь 331</a>.</p>
  <p>Связанные разделы: <a href="/encyclopedia/1-basics/1-09-dannye-i-informatsiya/5">метаданные</a>, <a href="/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/intro">основы БД</a>, <a href="/encyclopedia/6-ai/6-09-transformery-i-nlp/intro">NLP</a>.</p>
</div>
  </div>
