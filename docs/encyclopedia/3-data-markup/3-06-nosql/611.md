...
<ExternalPlayEmbed example="basics/installer-wizard-play" title="Мастер установки" minHeight={480} playProps={{ appName: 'Установка Apache Cassandra', productName: 'Apache Cassandra', welcomeText: 'Требуется JDK 11 или 17. Мастер развернёт узел cassandra и утилиту cqlsh.', extraOptionsLabel: 'Установить OpenJDK, если не найден в системе', cardSubtitle: 'Далее — apt/Docker и эмулятор CQL' }} />

<ExternalPlayEmbed example="data-markup/cassandra-cql-play" title="Cassandra CQL" minHeight={480} />
...
<ExternalCodeEmbed example="sql/nosql-611-001" title="Сквозной практикум (15 минут)" minHeight={552} />
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первые шаги с Redis](/encyclopedia/3-data-markup/3-06-nosql/511), [Первые шаги с Memcached](/encyclopedia/3-data-markup/3-06-nosql/8111), [Первые шаги с MongoDB](/encyclopedia/3-data-markup/3-06-nosql/411), [Первые шаги к микросервисам](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/101), [Первые шаги с SQL](/encyclopedia/3-data-markup/3-07-sql/101), [Первые шаги с Docker и Kubernetes](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/1172).
