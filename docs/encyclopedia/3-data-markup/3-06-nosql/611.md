...
<InstallerWizardPlay
  appName="Установка Apache Cassandra"
  productName="Apache Cassandra"
  welcomeText="Требуется JDK 11 или 17. Мастер развернёт узел cassandra и утилиту cqlsh."
  extraOptionsLabel="Установить OpenJDK, если не найден в системе"
  cardSubtitle="Далее — apt/Docker и эмулятор CQL"
/>
