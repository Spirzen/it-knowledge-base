...
<ExternalPlayEmbed example="basics/installer-wizard-play" title="Мастер установки" minHeight={480} playProps={{ appName: 'Установка MongoDB', productName: 'MongoDB Server', welcomeText: 'Мастер установит сервер mongod и утилиту mongosh. Каталог данных задаётся отдельно от Program Files.', defaultPath: 'C:\\\\Program Files\\\\MongoDB\\\\Server\\\\7.0', extraOptionsLabel: 'Установить MongoDB Compass (GUI)', cardSubtitle: 'Далее — apt/Docker и эмулятор shell' }} />

<ExternalPlayEmbed example="data-markup/mongo-shell-play" title="MongoDB Shell" minHeight={480} />
...
<ExternalCodeEmbed example="javascript/nosql-411-001" title="Порядок — валидатор, затем данные" minHeight={426} />
...
<ExternalCodeEmbed example="javascript/nosql-411-002" title="Вставка нескольких документов" minHeight={462} />
...
<ExternalCodeEmbed example="javascript/nosql-411-003" title="Связи между коллекциями" minHeight={390} />
...
Для сортировки по `createdAt` сохраняйте пару `(createdAt, _id)` — tie-breaker на случай одинаковых дат. **Tailable cursor** на capped collection — отдельный сценарий (хвост лога). Подробнее — [антипаттерны в курсе](/encyclopedia/3-data-markup/3-06-nosql/4#антипаттерны-и-типичные-ошибки).
...
<ExternalCodeEmbed example="javascript/nosql-411-004" title="Простое представление" minHeight={444} />
...
> **Общая база:** [функции в коде](/encyclopedia/4-code-dev/4-02-chto-takoe-kod-i-kak-on-rabotaet/4) — вызов, параметры, возврат. Примеры ниже на JavaScript в `mongosh`; в production ту же логику обычно выносят в приложение.
...
<ExternalCodeEmbed example="javascript/nosql-411-005" title="Процедура с использованием пайплайна агрегации" minHeight={642} />
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первые шаги с SQL](/encyclopedia/3-data-markup/3-07-sql/101), [Первые шаги с Redis](/encyclopedia/3-data-markup/3-06-nosql/511), [Первая программа на Expo](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/11321), [Первые шаги с Cassandra](/encyclopedia/3-data-markup/3-06-nosql/611), [Первая программа на React Native](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/11311), [Первые шаги с Memcached](/encyclopedia/3-data-markup/3-06-nosql/8111).
