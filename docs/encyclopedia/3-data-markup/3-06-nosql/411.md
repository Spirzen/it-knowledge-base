...
<InstallerWizardPlay
  appName="Установка MongoDB"
  productName="MongoDB Server"
  welcomeText="Мастер установит сервер mongod и утилиту mongosh. Каталог данных задаётся отдельно от Program Files."
  defaultPath="C:\\Program Files\\MongoDB\\Server\\7.0"
  extraOptionsLabel="Установить MongoDB Compass (GUI)"
  cardSubtitle="Далее — apt/Docker и эмулятор shell"
/>
