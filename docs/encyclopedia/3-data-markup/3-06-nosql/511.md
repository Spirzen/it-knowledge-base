...
<InstallerWizardPlay
  appName="Установка Redis"
  productName="Redis for Windows"
  welcomeText="Мастер установит redis-server и redis-cli. На Linux чаще используют apt — без GUI-мастера."
  extraOptionsLabel="Добавить Redis в службы Windows (автозапуск)"
  cardSubtitle="Далее — Linux apt и практикум типов данных"
/>
...
**Первые шаги** ([маршрут подборки](/about/collections/pervye-shagi)) — [Первые шаги с MongoDB](/encyclopedia/3-data-markup/3-06-nosql/411), [Первые шаги с Cassandra](/encyclopedia/3-data-markup/3-06-nosql/611), [Первые шаги с SQL](/encyclopedia/3-data-markup/3-07-sql/101), [Первые шаги с Memcached](/encyclopedia/3-data-markup/3-06-nosql/8111), [Первая программа на Expo](/encyclopedia/4-code-dev/4-12-mobilnye-prilozheniya/11321), [Первые шаги к микросервисам](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/101).
