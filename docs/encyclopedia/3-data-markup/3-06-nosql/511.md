...
<ExternalPlayEmbed example="basics/installer-wizard-play" title="Мастер установки" minHeight={480} playProps={{ appName: 'Установка Redis', productName: 'Redis for Windows', welcomeText: 'Мастер установит redis-server и redis-cli. На Linux чаще используют apt — без GUI-мастера.', extraOptionsLabel: 'Добавить Redis в службы Windows (автозапуск)', cardSubtitle: 'Далее — Linux apt и практикум типов данных' }} />
