...
description: NoSQL может быть представлен в виде — JavaScript-like синтаксиса (MongoDB shell) — здесь работают правила JS, JSON/BSON — тогда действуют правила JSON
---
