...
| [2.md](./2.md) | Эволюция систем: от MVP к масштабированию и миграциям |
| [3.md](./3.md) | Практика деплоя: от вопросов перед запуском до Docker, Kubernetes и статического хостинга |
| [998.md](./998.md) | Итоги — краткое резюме прочитанного |
| [999.md](./999.md) | Чек-лист — вопросы для самопроверки |

Рекомендуемый порядок: intro → 1 → 2 → выбранный маршрут из главы 1 → итоги и чек-лист.
...
2. [Основы развития информационных систем](./2.md) — путь от MVP до кэша, балансировки, репликации и миграций
3. Один практический блок по интересу
...
4. [Итоги](./998.md) и [чек-лист](./999.md)
...
Эти кейсы помогают понять, почему инфраструктура и ИБ составляют одну цепочку.
