...
CLI, конфигурация и типовые сценарии **Docker** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8.06. Контейнеризация и оркестрация/intro).
