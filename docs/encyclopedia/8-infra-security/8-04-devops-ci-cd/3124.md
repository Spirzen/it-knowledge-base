...
description: Справочник по Azure Repos Git - управляемые репозитории и распределённый workflow Git в составе Azure DevOps.
referenceType: tool
related:
...
**Azure Repos Git** — управляемый Git в Azure DevOps: репозитории, ветки, pull request, политики веток и интеграция с Azure Pipelines. В CI/CD события PR и push запускают пайплайны; политики блокируют merge без успешной сборки и ревью.
...
```sql
DELETE /refs?filter=heads/feature/x
```
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3124-001" title="Интеграция с Azure Pipelines — триггеры на Pull Request" minHeight={462} />
...
<ExternalCodeEmbed example="json/infra-security-8-8-04-devops-ci-cd-3124-002" title="Webhook-события и payload" minHeight={678} />
...
**Справочники** — [E2E-тесты и CI с Playwright и GitHub Actions](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3123), [Справочник по SOAP](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1201), [Справочник по Tempo](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3122), [Справочник по gRPC](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1202), [Справочник по Loki](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3121), [Справочник по GraphQL](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1203).
