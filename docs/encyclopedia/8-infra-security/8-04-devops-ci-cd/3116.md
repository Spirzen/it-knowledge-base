...
CLI, конфигурация и типовые сценарии **Grafana** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro). Пошаговый стенд — [Практикум Prometheus и Grafana](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/intro). Запросы для панелей и Explore — [галерея PromQL](/lab/Примеры/11114).
