...
CLI, конфигурация и типовые сценарии **Tempo** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro). Практикум — [Loki, Tempo и Mimir, шаг 7](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/7). Метрики в Prometheus — [галерея PromQL](/lab/Примеры/11114).
...
- Требует оркестрации (Kubernetes, Docker Compose). Локальные multi-service стеки — [Docker Compose — готовые стеки](/lab/Примеры/11111); образы сервисов — [Dockerfile — 10 типовых образов](/lab/Примеры/11113); в prod — [Kubernetes](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/117).
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3122-001" title="Компоненты" minHeight={390} />
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3122-002" title="Пример минимальной конфигурации (`tempo.yaml`)" minHeight={588} />
