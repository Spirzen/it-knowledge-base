...
<div class="callout callout--info">
  ...
  Базовый цикл CLI — [практический путь](/encyclopedia/8-infra-security/8-04-devops-ci-cd/22.md); справочник HCL — [3.md](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3.md).
</div>
  </div>
