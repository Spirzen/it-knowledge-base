...
Обзор дисциплины — [AgentOps](./2151). Мультиагентные flow — [Мультиагентные команды и DevOps-pipeline](./2152).
...
- Как собрать и запустить проект (`npm run`, `docker compose` — шаблоны стека в [Docker Compose — готовые стеки](/lab/Примеры/11111));
...
- [ ] Tracing включён — [Инструменты AgentOps](./2154)
