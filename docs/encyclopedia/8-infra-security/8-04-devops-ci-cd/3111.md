...
description: Справочник по Ansible - декларативная автоматизация конфигурации и развёртывания, playbooks и управление состоянием узлов.
referenceType: tool
related:
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3111-001" title="Структура play" minHeight={336} />
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3111-002" title="Примеры задач" minHeight={408} />
...
ansible-vault encrypt existing.yml  # зашифровать существующий
...
ansible-inventory --list                         # инвентарь в JSON
ansible-doc <module>                             # справка по модулю
ansible-playbook playbook.yml                    # запуск плейбука
ansible-galaxy install geerlingguy.nginx         # роль из Galaxy
ansible-config dump --only-changed               # изменённые настройки
```
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3111-003" title="Базовый плейбук для настройки веб-сервера" minHeight={720} />
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3111-004" title="Плейбук с использованием ролей и коллекций" minHeight={336} />
...
<ExternalCodeEmbed example="python/infra-security-8-8-04-devops-ci-cd-3111-005" title="Пример простого модуля `hello.py`" minHeight={336} />
...
**Справочники** — [Справочник по Terraform](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3), [Справочник по Nginx](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3112), [Справочник по нотации BPMN 2.0](/encyclopedia/7-project/7-04-analitika/129), [Справочник по GitHub Actions](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3113), [Справочник по языку С](/encyclopedia/5-languages/5-16-starye-yazyki/c-language/8), [Справочник по Jenkins](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3114).
