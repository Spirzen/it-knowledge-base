...
<div class="callout callout--tip">
  ...
  <p>В запросах часто имеют в виду <strong>RDP</strong> (Remote Desktop Protocol) — протокол удалённого рабочего стола Windows. В статье описан именно RDP; если у вас под "RGP" закреплён другой внутренний сервис, сверьтесь с документацией компании.</p>
</div>
