...
description: Справочник по Loki - хранение и запрос логов от Grafana Labs, типовая связка с Prometheus и стеком наблюдаемости.
referenceType: tool
related:
...
CLI, конфигурация и типовые сценарии **Loki** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro). Практикум — [Loki и Tempo, шаг 7](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/7). PromQL для метрик в паре с LogQL — [галерея Lab](/lab/Примеры/11114).
...
- Запуск: см. блок "Быстрый старт" (`loki -config.file=…`)
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3121-001" title="Пример минимальной конфигурации (monolithic)" minHeight={720} />
...
**Справочники** — [Справочник по Kibana](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3120), [Справочник по Tempo](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3122), [Справочник по Logstash](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3119), [E2E-тесты и CI с Playwright и GitHub Actions](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3123), [Справочник по AWS](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3118), [Справочник по Azure Repos Git](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3124).
