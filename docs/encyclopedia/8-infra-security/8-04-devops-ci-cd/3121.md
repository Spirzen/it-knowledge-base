...
CLI, конфигурация и типовые сценарии **Loki** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro). Практикум — [Loki и Tempo, шаг 7](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/7).
