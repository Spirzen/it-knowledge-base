...
CLI, конфигурация и типовые сценарии **Apache HTTP Server** (DevOps, shared hosting, legacy PHP). Учебный обзор: [Веб-серверы](/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/112). Параллельный материал по Nginx: [Справочник по Nginx](./3112.md), [Nginx — конфиги под задачу](/lab/Примеры/11112). Курс раздела: [DevOps и CI/CD](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro).
...
Разбор флагов `-I`, `-H`, кодов ответа — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133), [curl / fetch — примеры](/lab/Примеры/1133).
...
<ExternalCodeEmbed example="text/infra-security-8-8-04-devops-ci-cd-3125-001" title="Debian/Ubuntu" minHeight={318} />
...
<ExternalCodeEmbed example="text/infra-security-8-8-04-devops-ci-cd-3125-002" title="Базовый шаблон в конфиге виртуального хоста" minHeight={444} />
...
Nginx (см. [Справочник по Nginx](./3112.md)):



<ExternalCodeEmbed example="nginx/infra-security-8-8-04-devops-ci-cd-3125-003" title="Стек Nginx + Apache" minHeight={372} />
