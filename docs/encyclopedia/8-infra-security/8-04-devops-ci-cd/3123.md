...
Базовые темы: [DevOps и CI/CD](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro), [тестирование в проекте](/encyclopedia/7-project/7-05-testirovanie/intro), [Git](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/intro).
...
- [Тестирование в проекте](/encyclopedia/7-project/7-05-testirovanie/intro) — пирамида, unit и integration
- [GitHub Actions — CI/CD рецепты](/lab/Примеры/1134) — workflow для pytest, Node, matrix и деплоя
- [Проверка надёжности под нагрузкой](/encyclopedia/7-project/7-05-testirovanie/1014) — нагрузка после функциональных E2E
- [Git](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/intro) — ветки, PR и защита `main`
- [Контейнеризация](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/intro) — образ приложения для staging в CI
- [Микросервисы и интеграция](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/intro) — когда E2E бьёт в API-gateway и несколько сервисов
