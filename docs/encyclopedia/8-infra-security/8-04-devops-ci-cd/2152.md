...
**Observability** — trace каждого run linked to `commit_sha` и `pr_number`; метрики «стоимость PR», «время до merge», «% PR без human edits» — см. [мониторинг](/encyclopedia/8-infra-security/8-04-devops-ci-cd/19) и [2154](./2154).
