...
description: Справочник по Jenkins - CI/CD, агенты, задания и автоматизация сборки, тестов и развёртывания.
referenceType: tool
related:
...
CLI, конфигурация и типовые сценарии **Jenkins** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro).
...
- [Архитектура Jenkins](#архитектура-jenkins)
- [Master-узел](#master-узел)
- [Агенты (агентские узлы, worker nodes)](#агенты-агентские-узлы-worker-nodes)
- [Плагины](#плагины)
- [Конфигурационные файлы](#конфигурационные-файлы)
- [Типы заданий (Job Types)](#типы-заданий-job-types)
- [Freestyle Project](#freestyle-project)
- [Pipeline](#pipeline)
- [Multibranch Pipeline](#multibranch-pipeline)
- [Organization Folder](#organization-folder)
- [External Job](#external-job)
- [Matrix Project (через плагин)](#matrix-project-через-плагин)
- [Pipeline: основы](#pipeline-основы)
- [Декларативный синтаксис](#декларативный-синтаксис)
- [Встроенные шаги (Steps)](#встроенные-шаги-steps)
- [Управление исходным кодом](#управление-исходным-кодом)
- [Выполнение команд](#выполнение-команд)
- [Управление файлами и директориями](#управление-файлами-и-директориями)
- [Переменные и окружение](#переменные-и-окружение)
- [Учетные данные](#учетные-данные)
- [Уведомления](#уведомления)
- [Работа с Docker](#работа-с-docker)
- [Запуск других заданий](#запуск-других-заданий)
- [Контроль потока](#контроль-потока)
- [Работа с JSON, XML, YAML](#работа-с-json-xml-yaml)
- [Тестирование и отчеты](#тестирование-и-отчеты)
- [Условия выполнения (`when`)](#условия-выполнения-when)
- [Простые условия](#простые-условия)
- [Расширенные условия](#расширенные-условия)
- [Параллельное выполнение](#параллельное-выполнение)
- [Обработка ошибок и повторы](#обработка-ошибок-и-повторы)
- [Блок `catchError`](#блок-catcherror)
- [Повтор с логикой](#повтор-с-логикой)
- [Повторное использование кода](#повторное-использование-кода)
- [Shared Libraries](#shared-libraries)
- [Шаблоны через `load`](#шаблоны-через-load)
- [Глобальные переменные](#глобальные-переменные)
- [Основные переменные (`env`)](#основные-переменные-env)
- [Объект `params`](#объект-params)
- [Объект `currentBuild`](#объект-currentbuild)
- [Объект `scm`](#объект-scm)
- [Параметры заданий: типы и допустимые значения](#параметры-заданий-типы-и-допустимые-значения)
- [`string`](#string)
...
- [`password`](#password)
- [`file`](#file)
- [Безопасность и Groovy Sandbox](#безопасность-и-groovy-sandbox)
- [Что запрещено в sandbox:](#что-запрещено-в-sandbox)
- [Как обойти ограничения:](#как-обойти-ограничения)
- [Рекомендации:](#рекомендации)
- [Jenkins Configuration as Code (JCasC)](#jenkins-configuration-as-code-jcasc)
- [Включение JCasC:](#включение-jcasc)
- [Пример `jenkins.yaml`:](#пример-jenkinsyaml)
- [Преимущества JCasC:](#преимущества-jcasc)
- [Переменные окружения в JCasC:](#переменные-окружения-в-jcasc)
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-04-devops-ci-cd-3114-001" title="Пример `jenkins.yaml`" minHeight={720} />
...
| Область | Примечание |
|---------|------------|
| Версии | актуальные LTS/стабильные релизы **Jenkins** |
...
**Справочники** — [Справочник по GitHub Actions](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3113), [Справочник по Prometheus](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3115), [Справочник по Nginx](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3112), [Справочник по Grafana](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3116), [Справочник по Ansible](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3111), [Справочник по Elasticsearch](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3117).
