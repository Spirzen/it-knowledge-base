...
description: Prometheus — это система мониторинга и база данных временных рядов с открытым исходным кодом, ориентированная на надёжность, масштабируемость и гибкость. Она предоставляет мощный язык запросов…
referenceType: tool
---
