...
description: Справочник по Nginx - веб-сервер, обратный прокси, балансировка нагрузки и модульная конфигурация.
referenceType: tool
related:
  - title: "Справочник по Apache HTTP Server"
    doc: encyclopedia/8-infra-security/8-04-devops-ci-cd/3125
...
CLI, конфигурация и типовые сценарии **Nginx** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro). Готовые фрагменты конфигов с разбором — [Nginx — конфиги под задачу](/lab/Примеры/11112).
...
<div class="callout callout--tip">
  <div class="callout-title">Примеры под задачу</div>

  <div class="callout-body">
  Статика, reverse proxy, SPA, PHP-FPM, SSL и балансировка — с построчным разбором и проверкой через <code>curl</code>: <a href="/lab/Примеры/11112">Nginx — конфиги под задачу</a>.
</div>
</div>
...
<ExternalCodeEmbed example="nginx/infra-security-8-8-04-devops-ci-cd-3112-001" title="3. Контекст `http`" minHeight={390} />
...
<ExternalCodeEmbed example="nginx/infra-security-8-8-04-devops-ci-cd-3112-002" title="Примеры" minHeight={336} />
...
**Справочники** — [Справочник по Ansible](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3111), [Справочник по GitHub Actions](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3113), [Справочник по Terraform](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3), [Справочник по Jenkins](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3114), [Справочник по нотации BPMN 2.0](/encyclopedia/7-project/7-04-analitika/129), [Справочник по Prometheus](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3115).
