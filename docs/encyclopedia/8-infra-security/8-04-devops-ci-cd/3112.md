...
description: Nginx — высокопроизводительный веб-сервер, прокси-сервер и балансировщик нагрузки с открытым исходным кодом. Он обрабатывает HTTP, HTTPS, SMTP, POP3, IMAP и поддерживает модульное расширение…
referenceType: tool
---
# Справочник по Nginx
