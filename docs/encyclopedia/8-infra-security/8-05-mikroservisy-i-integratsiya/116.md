...
Сводная таблица всех четырёх паттернов с sequence-диаграммами — [Polling, Long Polling, SSE и Webhook](/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/129). Push/pull и надёжность webhook — в [120](./120).
