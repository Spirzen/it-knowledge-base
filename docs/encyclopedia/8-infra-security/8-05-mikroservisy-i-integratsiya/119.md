...
At-least-once допускает дубликаты при retry producer или повторном commit consumer. Для агрегаций и stream processing дубликат искажает результат — нужна семантика **exactly-once**.
