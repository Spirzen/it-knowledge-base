...
CLI, конфигурация и типовые сценарии **SOAP** (DevOps, CI/CD, инфраструктура). Учебный курс: [раздел](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/intro).
