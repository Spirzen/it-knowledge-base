...
Методы, коды ответов, заголовки и форматы **gRPC** в табличном виде. Учебный курс: [REST, GraphQL и gRPC — стили API](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/130), [раздел 8.05](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/intro).
...
Разбор:
- `protoc` генерирует C#/Go/Java-код из `.proto`; флаги `--csharp_out` и `--grpc_out` добавляют stubs для gRPC.
...
<ExternalCodeEmbed example="text/infra-security-8-8-05-mikroservisy-i-integratsiya-1202-001" title="1. Общая структура `.proto`-файла" minHeight={696} />
...
<ExternalCodeEmbed example="text/infra-security-8-8-05-mikroservisy-i-integratsiya-1202-002" title="9.1. Объявление сервиса" minHeight={408} />
...
<ExternalCodeEmbed example="text/infra-security-8-8-05-mikroservisy-i-integratsiya-1202-003" title="10.1. Стандартные и широко используемые опции" minHeight={720} />
...
Разбор:
- Пакет `main` собирается в один бинарник; импорты из стандартной библиотеки не требуют внешних зависимостей.
...
<ExternalCodeEmbed example="csharp/infra-security-8-8-05-mikroservisy-i-integratsiya-1202-004" title="18.3. Unit/integration тестирование" minHeight={354} />
...
**Справочники** — [Справочник по SOAP](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1201), [Справочник по GraphQL](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1203), [Справочник по Azure Repos Git](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3124), [Справочник по RabbitMQ](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1204), [E2E-тесты и CI с Playwright и GitHub Actions](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3123), [Справочник по Apache Kafka](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1205).
