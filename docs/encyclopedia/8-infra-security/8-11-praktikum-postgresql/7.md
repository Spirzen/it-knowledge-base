...
<ExternalCodeEmbed example="yaml/infra-security-8-8-11-praktikum-postgresql-7-007" title="Volume — обязательное правило" minHeight={552} />
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-11-praktikum-postgresql-7-008" title="Сеть и несколько контейнеров" minHeight={480} />
