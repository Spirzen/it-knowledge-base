...
1. Поднимите Postgres в Docker Compose с healthcheck и volume; выполните серию UPDATE, отследите `n_dead_tup`. Ориентир — [стек №3](/lab/Примеры/11111#3-только-postgresql-для-разработки) и [PostgreSQL в Docker](./7.md).
