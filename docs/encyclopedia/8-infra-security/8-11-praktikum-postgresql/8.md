...
<ExternalCodeEmbed example="yaml/infra-security-8-8-11-praktikum-postgresql-8-009" title="StatefulSet — минимальный паттерн" minHeight={720} />
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-11-praktikum-postgresql-8-010" title="Операторы PostgreSQL" minHeight={336} />
