...
description: "Инфраструктура как код для PostgreSQL - Ansible роли, Terraform модули, настройка RDS, управление конфигурациями и GitOps практики для баз данных."
related:
  - title: "Terraform"
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-11-praktikum-postgresql-12-001" title="Ansible — bare metal и VM" minHeight={354} />
...
<ExternalCodeEmbed example="text/infra-security-8-8-11-praktikum-postgresql-12-002" title="Terraform — managed PostgreSQL" minHeight={720} />
