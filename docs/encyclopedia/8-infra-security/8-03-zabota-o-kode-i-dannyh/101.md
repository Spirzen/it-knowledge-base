...
<div class="callout callout--caution">
  ...
  Запись уже вышла из срока хранения reflog; на remote сделали `push --force`, а у вас нет старого коммита; удалили папку `.git` без бэкапа. Тогда остаются клон с другой машины, бэкап ([115](./115.md)) или обращение к коллегам.
</div>
...
Резервные копии и шифрование — [115](./115.md), [117](./117.md).
