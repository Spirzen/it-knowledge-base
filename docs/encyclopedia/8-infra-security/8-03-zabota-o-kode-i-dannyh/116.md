...
<div class="callout callout--tip">
  ...
  Начните с [4.13 / Основы Git](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/intro) и [архитектуры Git](./111.md).
...
| Размер репозитория | Может быть большим на сервере | Компактный (дельта, packfile — [Особенности работы с репозиториями в Git](./113.md)) |
...
3. Публикация в GitHub/GitLab/GitVerse ([Gitverse - отечественная альтернатива Git](./1181.md), [SourceCraft - отечественная альтернатива Git](./1182.md)) и перенастройка CI ([DevOps](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro)).

После миграции команда учится не полагаться на «единственный сервер» как на единственный бэкап: `push` в remote + политика веток ([Модель ветвления GitFlow](./1111.md) или GitHub Flow).
...
Подробнее о хранении и передаче объектов Git — [Особенности работы с репозиториями в Git](./113.md); о рисках деструктивных команд — [Опасные скрипты](./101.md).
