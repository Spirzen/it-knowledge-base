...
<div class="callout callout--tip">
  ...
  Первый проход по Git — в [Основы работы с Git](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/intro): [workflow add/commit/push](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/112), [ветки и запросы на слияние](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/113). Карманный набор из 12 команд — [шпаргалка 4.13/115](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/115#12-komand). Примеры команд с построчным разбором — [лаборатория 1123](/lab/Примеры/1123). Эта статья дополняет курс **расширенным справочником** и короткими пояснениями «когда вызывать».
</div>
  </div>
