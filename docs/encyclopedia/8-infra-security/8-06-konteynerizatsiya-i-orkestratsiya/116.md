...
<div class="callout callout--tip">
  ...
  Десять готовых Dockerfile с построчным разбором, минимальным кодом приложения и типичными ошибками — <a href="/lab/Примеры/11113">Dockerfile — 10 типовых образов</a> (формат как у <a href="/lab/Примеры/111">галереи Turtle</a>). Ниже в этой главе — углублённые примеры для Node, Python, Go, SPA и Spring; для PHP, .NET и job-контейнера удобнее начать с галереи.
</div>
</div>
...
- [Универсальная шпаргалка — 9 практик Dockerfile](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/118#docker-9-praktik)
