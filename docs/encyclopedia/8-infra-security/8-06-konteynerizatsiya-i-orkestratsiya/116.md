...
title: Dockerfile и инструкции для сборки Docker-образа
...
# Dockerfile и инструкции для сборки Docker-образа
...
<ExternalPlayEmbed example="lab/dockerfile-builder" title="Dockerfile Builder" minHeight={420} />
...
- Примеры health-check и флагов `curl` — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133), [curl / fetch — примеры](/lab/Примеры/1133).
...
Таблица из **девяти практик** с минимальными примерами и связкой с командами `docker build` / `push` — в [универсальной шпаргалке](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/118#docker-9-praktik).
...
<div class="callout callout--tip">
  <div class="callout-title">Галерея для лабораторных и поиска</div>

  <div class="callout-body">
  Десять готовых Dockerfile с построчным разбором, минимальным кодом приложения и типичными ошибками — [Dockerfile — 10 типовых образов](/lab/Примеры/11113) (формат как у [галереи Turtle](/lab/Примеры/111)).
...
<ExternalCodeEmbed example="dockerfile/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-116-001" title="1. Node.js API (Express / Fastify)" minHeight={516} />
...
<ExternalCodeEmbed example="dockerfile/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-116-002" title="2. Python (Flask / FastAPI)" minHeight={498} />
...
<ExternalCodeEmbed example="dockerfile/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-116-003" title="3. Go-сервис (минимальный образ)" minHeight={390} />
...
<ExternalCodeEmbed example="dockerfile/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-116-004" title="4. React / Vue SPA + Nginx" minHeight={336} />
...
Полный разбор тех же приёмов вне Dockerfile — [Nginx — конфиги под задачу](/lab/Примеры/11112).
...
<ExternalCodeEmbed example="dockerfile/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-116-005" title="5. Java Spring Boot (JAR)" minHeight={426} />
...
<ExternalCodeEmbed example="dockerfile/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-116-006" title="Разбор на примере — Python по шагам" minHeight={372} />
...
- [DevOps — шпаргалка — 9 практик Dockerfile](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/118#docker-9-praktik)
