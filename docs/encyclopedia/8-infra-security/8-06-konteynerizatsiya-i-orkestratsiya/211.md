...
- [kubectl — шпаргалка команд](#kubectl--шпаргалка-команд)
...
Типовые команды `kubectl`, сгруппированные по задачам. Краткая версия — в [учебной шпаргалке](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/111#краткая-шпаргалка-kubectl); полный справочник CLI — [reference/kubectl](https://kubernetes.io/docs/reference/kubectl/).
