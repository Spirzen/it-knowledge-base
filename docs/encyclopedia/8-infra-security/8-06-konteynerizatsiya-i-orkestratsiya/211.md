...
Система мониторинга с pull-моделью. Использует **ServiceMonitor** и **PodMonitor** (через Prometheus Operator) для обнаружения целей. Учебный стенд — [Практикум Prometheus и Grafana](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/intro); мониторинг VM и bare metal — [Практикум Zabbix](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/zabbix-praktikum/intro); справочник — [Справочник по Prometheus](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3115).
...
Система агрегации логов от Grafana Labs. Хранит логи без полнотекстового индекса, используя метки (labels) для фильтрации. Практикум — [Loki и Tempo, шаг 7](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/7); справочник — [Справочник по Loki](/encyclopedia/8-infra-security/8-04-devops-ci-cd/3121).
