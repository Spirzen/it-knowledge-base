...
Перед первым `docker run` полезно прочитать [Запуск и перезапуск приложений](/encyclopedia/1-basics/1-035-bazovaya-informatika/208) — там отдельно разобран сценарий "Docker Desktop + терминал".
