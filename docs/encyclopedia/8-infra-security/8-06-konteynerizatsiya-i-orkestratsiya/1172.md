...
related:
  - title: "Первые шаги к микросервисам"
    doc: encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/101
...
<div class="callout callout--tip">
  ...
  Полный список с пояснениями — `build`, `push`, `exec`, `logs`, `inspect`, `cp`, `save`/`load` и другие — в [универсальной шпаргалке](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/118#docker-18-komand).
</div>
  </div>
...
<ExternalCodeEmbed example="yaml/infra-security-8-8-06-konteynerizatsiya-i-orkestratsiya-1172-001" title="Создание манифеста Deployment" minHeight={408} />
...
<div class="callout callout--info">
  ...
  Полная цепочка (фазы Pending → Running, завершение и SIGTERM) — в разделе [жизненный цикл Pod](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/117#zhiznennyy-tsikl-pod).
  </div>
</div>
