...
referenceType: tool
description: Jenkins — это система непрерывной интеграции и непрерывной доставки (CI/CD), написанная на Java. Она автоматизирует сборку, тестирование и развертывание программного обеспечения. Jenkins работает как серверное приложение
...
| Задача | Подсказка |
|--------|-----------|
| Установка | официальная документация **Jenkins** |
