...
referenceType: tool
description: "GitHub Actions — это система автоматизации рабочих процессов, встроенная непосредственно в платформу GitHub. Она позволяет выполнять последовательности задач (workflow) при наступлении определённых событий в репозитории:"
...
| Задача | Подсказка |
|--------|-----------|
| Установка | официальная документация **GitHub Actions** |
