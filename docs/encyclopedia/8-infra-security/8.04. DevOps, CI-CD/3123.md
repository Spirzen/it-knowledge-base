...
description: Grafana Mimir — это масштабируемая, отказоустойчивая, мультитенантная система долгосрочного хранения метрик, совместимая с Prometheus. Она предназначена для приема, хранения и выполнения запросов к…
referenceType: tool
---
# Справочник по Mimir
