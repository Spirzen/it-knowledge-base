...
description: Loki — это система логирования, разработанная Grafana Labs, ориентированная на эффективное хранение, индексирование и запрос логов без полнотекстового поиска. Она оптимизирована для работы в связке с…
referenceType: tool
---
# Справочник по Loki
