...
Stored XSS — payload сохраняется (комментарии, профиль). Проверяйте контекст (HTML, attribute, JS). Защита — CSP, encoding; см. [Безопасность приложений](/encyclopedia/8-infra-security/8-07-informatsionnaya-bezopasnost/113).
