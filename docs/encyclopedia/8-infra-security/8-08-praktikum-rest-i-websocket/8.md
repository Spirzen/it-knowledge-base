...
> **Практикум, шаг 8 из 8.** E2E-проверка **OrderDesk**. Сервисы из [шага 4](./4.md) и [Практикум — сервис заказов на C#](./5.md) должны быть запущены. Ожидаемые статусы можно заранее посмотреть в [интерактивной песочнице](/encyclopedia/8-infra-security/8-08-praktikum-rest-i-websocket/intro).
...
REST-часть войдёт в CI; WebSocket — вручную или через отдельный скрипт (k6, `websockets` в Python). Те же REST-запросы можно воспроизвести в терминале — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133), [curl / fetch — примеры](/lab/Примеры/1133).
...
Дальше — контейнеры ([8.06](/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/intro)), интеграционные тесты ([Проверка взаимодействия компонентов](/encyclopedia/7-project/7-05-testirovanie/1012)) и нагрузочное тестирование ([Проверка надежности под нагрузкой](/encyclopedia/7-project/7-05-testirovanie/1014)).
