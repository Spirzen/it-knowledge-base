...
<div class="callout callout--tip">
  ...
  Если на половину вопросов ответ уверенный — вернитесь к [сценарию](/encyclopedia/8-infra-security/8-08-praktikum-rest-i-websocket/1) и [контракту](/encyclopedia/8-infra-security/8-08-praktikum-rest-i-websocket/2). Итоги и FAQ по сбоям — [Практикум REST и WebSocket — итоги](/encyclopedia/8-infra-security/8-08-praktikum-rest-i-websocket/998).
  </div>
</div>
