...
<div class="callout callout--tip">
  ...
  Двенадцать практик «с чего начать» — HTTPS, OAuth, rate limit, gateway, валидация и др. — собраны в [12 советов по безопасности API](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/132).

  Ниже в этой статье — каталог угроз и разбор типичных промахов.
  </div>
</div>

Общая база: [безопасность приложений](./113.md). Интеграционная авторизация и практика Basic, Bearer, mTLS — [8.05.1121](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/1121), [8.05.134](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/134).
...
Защита строится на: **аутентификация**, **авторизация на каждый ресурс**, **валидация входа**, **лимиты**, **наблюдаемость**. Виды проверок входных данных — [Проверка и валидация](/encyclopedia/4-code-dev/4-14-razrabotka-i-otladka/118).
...
- [Интеграции — Basic, Bearer и mTLS на практике](/encyclopedia/8-infra-security/8-05-mikroservisy-i-integratsiya/134)
