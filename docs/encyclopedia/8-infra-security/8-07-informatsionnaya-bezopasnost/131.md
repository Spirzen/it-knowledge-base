...
Ботнет **Mirai** ([Вирусы и вредоносные программы](/encyclopedia/8-infra-security/8-07-informatsionnaya-bezopasnost/119)) показал масштаб: тысячи устройств с `admin:admin` → DDoS на DNS-провайдера. Вендоры часто **переоценивают** "безопасность" устройств, пока на [IoT Village](https://www.iotvillage.org/) и meetup'ах те же модели ломают за часы.
...
- **Secure SDLC** — threat modeling, code review, fuzzing; см. [Безопасность на ранних этапах разработки](/encyclopedia/8-infra-security/8-07-informatsionnaya-bezopasnost/1132).
