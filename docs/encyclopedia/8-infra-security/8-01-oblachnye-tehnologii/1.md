...
<div class="callout callout--warning">
  ...
  <div class="callout-body">
  <p>Публичный bucket "для теста" часто находят боты за часы. Делайте доступ через CDN или политику только для CloudFront. Исходящий трафик CDN (egress) тоже тарифицируется — см. <a href="/encyclopedia/8-infra-security/8-01-oblachnye-tehnologii/12">главу про OpEx</a>.</p>
</div>
  </div>
