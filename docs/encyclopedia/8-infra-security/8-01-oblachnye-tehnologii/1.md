...
![image.png](https://assets.spirzen.ru/encyclopedia/8-infra-security/8-01-oblachnye-tehnologii/image.png)
...
![image-1.png](https://assets.spirzen.ru/encyclopedia/8-infra-security/8-01-oblachnye-tehnologii/image-1.png)

- **PaaS** — квартира с отделкой: завозите мебель (код), стены и коммуникации уже есть.

![image-2.png](https://assets.spirzen.ru/encyclopedia/8-infra-security/8-01-oblachnye-tehnologii/image-2.png)

- **SaaS** — отель: заехали и пользуетесь сервисом.

![image-3.png](https://assets.spirzen.ru/encyclopedia/8-infra-security/8-01-oblachnye-tehnologii/image-3.png)
...
<ExternalCodeEmbed example="python/infra-security-8-8-01-oblachnye-tehnologii-1-001" title="Пример — тот же смысл из Python (boto3)" minHeight={408} />
...
Ниже — **опорные имена**, с которыми сравнивают вакансии и архитектуру. Подробнее про экосистемы компаний — в [1.04 "Как видят IT"](/encyclopedia/1-basics/1-04-kak-vidyat-it-obychnye-lyudi/711).
...
**DevOps и инфраструктура** — [Платформы — о разделе](/encyclopedia/2-system-network/2-02-platformy/intro), [Основы DevOps](/encyclopedia/8-infra-security/8-04-devops-ci-cd/1), [Архитектура персонального компьютера](/encyclopedia/1-basics/1-08-kak-rabotaet-kompyuter/7), [Терминал — о разделе](/encyclopedia/2-system-network/2-05-terminal/intro), [Системное администрирование — о разделе](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/intro), [Основы информационной безопасности — о разделе](/encyclopedia/2-system-network/2-08-osnovy-informatsionnoy-bezopasnosti/intro).
