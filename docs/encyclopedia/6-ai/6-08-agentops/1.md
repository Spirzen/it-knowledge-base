...
| Слой | Архитектурный вопрос ([119](/encyclopedia/6-ai/6-05-razrabotka-ii/119)) | Вопрос AgentOps |
|------|------------------------------------------------------------------------|-----------------|
...
Паттерны — [2152](/encyclopedia/8-infra-security/8-04-devops-ci-cd/2152):
...
Три слоя приложения (RAG / MCP / agent) — [121](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/121). AgentOps накладывает **политики** на каждый.
...
Слой 5 в [119](/encyclopedia/6-ai/6-05-razrabotka-ii/119) — streaming, cache, autoscaling. AgentOps добавляет **экономику и надёжность** agent run, где один user request = **десятки** LLM calls.
