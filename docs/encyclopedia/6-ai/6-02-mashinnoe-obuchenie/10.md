...
**Scikit-learn** — стандартная библиотека для **табличного** машинного обучения на Python: регрессия, классификация, кластеризация, предобработка и оценка моделей в едином API. Для изображений, длинных текстов и больших нейросетей обычно переходят к TensorFlow или PyTorch — см. [Keras и TensorFlow](/encyclopedia/6-ai/6-03-neyroseti/114). Обзор всех типов обучения — в [Машинное обучение](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/1); практический end-to-end пример — [проект Melbourne](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/7).
