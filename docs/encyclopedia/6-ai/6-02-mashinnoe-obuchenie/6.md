...
Это главная причина оборачивать предобработку и модель в один `Pipeline` — см. [4.md](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/4) и [7.md](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/7).
...
1. Очистка завершена ([4.md](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/4)).
