...
Параметры генерации (temperature, structured output) — [118](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/118). Готовые шаблоны с построчным разбором — [Prompt engineering — библиотека](/lab/Примеры/1150).
