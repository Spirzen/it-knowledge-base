...
description: "Подборка про вайб-кодинг, практический AI-стек, нейрослоп и ответственное использование ИИ при разработке и в контенте."
sidebar_label: "Вайб-кодинг и нейроконтент — о разделе"
related:
  - title: "Вайб-кодинг"
...
Здесь собраны материалы о **культуре, рисках и практике** ИИ в разработке: когда помощь модели ускоряет работу, а когда превращается в [вайб-кодинг](./1) или [нейрослоп](./2) — однотипный код и контент без смысла и ответственности. Практика — **сборка продуктов** на Lovable, Supabase, Cursor, n8n и ChatGPT ([Практический AI-стек — Lovable, Supabase, Cursor, n8n и ChatGPT](./3)), **Claude Code** как агент в терминале и браузере ([Claude Code — установка, контекст и практический проект](./4)) и **ZCode** с моделью GLM-5.2 ([ZCode и GLM-5.2 — IDE-агент, длинный контекст и вайб-кодинг](./6)).

| Статья | О чём |
|--------|--------|
| [Вайб-кодинг](./1) | Вайб-кодинг — термин, спектр практик, инструменты, риски для навыков и продакшена |
| [Мультимодальный ИИ](./5) | Мультимодальный ИИ — режимы, распознавание медиа, генерация изображений, видео и аудио, топ нейросетей |
