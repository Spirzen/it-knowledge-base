...
**Песочница** — не паранойя, а условие использования агентов в разумных границах. Docker, отдельный пользователь, allow-list команд и HITL снижают риск OWASP **LLM06** и последствий промпт-инъекции. MCP и RAG — [глава 3](./3); тесты атак — [Red team](./6).
