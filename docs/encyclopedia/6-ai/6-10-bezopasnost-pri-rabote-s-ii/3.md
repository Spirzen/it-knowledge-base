...
RAG и MCP — **границы доверия**. Относитесь к каждому документу в индексе и каждому MCP-tool как к **входу от неавторизованного пользователя**. Детали по агентам и sandbox — [Песочница и права](./4); supply chain пакетов — [Slopsquatting](./7).
