...
<ExternalPlayEmbed example="ai/prompt-injection-lab-play" title="Лаборатория prompt injection" minHeight={520} />
...
**Критерий прохождения** — **отсутствие запрещённого поведения** (утечка, tool call, PII в ответе).
...
**Red team для LLM** — **регрессионный набор** в CI плюс периодический ручной прогон. Свяжите security eval с [MLOps/AgentOps](/encyclopedia/6-ai/6-08-agentops/intro) — тот же pipeline, что quality eval, но с запретными исходами. RAG/MCP сценарии — [глава 3](./3).
