...
4. [Нейрон](/encyclopedia/6-ai/6-03-neyroseti/1) — веса, слои; затем [перцептрон на NumPy](/encyclopedia/6-ai/6-03-neyroseti/2) — первое обучение в коде; [распознавание лиц, объектов и текста](/encyclopedia/6-ai/6-06-primenenie-ii/120).
...
7. [Генерация кода — ChatGPT, Gemini, DeepSeek](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/117) — практика для разработчика.
