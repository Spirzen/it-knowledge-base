...
description: Введение в современный искусственный интеллект - статистические модели, обучающие данные, архитектуры нейросетей, реальные возможности и технические ограничения.
...
**Математика → NumPy → DL (рекомендуется перед нейросетями):** [341 — виды мат. наук](/encyclopedia/3-data-markup/3-03-myslitelnaya-baza/341) → [34 — LA](/encyclopedia/3-data-markup/3-03-myslitelnaya-baza/34) → [342 — векторы](/encyclopedia/3-data-markup/3-03-myslitelnaya-baza/342) → [343 — матрицы](/encyclopedia/3-data-markup/3-03-myslitelnaya-baza/343) → [337 — NumPy](/encyclopedia/5-languages/5-02-python/337) + [Lab 1129](/lab/Примеры/1129) → [33 — pandas](/encyclopedia/5-languages/5-02-python/33) → [319 — Matplotlib](/encyclopedia/5-languages/5-02-python/319).
...
4. [Нейрон](/encyclopedia/6-ai/6-03-neyroseti/1) — веса, слои, функции активации; [перцептрон на NumPy](/encyclopedia/6-ai/6-03-neyroseti/2) (ступенчатый персептрон, ландшафт MSE, градиентный спуск); [архитектуры Dense/CNN/LSTM](/encyclopedia/6-ai/6-03-neyroseti/113); [Keras и TensorFlow](/encyclopedia/6-ai/6-03-neyroseti/114) (MNIST 6×6, CIFAR-10, Fashion MNIST, TensorBoard, Colab) или [практикум MNIST на PyTorch](/encyclopedia/5-languages/5-02-python/335); табличный ML — [Lab 1157 Titanic](/lab/Примеры/1157), [Lab 1158 spam](/lab/Примеры/1158); подготовка таблиц — [Lab 1148](/lab/Примеры/1148); маршрут «курс ML» — [6-02/21](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/21); сквозные DL-проекты — [практикум в Colab](/encyclopedia/6-ai/6-05-razrabotka-ii/122#vetka-dl--glubokoe-obuchenie-v-colab); [распознавание лиц, объектов и текста](/encyclopedia/6-ai/6-06-primenenie-ii/120).
...
6. [Большие языковые модели](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/1) — LLM, цепочка "текст → токены → эмбеддинги", инференс; [Reasoning-модели](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/123), [российские нейросети](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/124), [выбор модели](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/125), [стоимость](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/126); локальный тюнинг скорости — [Оптимизация локального инференса LLM](/encyclopedia/6-ai/6-05-razrabotka-ii/127); затем [RAG, MCP и агенты — три слоя](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/121), [типы интеллектуальных агентов](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/120), [агенты ИИ](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/116) и [MCP-серверы](/encyclopedia/6-ai/6-04-modeli-i-instrumenty/114) (связь с [классическим API](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/117)).
