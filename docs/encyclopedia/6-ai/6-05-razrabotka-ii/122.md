...
|------------------------|-------|-----------------------------|
| [114 — MNIST, CNN](/encyclopedia/6-ai/6-03-neyroseti/114) | `Conv2D`, compile, fit, callbacks | Ноутбук: MNIST или CIFAR-10 на Keras; кривые loss/accuracy через matplotlib или TensorBoard |
| [335 — практикум PyTorch](/encyclopedia/5-languages/5-02-python/335) | CNN end-to-end, сохранение весов | Локальный [TestPyTorch](/encyclopedia/5-languages/5-02-python/335) или порт архитектуры в Colab |
| [113 — CNN](/encyclopedia/6-ai/6-03-neyroseti/113) + [120 — лица](/encyclopedia/6-ai/6-06-primenenie-ii/120) | Классификация изображений, метрики | Датасет **FER2013** или **CK+**: grayscale 48×48, 7 классов эмоций; CNN + `ImageDataGenerator` только на train |
| [113 — LSTM](/encyclopedia/6-ai/6-03-neyroseti/113) + [ML — пример 2](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/1) | Последовательности, char-level RNN | Корпус текста (например "Война и мир" с [Project Gutenberg](https://www.gutenberg.org/)): посимвольная LSTM, генерация по seed-строке |
| [6 — разбиение выборки](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/6) + [8 — переобучение](/encyclopedia/6-ai/6-02-mashinnoe-obuchenie/8) | train/val/test, EarlyStopping | В каждом ноутбуке: hold-out test не трогать до финала; validation — для callbacks |
...
1. [114 — Keras, callbacks, TensorBoard](/encyclopedia/6-ai/6-03-neyroseti/114) → MNIST/CIFAR в Colab
2. [335 — CNN локально](/encyclopedia/5-languages/5-02-python/335) или тот же пайплайн в PyTorch в Colab
