...
<div class="callout callout--tip">
  ...
  Если вы впервые вызываете Chat Completions из Python — начните с <a href="/lab/Примеры/1149">OpenAI / API — готовые промпты и вызовы</a>: там <code>chat.completions.create</code>, <code>messages</code>, curl и построчный разбор. Текст для полей <code>messages</code> — <a href="/lab/Примеры/1150">Prompt engineering — библиотека промптов</a>. Эта глава — следующий уровень: адаптеры, retry, очереди и prod.
</div>
</div>
