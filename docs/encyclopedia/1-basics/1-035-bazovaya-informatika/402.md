...
Путь `/mnt/d/` — диск `D:` Windows. Скрипты из WSL удобно вызывать из [Task Scheduler](/encyclopedia/1-basics/1-035-bazovaya-informatika/402): `wsl.exe -e bash /home/user/backup.sh`.
...
**Следующий шаг по карте:** [виртуальные машины и Home Lab](/encyclopedia/1-basics/1-035-bazovaya-informatika/403) — место, где скрипты разворачивают сервисы без риска для основной системы.
