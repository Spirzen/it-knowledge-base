...
На работе ошибки смотрят в централизованных логах. Дома — файл лога приложения, Event Viewer, `journalctl`. Продвинутый уровень — [мониторинг и логи](/encyclopedia/1-basics/1-035-bazovaya-informatika/403).
...
- [Мониторинг и логи](/encyclopedia/1-basics/1-035-bazovaya-informatika/403)
