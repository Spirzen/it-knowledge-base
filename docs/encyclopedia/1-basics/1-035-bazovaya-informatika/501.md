...
related:
  - title: Путь продвинутого
    doc: /encyclopedia/1-basics/1-035-bazovaya-informatika/401
  - title: Автоматизация
    doc: /encyclopedia/1-basics/1-035-bazovaya-informatika/506
  - title: PowerToys
    doc: /encyclopedia/1-basics/1-035-bazovaya-informatika/509
---
...
| Слой | Примеры | Глава |
| :--- | :--- | :--- |
| Ускорение Windows | [PowerToys](/encyclopedia/1-basics/1-035-bazovaya-informatika/509), AutoHotkey | [PowerToys и дополнительные утилиты](/encyclopedia/1-basics/1-035-bazovaya-informatika/509), [Автоматизация — AutoHotkey, PowerShell и планировщик](/encyclopedia/1-basics/1-035-bazovaya-informatika/506) |
| Файлы | Total Commander, 7-Zip, Everything | [Файловые менеджеры и системные утилиты](/encyclopedia/1-basics/1-035-bazovaya-informatika/502) |
| Код и конфиги | VS Code, Vim, Notepad++ | [Редакторы кода — VS Code, Vim, Notepad++](/encyclopedia/1-basics/1-035-bazovaya-informatika/503) |
| Виртуализация | VirtualBox, WSL, Proxmox | [Виртуализация и управление операционными системами](/encyclopedia/1-basics/1-035-bazovaya-informatika/508) |
| Сеть | Wireshark, PuTTY, WinMTR | [Сетевые и системные диагностические утилиты](/encyclopedia/1-basics/1-035-bazovaya-informatika/505) |
| Безопасность | Sysinternals, VeraCrypt | [Безопасность и системное администрирование](/encyclopedia/1-basics/1-035-bazovaya-informatika/507) |

Зачем каждый слой в жизни — в [советах продвинутому (401+)](/encyclopedia/1-basics/1-035-bazovaya-informatika/401).

---

## Минимальный набор "с первого дня"

1. **[Microsoft PowerToys](https://learn.microsoft.com/windows/powertoys/)** — Run, FancyZones, переименование ([подробнее](/encyclopedia/1-basics/1-035-bazovaya-informatika/509)).
...
6. **VirtualBox** или **Hyper-V** — [эксперименты в ВМ](/encyclopedia/1-basics/1-035-bazovaya-informatika/403).
7. **Менеджер паролей** (Bitwarden + при желании свой [Vaultwarden](/encyclopedia/1-basics/1-035-bazovaya-informatika/404)).
...
Софт без скриптов — только половина power user; см. [Скрипты и автоматизация](/encyclopedia/1-basics/1-035-bazovaya-informatika/402).
...
4. Для экспериментов — отдельная [ВМ](/encyclopedia/1-basics/1-035-bazovaya-informatika/508), не рабочая система.
...
Docker, PuTTY, Wireshark, VirtualBox на рабочем ПК + Debian/Proxmox на железе. Vaultwarden, Nextcloud — в [советах](/encyclopedia/1-basics/1-035-bazovaya-informatika/404).
...
Дальше — по категориям в оглавлении раздела или по [дорожной карте советов](/encyclopedia/1-basics/1-035-bazovaya-informatika/401).
