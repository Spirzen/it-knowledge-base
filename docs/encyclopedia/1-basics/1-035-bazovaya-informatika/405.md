...
| 3 | Глобальные хоткеи в [AutoHotkey](/encyclopedia/1-basics/1-035-bazovaya-informatika/506), [PowerToys](#microsoft-powertoys) (см. ниже) |
...
Почему не стандартный Блокнот — нет нормального поиска по проекту, Git, подсветки, множественных курсоров, встроенного терминала. Для power user текст = **данные**, с ними работают как с кодом. Способы поиска по файлам и папкам — [поиск текста в файлах](/encyclopedia/2-system-network/2-05-terminal/104).

Подробное сравнение и IDE — [Софт: разработка](/encyclopedia/4-code-dev/4-011-instrumenty-razrabotki/503). Путь в программирование — [Код и разработка](/encyclopedia/4-code-dev/code-dev).
...
- встроенный терминал ``Ctrl+` `` для [скриптов](/encyclopedia/4-code-dev/4-011-instrumenty-razrabotki/402).
...
Список и альтернативы — в [PowerToys и утилиты рабочей станции](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/11).
...
Сохраняйте профили экспорта в Git вместе с [dotfiles](/encyclopedia/4-code-dev/4-011-instrumenty-razrabotki/402).
...
- **одна** главная ОС на работу, эксперименты — в [ВМ](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/10);
- шаблоны папок (`Projects/2025/client-name`);
- синхронизация только нужного (не весь диск в облако);
- закрытие вкладок и отключение лишней автозагрузки — см. [процессы Windows](/encyclopedia/1-basics/1-035-bazovaya-informatika/406).
...
**Дальше:** [анализ процессов и кэшей Windows](/encyclopedia/1-basics/1-035-bazovaya-informatika/406).
