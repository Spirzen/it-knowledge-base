...
- проще связать с [макросами](/encyclopedia/1-basics/1-035-bazovaya-informatika/402).
...
Подробное сравнение и IDE — [Софт: разработка](/encyclopedia/1-basics/1-035-bazovaya-informatika/503). Путь в программирование — [Код и разработка](/encyclopedia/4-code-dev/code-dev).
...
- встроенный терминал ``Ctrl+` `` для [скриптов](/encyclopedia/1-basics/1-035-bazovaya-informatika/402).
...
Список и альтернативы — в [дополнительных инструментах](/encyclopedia/1-basics/1-035-bazovaya-informatika/509).
...
Сохраняйте профили экспорта в Git вместе с [dotfiles](/encyclopedia/1-basics/1-035-bazovaya-informatika/402).
...
- **одна** главная ОС на работу, эксперименты — в [ВМ](/encyclopedia/1-basics/1-035-bazovaya-informatika/403);
