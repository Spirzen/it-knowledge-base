...
| Данные из веба | — | [Парсинг на Python](/encyclopedia/5-languages/5-02-python/316) · [BeautifulSoup](/encyclopedia/5-languages/5-02-python/317) |
...
|------------|------------|------|-----------|
| **BeautifulSoup** | Парсинг HTML после загрузки страницы | Python, старшие классы, автоматизация | [BeautifulSoup](/encyclopedia/5-languages/5-02-python/317.md) |
| **pyTelegramBot** (`telebot`) | Telegram-боты на Python | Кружки, хобби, простые боты | [Telegram-боты](/encyclopedia/5-languages/5-02-python/3434.md) |
...
Подробнее — [BeautifulSoup](/encyclopedia/5-languages/5-02-python/317).
...
Подробнее — [Telegram-боты](/encyclopedia/5-languages/5-02-python/3434).
