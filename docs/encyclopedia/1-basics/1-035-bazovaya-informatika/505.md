...
<div class="callout callout--tip">
  ...
  Теория протоколов — в [разделе "Сеть"](/encyclopedia/2-system-network/2-03-set-i-internet/intro); практика VPN — в [self-hosting](/encyclopedia/1-basics/1-035-bazovaya-informatika/404).
</div>
  </div>
...
Установка CLI-утилит на Windows: `winget` (см. [1.035 / 501](/encyclopedia/1-basics/1-035-bazovaya-informatika/501)), на Linux — `apt` / `dnf`.
...
Для главы про **диагностику** достаточно знать, откуда ставить CLI. Подробнее про `winget` и воспроизводимый стек — в [обзоре раздела](/encyclopedia/1-basics/1-035-bazovaya-informatika/501).
