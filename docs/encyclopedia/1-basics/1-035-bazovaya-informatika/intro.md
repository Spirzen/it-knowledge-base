...
<div class="callout callout--tip">
  ...
  Совсем с нуля — начните с [Основы компьютерной грамотности](/encyclopedia/1-basics/1-035-bazovaya-informatika/101), затем [Цифровая безопасность](/encyclopedia/1-basics/1-035-bazovaya-informatika/112) и [Терминология новичка](/encyclopedia/1-basics/1-035-bazovaya-informatika/102). Затем идите по главам **1 → 8** подряд или выборочно по таблице ниже. После [Компьютер, периферия и сетевое оборудование](/encyclopedia/1-basics/1-035-bazovaya-informatika/3) удобно углубиться в [Память и вычисления](/encyclopedia/1-basics/1-035-bazovaya-informatika/11). Глава **9** — справочник по средам (Godot, Flutter, BeautifulSoup и др.), её можно открывать по мере необходимости. **112–113** — безопасность и passkeys (можно после главы 6).
