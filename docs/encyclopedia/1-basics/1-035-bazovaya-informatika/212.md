...
Android использует ядро Linux. Команды `adb` для отладки телефона работают с Linux и WSL. См. [Android](/encyclopedia/1-basics/1-035-bazovaya-informatika/213).

**Где учить терминал дальше?**

[Терминал — раздел](/encyclopedia/2-system-network/2-05-terminal/intro), [запуск приложений](/encyclopedia/1-basics/1-035-bazovaya-informatika/208).
...
Терминал macOS близок к Linux — многие команды те же. См. [macOS](/encyclopedia/1-basics/1-035-bazovaya-informatika/211). Homebrew заменяет apt для софта.
