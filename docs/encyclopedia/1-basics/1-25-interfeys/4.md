...
description: "%%{init: { \"theme\": \"default\", \"themeVariables\": { \"fontSize\": \"14px\", \"fontFamily\": \"Segoe UI, Tahoma, sans-serif\" } }}%% flowchart TD classDef group."
  вспомогательных блоков в удобстве работы и доступности функций.
---

import UiNavigationElementsDemo from '@site/src/components/UiNavigationElementsDemo';
