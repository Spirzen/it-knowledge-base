...
На домашнем ПК чаще **тип 2**. **Контейнер Docker** делит ядро хоста — легче ВМ, но слабее изоляция. Сомнительное ПО — в **ВМ**; привычные сервисы — в **контейнерах** на отдельном Linux-хосте.
