...
| **Bash** | Linux, macOS, [WSL](https://learn.microsoft.com/windows/wsl/) | Серверы, деплой, cron, пайплайны в терминале — [галерея с разбором](/lab/Примеры/1151) |
...
- есть WSL или Home Lab на Linux — [Bash](/encyclopedia/5-languages/5-25-bash/112), практика — [однострочники и скрипты](/lab/Примеры/1151);
...
Тот же смысл на Bash — [архив с датой](/lab/Примеры/1151#bash-tar-backup) в галерее Lab и [рекомендации по cron](/encyclopedia/5-languages/5-25-bash/11).
...
<div class="callout callout--warning">
  <div class="callout-title">Стоп-лист перед автоматизацией</div>

  <div class="callout-body">
  <p>Скрипты PowerShell/Bash и команды от ИИ-агента в IDE работают с вашими правами. <code>robocopy /MIR</code>, <code>rm -rf</code>, <code>git reset --hard</code> — <a href="/encyclopedia/8-infra-security/8-03-zabota-o-kode-i-dannyh/101">Опасные скрипты</a>.</p>
</div>
  </div>
...
| Команда из чата / от агента без чтения | Снесённый диск или Git | [Опасные скрипты](/encyclopedia/8-infra-security/8-03-zabota-o-kode-i-dannyh/101) |
