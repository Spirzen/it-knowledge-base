...
description: >-
  Traceback, коды ошибок Windows и браузера — что скопировать в поиск,
  как найти причину и когда ошибка указывает на код или окружение.
related:
...
| **0x80070070** | Нет места | Очистка диска, [диспетчер задач](/encyclopedia/1-basics/1-11-soft-ryadovogo-polzovatelya/1) |
...
Зависание UI, не всегда есть traceback. Диспетчер задач → снять дамп или завершить процесс. См. [запуск приложений](/encyclopedia/1-basics/1-12-sovety-dlya-novichka/13).
...
На работе ошибки смотрят в централизованных логах. Дома — файл лога приложения, Event Viewer, `journalctl`. Продвинутый уровень — [мониторинг и логи](/encyclopedia/1-basics/1-14-sovety-dlya-prodvinutogo/3).
...
- [Мониторинг и логи](/encyclopedia/1-basics/1-14-sovety-dlya-prodvinutogo/3)
