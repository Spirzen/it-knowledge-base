...
description: "Подборка материалов раздела Коммуникация и общение в энциклопедии Вселенная IT."
sidebar_label: Коммуникация и общение — о разделе
related:
  - title: "Поиск информации"
    doc: encyclopedia/1-basics/1-21-poisk-informatsii/intro
...
| Термин | Кратко |
|--------|--------|
| **MUA / MTA / MDA** | клиент почты / сервер пересылки / доставка в ящик |
| **Envelope sender** | адрес в `MAIL FROM` (для SPF и bounce), не всегда = `From:` в письме |
| **E2EE** | сквозное шифрование содержимого (Signal, секретные чаты и т.д.) |
| **RACI** | кто делает, кто отвечает, кого спрашивают, кого информируют |
| **Action item** | конкретное действие после встречи: кто, что, до когда |
