...
|--------------------|------------------------------|----------------------|----------------------|
| **Разработчик** | Код, отладка, API, фреймворки | [4. Код](/encyclopedia/4-code-dev/4-01-algoritmy/1), [5. Языки](/encyclopedia/5-languages/intro), [2.04 Веб](/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/1) | C#, ASP.NET Core, Playwright |
...
| **Бизнес-пользователь** | Office, Copilot без кода | [1.035 / 310 — M365](/encyclopedia/1-basics/1-035-bazovaya-informatika/310), [6.06 Применение ИИ](/encyclopedia/6-ai/6-06-primenenie-ii/3) | M365, Copilot в задачах |
...
**Стек Microsoft** здесь — ситуация, когда работодатель или учебное заведение явно опирается на Azure, Active Directory / Entra, .NET или M365. В остальных случаях Learn остаётся полезным для **универсальных** тем (Git, ИИ-основы, облачные модели), но не заменяет документацию вашего стека.
