...
Программа реализует [алгоритм](/glossary/А#алгоритм) — упорядоченные шаги решения задачи. Сами алгоритмы и приёмы программирования разбираются в следующих томах; здесь фокус на **исполнении**, **типах ПО** и **взаимодействии с системой**.
...
**Углубление (не обязательно с первого прохода):** [Компиляторы и интерпретаторы](/encyclopedia/1-basics/1-19-programma/2) — полный конвейер компиляции, байт-код, JIT.
