...
0. [Базовая информатика — банки данных](/encyclopedia/1-basics/1-035-bazovaya-informatika/1#поиск-и-хранение-информации) — БД, СУБД, модели, запросы, маски файлов (школьный минимум);
