...
<div class="callout callout--tip">
  ...
  Теория протоколов — в [разделе "Сеть"](/encyclopedia/2-system-network/2-03-set-i-internet/intro); практика VPN — в [self-hosting](/encyclopedia/1-basics/1-14-sovety-dlya-prodvinutogo/4).
</div>
  </div>
