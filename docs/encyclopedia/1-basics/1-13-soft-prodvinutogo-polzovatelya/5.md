...
<div class="callout callout--tip">
  ...
  Домашний сервер, WireGuard и "почему не открывается сайт" требуют тех же утилит, что и у разработчика. Теория протоколов — в <a href="/encyclopedia/2-system-network/2-03-set-i-internet/intro">разделе "Сеть"</a>; практика VPN — в <a href="/encyclopedia/1-basics/1-14-sovety-dlya-prodvinutogo/4">self-hosting</a>.
</div>
  </div>
...
Установка CLI-утилит на Windows: `winget` (см. [обзор стека](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/1)), на Linux — `apt` / `dnf`.
...
## Установка сетевых утилит (кратко)

Для главы про **диагностику** достаточно знать, откуда ставить CLI. Подробнее про `winget` и воспроизводимый стек — в [обзоре раздела](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/1).
