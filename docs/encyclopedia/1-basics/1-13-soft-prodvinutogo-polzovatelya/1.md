...
<div class="callout callout--tip">
  ...
  Установка принтеров, сводные таблицы Excel и "как скачать с официального сайта" — в [софте рядового пользователя](/encyclopedia/1-basics/1-11-soft-ryadovogo-polzovatelya/intro) и [советах для новичка](/encyclopedia/1-basics/1-12-sovety-dlya-novichka/intro).
...
| Слой | Примеры | Глава |
| :--- | :--- | :--- |
| Ускорение Windows | [PowerToys](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/9), AutoHotkey | [PowerToys и дополнительные утилиты](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/9), [Автоматизация — AutoHotkey, PowerShell и планировщик](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/6) |
| Файлы | Total Commander, 7-Zip, Everything | [Файловые менеджеры и системные утилиты](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/2) |
| Код и конфиги | VS Code, Vim, Notepad++ | [Редакторы кода — VS Code, Vim, Notepad++](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/3) |
| Виртуализация | VirtualBox, WSL, Proxmox | [Виртуализация и управление операционными системами](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/8) |
| Сеть | Wireshark, PuTTY, WinMTR | [Сетевые и системные диагностические утилиты](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/5) |
| Безопасность | Sysinternals, VeraCrypt | [Безопасность и системное администрирование](/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/7) |
