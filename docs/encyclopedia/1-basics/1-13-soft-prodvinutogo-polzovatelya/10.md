...
<div class="callout callout--tip">
  <div class="callout-title">Краткий обзор в другой главе</div>

  <div class="callout-body">
  diagrams.net упоминается в контексте графики и Visio в главе <a href="/encyclopedia/1-basics/1-13-soft-prodvinutogo-polzovatelya/4">"Графика, дизайн и 3D"</a>. Здесь — полное руководство: архитектура, практика работы и XML-схема файлов.
</div>
  </div>


<SchemaMakerPlay defaultDocName="Архитектура" title="Схемы в браузере" subtitle="Альтернатива Draw.io для быстрых блок-схем — экспорт PNG/PDF" />
...
### Живой пример — `it-universe-architecture.drawio`

В репозитории [it-knowledge-base](https://github.com/Spirzen/it-knowledge-base) лежит сводная схема всего сайта: контекст C4, папки, пайплайн сборки, runtime и деплой. Исходник — `info/it-universe-architecture.drawio`; для статей экспортируется PNG (`static/img/it-universe-architecture.png`). Заготовку drawio можно пересобрать скриптом `node scripts/generate-architecture-drawio.mjs`. Подробная легенда — [О проекте → архитектура](/about/project#arhitektura-proekta); те же потоки в Mermaid — [контекст](/about/project#it-universe-c4-mermaid) и [сборка](/about/project#it-universe-build-mermaid).

![Архитектура «Вселенная IT» — drawio-модель, экспортированная в PNG](/img/it-universe-architecture.png)
