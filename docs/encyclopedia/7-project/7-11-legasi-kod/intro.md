...
Здесь — **работа с существующим кодом и знаниями о нём**. Детали CI/CD, облачной миграции БД, контейнеризации и кибербезопасности затронуты только там, где они связаны с легаси; углублённо эти темы живут в главах про тестирование, инфраструктуру и архитектуру. Паттерн Strangler Fig разобран и в [отдельной статье по архитектуре](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/2125) — мы на него опираемся, не дублируем учебник целиком.
