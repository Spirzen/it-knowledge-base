...
description: "SOLID описывает свойства классов. GRASP (General Responsibility Assignment Software Patterns) отвечает на вопрос: кому поручить эту обязанность?"
  Action–Domain–Responder для HTTP-приложений.
---
