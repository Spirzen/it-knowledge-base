...
description: >-
  Навигационный маршрут по разделу системного проектирования программного обеспечения с последовательным изучением нефункциональных требований, архитектуры API, баз данных, распределённых систем и методов оценки альтернатив.
