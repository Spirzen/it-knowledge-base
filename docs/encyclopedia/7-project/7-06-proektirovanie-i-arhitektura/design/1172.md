...
| Глава | Фокус |
|-------|--------|
| [117](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/117) | REST, контракт, партнёрский API заказов, HMAC-ошибки |
| [1171](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/1171) | Публичный API, OAuth 2.0, webhooks с shared secret |
...
Подробнее про сертификаты: [8.07.112](/encyclopedia/8-infra-security/8-07-informatsionnaya-bezopasnost/112). HMAC из [1171](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/1171) проще, но у крупных партнёров часто требуют **асимметрию** (платформа подписывает приватным ключом, банк проверяет публичным).
...
Ответ `403` без валидного клиентского сертификата — ожидаемое поведение; тело ошибки в том же формате, что в [117](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/117).
...
| `X-Webhook-Id` | `evt_01JABC123` (идемпотентность — [213](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/213)) |
...
Партнёр по-прежнему отвечает **`2xx` за секунды**, тяжёлую обработку кладёт во внутреннюю очередь — как в [1171](/encyclopedia/7-project/7-06-proektirovanie-i-arhitektura/design/1171).
