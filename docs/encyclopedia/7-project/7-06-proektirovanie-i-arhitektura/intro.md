...
2. **[System Design — карта тем и подготовка](143.md)** — порядок изучения (сети → БД → кэш → [очереди](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/121)), пять рычагов, типовой контур, классические задачи, postmortem. Синтез по асинхронной обработке — [асинхронная обработка в высоконагруженных системах](145.md); для "ложного CRUD" — [email-рассылка как распределённая система](144.md); для ручной диагностики API-контуров — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133), [curl / fetch — примеры](/lab/Примеры/1133).
2a. **[Основы развития информационных систем](/encyclopedia/8-infra-security/8-00-osnovy-infrastruktury/2)** — мост между архитектурой и эксплуатацией: как системы эволюционируют от MVP к кэшу, балансировке, репликации, шардингу, централизованному логированию и поэтапным миграциям.
...
- **[System Design — карта тем](143.md)** · **[12 концепций распределённой архитектуры](141.md)** · **[Асинхронная обработка в высоконагруженных системах](145.md)** · **[Email-рассылка как распределённая система](144.md)** — подготовка к собеседованию, очереди и воркеры, "ложный CRUD" рассылки, напоминалка перед микросервисами.
