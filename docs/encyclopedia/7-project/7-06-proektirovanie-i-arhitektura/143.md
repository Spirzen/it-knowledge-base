...
<div class="callout callout--tip">
  ...
  <p>Проверьте, что понимаете <strong>задержку и пропускную способность</strong> на уровне HTTP/TCP/DNS — <a href="/encyclopedia/2-system-network/2-03-set-i-internet/1#пропускная-способность-и-задержка">§ в основах сети</a>. Затем <a href="141.md">12 концепций</a> → <a href="design/1116.md">NFR в цифрах</a> → одна задача из <a href="#pyat-klassicheskih-zadach">классических задач design</a> с блок-схемой от клиента до БД (для «ложного CRUD» удобна <a href="144.md">email-рассылка</a>).</p>
</div>
  </div>
...
| 2 | **Базы данных** | Масштабирование — это прежде всего данные: индексы, репликация, партиционирование | [Опорные темы](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/12), [Основы БД](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/intro), [индексы и план](/encyclopedia/3-data-markup/3-05-osnovy-baz-dannyh/3), [репликация и шардинг](/encyclopedia/3-data-markup/3-08-upravlenie-rsubd/1) |
...
| **Надёжность** | Работа при сбоях узлов и зависимостей | Репликация, failover, бэкапы, circuit breaker, retry с лимитом | [инженерия устойчивости](design/2136.md), [SLA](design/2135.md), [РСУБД — репликация](/encyclopedia/3-data-markup/3-08-upravlenie-rsubd/1.md) |
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  <p>Девять типовых компонентов (gateway, registry, auth, БД, кэш, брокер, метрики, логи) — в <a href="design/118.md#prodakshn-stek">паттернах микросервисной архитектуры</a>. Их удобно накладывать на ответ system design после блок-схемы запроса.</p>
</div>
  </div>
