...
<div class="callout callout--tip">
  ...
  <p>В C# Command хорошо работает как контракт бизнес-действий и транспорт операции через слои. Для локальных коротких вызовов проще и дешевле остаются обычные методы.</p>
</div>
  </div>
