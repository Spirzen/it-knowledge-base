...
<ExternalPlayEmbed example="about/schema-maker-play" title="Эскиз Command" minHeight={560} playProps={{ defaultDocName: 'Command', title: 'Эскиз Command', subtitle: 'Invoker, Command и Receiver в одном каркасе' }} />
...
<ExternalPlayEmbed example="about/archi-styler-play" title="Command на диаграмме" minHeight={480} playProps={{ defaultPattern: 'command', title: 'Command на диаграмме', subtitle: 'Клиент, Invoker, Command, Receiver' }} />
...
<ExternalCodeEmbed example="csharp/project-7-7-06-proektirovanie-i-arhitektura-design-patterns-120-001" title="Классический вариант" minHeight={426} />
