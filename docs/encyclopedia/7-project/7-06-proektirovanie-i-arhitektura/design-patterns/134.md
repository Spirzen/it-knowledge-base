...
<ExternalPlayEmbed example="about/schema-maker-play" title="Эскиз Prototype" minHeight={560} playProps={{ defaultDocName: 'Prototype', title: 'Эскиз Prototype', subtitle: 'Прототип и клоны через общий контракт' }} />
...
<ExternalCodeEmbed example="java/project-7-7-06-proektirovanie-i-arhitektura-design-patterns-134-001" title="Пример — прототип отчета" minHeight={720} />
