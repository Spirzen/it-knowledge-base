...
В [порождающих паттернах](./111.md) разобраны **три уровня "фабрики"** — простая фабрика (приём, не паттерн GoF), фабричный метод и абстрактная фабрика. Здесь фокус на современном .NET: где классическая абстрактная фабрика даёт структуру, а где ту же задачу проще решает контейнер зависимостей.

<ExternalPlayEmbed example="about/schema-maker-play" title="Эскиз Abstract Factory" minHeight={560} playProps={{ defaultDocName: 'Abstract Factory', title: 'Эскиз Abstract Factory', subtitle: 'Семейства объектов и согласованные реализации' }} />
...
<ExternalCodeEmbed example="csharp/project-7-7-06-proektirovanie-i-arhitektura-design-patterns-119-001" title="Что делает Abstract Factory" minHeight={372} />
...
<ExternalPlayEmbed example="about/archi-styler-play" title="Abstract Factory на диаграмме" minHeight={480} playProps={{ defaultPattern: 'abstract-factory', title: 'Abstract Factory на диаграмме', subtitle: 'Factory, продукты и согласованное семейство' }} />
...
<ExternalCodeEmbed example="csharp/project-7-7-06-proektirovanie-i-arhitektura-design-patterns-119-002" title="Выбор реализации в рантайме" minHeight={372} />
...
<div class="callout callout--tip">
  ...
  <div class="callout-body">
  Для прикладных сервисов ASP.NET Core чаще хватает DI-конфигурации.

  Abstract Factory хорошо работает как инструмент архитектуры библиотек и платформенных слоёв с жёсткими семействами объектов.
</div>
  </div>
