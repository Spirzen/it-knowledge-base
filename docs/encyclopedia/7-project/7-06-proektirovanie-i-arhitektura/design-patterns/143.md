...
<ExternalPlayEmbed example="about/archi-styler-play" title="Связи MVC и Observer" minHeight={480} playProps={{ defaultPattern: 'observer', title: 'Связи MVC и Observer', subtitle: 'Модель оповещает представления при изменении состояния' }} />
...
- REST/BFF и путь HTTP-запроса — [2.04 Сайты](/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/intro), [REST API](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/117)
