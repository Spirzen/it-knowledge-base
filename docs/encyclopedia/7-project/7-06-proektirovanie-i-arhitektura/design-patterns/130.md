...
<div class="callout callout--tip">
  ...
  <p>В Java-проектах часто применяют Lombok <code>@Builder</code>, AutoValue или Immutables. Это ускоряет разработку, но не отменяет архитектурный выбор, когда Builder действительно нужен.</p>
</div>
  </div>
