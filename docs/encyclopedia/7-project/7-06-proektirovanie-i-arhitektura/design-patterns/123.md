...
<div class="callout callout--warning">
  ...
  <p>Для одноразового ленивого пайплайна чаще уместен <code>Stream</code> ([Stream API](/encyclopedia/5-languages/5-03-java/295)). Собственный <code>Iterator</code> оправдан, когда нужна совместимость с legacy-кодом, точный контроль страниц или обход вне стандартных коллекций.</p>
</div>
  </div>
