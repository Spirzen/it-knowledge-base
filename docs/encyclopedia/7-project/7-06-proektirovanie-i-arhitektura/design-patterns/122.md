...
<SchemaMakerPlay defaultDocName="Chain of Responsibility" title="Эскиз цепочки" subtitle="Handler, next и порядок прохождения запроса" />
...
<ArchiStylerPlay defaultPattern="layered" title="Обработчики на диаграмме" subtitle="Handler-классы и связь Uses к следующему звену" />
