...
<ExternalPlayEmbed example="about/schema-maker-play" title="Эскиз Observer" minHeight={560} playProps={{ defaultDocName: 'Observer', title: 'Эскиз Observer', subtitle: 'Publisher, Observer и поток уведомлений' }} />
...
<ExternalPlayEmbed example="about/archi-styler-play" title="Observer на диаграмме" minHeight={480} playProps={{ defaultPattern: 'observer', title: 'Observer на диаграмме', subtitle: 'Subject и subscribers без жёсткой связи' }} />
...
- события между сервисами — [pub/sub](/encyclopedia/2-system-network/2-09-osnovy-integratsionnogo-vzaimodeystviya/121)
