...
| 1b | [Agile — гибкая методология разработки](./3) | Манифест, словарь, чек-лист |
| 1c | [Как выбрать процесс под контекст](./4) | Stacey, Cynefin, Scrum/Kanban/Waterfall |
| 1d | [XP, TDD и BDD](./5) | Инженерные практики Agile |
| 1a | [Scrum — углублённо](/encyclopedia/7-project/7-14-scrum/intro) | История, спринт, потери, бэклог, внедрение |
| 1e | [Kanban — углублённо](/encyclopedia/7-project/7-18-kanban/intro) | Поток, WIP, метрики, поддержка |
