...
Каждый `if` — дополнительный путь в [графе потока управления](/encyclopedia/7-project/7-05-testirovanie/130). Цель не «запретить if», а **убрать несущественные** ветки:
...
Подробный указатель приёмов для условий — [13](./13).

Связь с Фаулером: *Replace Conditional with Polymorphism*, *Decompose Conditional* — [612](/encyclopedia/4-code-dev/4-02-chto-takoe-kod-i-kak-on-rabotaet/612).
