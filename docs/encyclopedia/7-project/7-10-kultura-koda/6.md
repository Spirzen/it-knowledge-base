...
description: "Анемичные модели в ООП - примитивная одержимость, Value Objects, доменные сущности, антипаттерны DTO и рефакторинг к богатой модели предметной области."
---
