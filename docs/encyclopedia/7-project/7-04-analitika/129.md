...
<div class="article-tags"><span class="tag tag-reference">СПРАВОЧНИК</span>
...
Крупный справочник по важнейшей системе моделирования. Ниже — интерактивный поиск по элементам и мини-редактор процесса; таблицы в статье дополняют справочник детальной семантикой.
