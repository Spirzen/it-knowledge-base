...
description: Навигационный маршрут по разделу контроля качества программного обеспечения с последовательным изучением основ, методов верификации интерфейсов, практик автоматизации и нагрузочного тестирования.
...
|-----|----------|-------|
| 0 | [Добро пожаловать в тестирование](./100) | Полный вход для новичка в QA, маршрут 2 недель |
