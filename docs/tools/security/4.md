---
title: Трафик
description: "Назначение: Графический анализатор сетевого трафика с поддержкой тысяч протоколов, декодированием, фильтрацией и экспортами."
slug: /tools/Безопасность/4
---
