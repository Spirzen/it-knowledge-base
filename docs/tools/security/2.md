---
title: Брандмауэры
description: Брандмауэр (firewall) — это программное или аппаратное средство, контролирующее входящий и исходящий сетевой трафик на основе заданных правил безопасности.
slug: /tools/Безопасность/2
---
# Брандмауэры
...
- **Управление**:  
  ...
  - Через PowerShell:  
    ...
    ```
- **Ссылка**: [Документация Microsoft](https://learn.microsoft.com/ru/windows/security/operating-system-security/network-security/windows-firewall/)
...
- **Ссылка**: [https://www.cisco.com/c/en/us/products/Безопасность/asa-firepower-services/index.html](https://www.cisco.com/c/en/us/products/Безопасность/asa-firepower-services/index.html)
...
- **Установка**:  
  - Виртуальная версия: через [Fortinet Developer Сеть](https://www.fortinet.com/support/fortinet-developer-Сеть) по запросу лицензии  
...
|----------------|------------------------|-------------|
| AWS            | **Безопасность Groups + NACLs** | Stateless (NACL) / Stateful (SG), L3/L4 |
| AWS            | **Сеть Firewall**   | Managed NGFW с Suricata-правилами |
...
- **Для облака**:  
  - Использовать native-инструменты провайдера; при необходимости — managed NGFW (AWS Сеть Firewall, Palo Alto VM-Series и др.)
...
- [OWASP — Сеть Access Control](https://owasp.org/www-community/controls/Network_Access_Control)
