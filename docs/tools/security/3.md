---
title: Шифрование
description: "Назначение: Реализация стандарта OpenPGP для асимметричного шифрования, цифровой подписи и управления ключами."
slug: /tools/Безопасность/3
...
**Документация**: [https://gnupg.org/Документация/](https://gnupg.org/Документация/)
