...
import GameEnginePickerPlay from '@site/src/components/GameEnginePickerPlay.jsx';
import GameEnginePlay from '@site/src/components/GameEnginePlay.jsx';
...
| [Unreal Engine](https://www.unrealengine.com/) | C++, Blueprints | AAA 3D | 5% после $1M выручки |
...
- **Установка**: [Epic Games Launcher](https://www.unrealengine.com/) (нужен аккаунт Epic). Исходники: [GitHub UnrealEngine](https://github.com/EpicGames/UnrealEngine) (привязка аккаунта). Linux — чаще сборка из исходников.
...
- [Инструменты для видеоигр](/tools/Игры/2) — OBS, Steam, Proton, моды.
- [Игровые магазины](/tools/Игры/3) — лаунчеры и облачный гейминг.
