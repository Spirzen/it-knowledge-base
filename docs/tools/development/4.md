...
import WebMetricsDemo from '@site/src/components/WebMetricsDemo.jsx';
...
:::tip Три сигнала
**Метрики** — «сколько и как быстро». **Логи** — «что случилось». **Трейсы** — «какой путь запроса через сервисы». Вместе они сокращают время поиска узкого места.
:::
...
- [Утилиты](/tools/Разработка/2) — Wireshark, Process Explorer, sysstat
