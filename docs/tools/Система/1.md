...
- **Windows Subsystem for Linux (WSL)**  
  ...
  wsl --install
  ```
  Подробнее: [официальная документация](https://learn.microsoft.com/ru-ru/windows/wsl/install).
...
- **Sysinternals Suite** — набор утилит от Microsoft (Process Explorer, Autoruns, ProcMon и др.).  
  Скачать: [официальный сайт](https://learn.microsoft.com/ru-ru/sysinternals/).
