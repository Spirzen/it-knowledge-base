---
title: Мониторинг
description: Мониторинг — процесс сбора, анализа и визуализации метрик и событий в программных и аппаратных компонентах ИТ-инфраструктуры.
slug: /tools/Система/2
---
...
#### Текущие метрики ресурсов (CPU, RAM, Disk, Сеть)
