...
description: "Контейнеризация — метод изоляции приложений и их зависимостей в лёгковесных, переносимых средах, использующих общее ядро ОС."
slug: /tools/Система/4
---
...
#### Nomad (HashiCorp)
- Альтернатива Kubernetes с поддержкой JVM-процессов, бинарников.
- Проще в настройке.
- Установка:
  ```bash
