...
import TestingToolsCatalogPlay from '@site/src/components/TestingToolsCatalogPlay.jsx';
import TestingStagesPlay from '@site/src/components/TestingStagesPlay';
import UnitTestingAaaPlay from '@site/src/components/UnitTestingAaaPlay';
import TestingClassificationPlay from '@site/src/components/TestingClassificationPlay';
import TestDoublesComparePlay from '@site/src/components/TestDoublesComparePlay';
import LoadStressMetricsPlay from '@site/src/components/LoadStressMetricsPlay.jsx';
...
<TestingToolsCatalogPlay />

<TestingStagesPlay />

<UnitTestingAaaPlay />

<TestingClassificationPlay />

<TestDoublesComparePlay />

<LoadStressMetricsPlay />

<div class="callout callout--tip">
  <div class="callout-title">CI/CD</div>

  <div class="callout-body">
  Запускайте unit и линтеры на каждый push; integration — на merge; E2E и нагрузку — по расписанию или перед релизом. Отчёты в формате **JUnit XML** подхватывают GitHub Actions, GitLab CI, Jenkins.
</div>
  </div>
...
| **curl** | CLI-запросы без GUI — [утилита curl](/encyclopedia/2-system-network/2-05-terminal/1133) |
