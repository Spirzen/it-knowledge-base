...
import DevAutomationPlay from '@site/src/components/DevAutomationPlay.jsx';
...
macOS — LaunchAgent (см. [Планировщики](/tools/Автоматизация/1)). Планировщик ОС — когда нужен не watch, а **строгое расписание**.
