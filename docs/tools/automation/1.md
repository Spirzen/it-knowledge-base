...
import CronSchedulePlay from '@site/src/components/CronSchedulePlay.jsx';
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Shell-скрипты и PowerShell — в разделах языков; пайплайны CI/CD — в [DevOps и CI/CD](/encyclopedia/8-infra-security/8-04-devops-ci-cd/intro); планирование на сервере — в [системном администрировании](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/intro).
</div>
  </div>
