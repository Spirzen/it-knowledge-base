...
slug: /tools/Документация/5
---

import CrossPlatformMobilePlay from '@site/src/components/CrossPlatformMobilePlay.jsx';
...
:::tip Практика
Начните с **одного модуля** (например, API-клиент + DTO), покройте контрактными тестами в `commonTest`, затем подключайте iOS. Параллельно следите за [Swift SDK для Android](/tools/Документация/4), если стек команды уже на Swift.
:::
...
- [Подборка документации](/tools/Документация/2) — Kotlin Docs, Android Developer
- [Подборка статей](/tools/Документация/3) — архитектура и процессы
