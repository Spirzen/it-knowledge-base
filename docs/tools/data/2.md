---
title: NoSQL
description: "NoSQL (Not only SQL) — класс систем управления данными, не требующих фиксированной реляционной схемы и часто оптимизированных под горизонтальное масштабирование, гибкость схемы и высокую доступность."
slug: /tools/Данные/2
...
- **Сценарии**: Big Данные, аналитика, долговременное хранение логов.
- **Установка**:
