...
<div class="callout callout--tip">
  ...
  <p><strong>PostgreSQL</strong> — рекомендуемая серверная СУБД для практики всем в IT: разработчикам, аналитикам, тестировщикам, инженерам, администраторам и архитекторам — независимо от языка. Установите локально (или в Docker), пройдите <a href="/encyclopedia/3-data-markup/3-07-sql/101">Первые шаги с SQL</a> и закрепите на <a href="/encyclopedia/3-data-markup/3-07-sql/891">демобазе</a>. До установки можно потренироваться в браузере — <a href="/lab/Примеры/1152">SQL — реальные кейсы</a> (тренажёр и разбор запросов на схеме магазина). Для встраиваемых сценариев и прототипов без сервера — <strong>SQLite</strong>. NoSQL добавляют, когда схема или нагрузка этого требуют.</p>
</div>
  </div>
