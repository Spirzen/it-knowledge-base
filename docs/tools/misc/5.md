---
title: Скриншотеры
description: Скриншотеры — программные средства для создания изображений содержимого экрана или его фрагментов.
slug: /tools/Прочее/5
---
# Скриншотеры
...
- **Описание**: Встроенная функция macOS для захвата области, окна или всего экрана с возможностью добавления аннотаций. Сочетания начинаются с клавиши **⌘ (Command)** — служебной клавиши с символом петли слева от пробела; в Windows ту же роль для многих команд выполняют **Ctrl** или **Win**.
- **Установка**: Предустановлено.
- **Дополнительно**: Снимки сохраняются по умолчанию на рабочий стол; настройки — в «Сстемных настройках → Клавиатура → Сочетания клавиш».
