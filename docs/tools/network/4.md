...
Полная таблица (маршрут, `ss`/`netstat`, ARP, `iperf3`, `ssh`) — [Сетевые подключения и диагностика](/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/6#setevye-komandy-diagnostika).
