...
Синтаксис идентичен JavaScript.
...
// Запись
File.WriteAllText("example.txt", "Привет из C#!", System.Text.Encoding.UTF8);

// Чтение
string content = File.ReadAllText("example.txt", System.Text.Encoding.UTF8);
