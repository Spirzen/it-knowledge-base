...
Для генерации надёжных паролей применяется `RandomNumberGenerator`, входящий в состав `System.Security.Cryptography`. Он использует источники энтропии операционной системы.
