...
description: JSON — JavaScript Object Notation — стал де-факто стандартом обмена структурированными данными в распределённых системах, веб-API и конфигурационных файлах.
slug: /lab/Кейсы/11
---
# Парсер JSON на Java
...
Рекомендуется использовать как модульные тесты (JUnit), так и *свойственные тесты* (property-based Тестирование, например, с помощью jq или сравнения с `org.json` как «oracle»).
