...
<div class="callout callout--tip">
  ...
  Pages опирается на репозиторий и <code>git push</code>. Команды <code>init</code>, <code>add</code>, <code>commit</code>, <code>push</code> с построчным разбором — <a href="/lab/Примеры/1123">лабораторная шпаргалка Git</a> (<a href="/lab/Примеры/1123#как-залить-проект-на-github-с-нуля">залить проект на GitHub</a>). Теория — <a href="/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/112">Как работать с Git</a>.
</div>
</div>
