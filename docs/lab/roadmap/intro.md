...
- готовые планы по ролям;
- маршруты роста от новичка к специализации;
- инструмент профориентации по интересу к темам.
...
<div class="callout callout--tip">
  ...
  Независимо от выбранного плана развития стоит **установить PostgreSQL** и регулярно с ним работать — разработчикам, аналитикам, тестировщикам, инженерам, администраторам и архитекторам.

  Старт — [Первые шаги с SQL](/encyclopedia/3-data-markup/3-07-sql/101), установка — [СУБД](/tools/data/1).
</div>
  </div>
