...
import ScratchPythonTable from '@site/src/components/ScratchPythonTable.jsx';
...
<div class="callout callout--tip">
  ...
  Перед таблицей полезно пройти <a href="/encyclopedia/9-spinoff/9-11-dlya-detey/5-kod/2">главу «Блоки»</a> и поработать в <a href="/lab/Примеры/1121">мини-проектах Scratch</a>. Синтаксис Python — в <a href="/encyclopedia/9-spinoff/9-11-dlya-detey/5-kod/6">программе на Python</a>. Рисование «как в Scratch, но текстом» — <a href="/lab/Примеры/111">Turtle</a> и <a href="/encyclopedia/5-languages/5-02-python/32">глава Turtle</a>. Промежуточный шаг с блоками и текстом одновременно — <a href="/encyclopedia/9-spinoff/9-11-dlya-detey/5-kod/4">Edublocks</a>.
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Переход Scratch → Python — это <strong>замена обёртки при том же скелете</strong>: цикл остаётся циклом, условие — условием, переменная — переменной. Меняются скобки, отступы и способ запуска. Подробный разбор на примере «кота» — в <a href="/encyclopedia/9-spinoff/9-11-dlya-detey/5-kod/2">главе «Блоки»</a>, § «От графики к тексту».
</div>
</div>
...
| Цель | Материал |
|------|----------|
| Ещё блоки Scratch | [112 — примеры скриптов](/lab/Примеры/112), [1121 — мини-проекты](/lab/Примеры/1121) |
...
| Задачи ЕГЭ / олимпиады | [1122 — алгоритмы на Python](/lab/Примеры/1122) |
