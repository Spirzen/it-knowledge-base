...
Готовые **скетчи Arduino Uno** (язык C++) и **программы BBC micro:bit** (MakeCode / JavaScript) с **построчным разбором** — в том же формате, что и популярная [галерея Turtle на Python](/lab/Примеры/111): скопировал код → прочитал, **зачем каждая строка** → запустил в [Tinkercad](https://www.tinkercad.com/circuits) или на плате.
...
|------------------------|-------------|
| arduino мигающий светодиод / blink | [Мигающий LED](#blink) |
| arduino подключение кнопки digitalRead | [Кнопка и LED](#button) |
| arduino плавная яркость pwm analogWrite | [ШИМ](#pwm) |
| arduino потенциометр analogRead | [Потенциометр](#sensor) |
| arduino светофор код | [Светофор](#traffic) |
| microbit сердце / смайлик код | [Сердце на micro:bit](#mb-heart) |
| microbit кнопка A B | [Кнопки A и B](#mb-buttons) |
| tinkercad arduino симулятор | [Симулятор](#simulator) |

**Где запускать:**

| Платформа | Симуляция в браузере | Прошивка на железо |
|-----------|----------------------|---------------------|
| **Arduino Uno** | Tinkercad Circuits → **Текст (C++)** → ▶ Start | Arduino IDE 2, кнопка Upload |
| **micro:bit** | Tinkercad (плата micro:bit) или [makecode.microbit.org](https://makecode.microbit.org) | USB → Download → перетащить файл на диск MICROBIT |

<div class="callout callout--tip">
  <div class="callout-title">Сначала теория</div>

  <div class="callout-body">
  Интерфейс Tinkercad, breadboard, Blockly и ограничения симулятора — <a href="/encyclopedia/2-system-network/2-10-zhelezo/1013">Tinkercad Circuits и Arduino</a>. Что такое микроконтроллер и прошивка — <a href="/encyclopedia/2-system-network/2-10-zhelezo/112">Встраиваемые системы</a>. Визуальный код без проводов — <a href="/lab/Примеры/112">Scratch</a>, рисование на ПК — <a href="/lab/Примеры/111">Turtle</a>.
</div>
</div>
...
<TinkercadCircuitsPlay section="hub" />
...
| Рисование на Python | [Turtle — галерея](/lab/Примеры/111) |
| Блоки без железа | [Scratch](/lab/Примеры/112) |
