...
description: "Примеры графиков Matplotlib на Python для школьников и студентов — sin, cos, парабола, столбцы, scatter, гистограмма, подграфики; код с подробным разбором."
...
<div class="callout callout--tip">
  ...
  Теория — <a href="/encyclopedia/5-languages/5-02-python/319">Matplotlib — графики</a> (архитектура, pyplot, экспорт). Массивы для осей X и Y — <a href="/lab/Примеры/1129">примеры NumPy</a>. Символьные формулы (корни, производные) перед графиком — <a href="/lab/Примеры/1118">SymPy — уравнения и производные</a>. Таблицы перед графиком — <a href="/lab/Примеры/1113">примеры Pandas</a>, <a href="/encyclopedia/5-languages/5-02-python/33">NumPy и pandas</a>. Рисование фигур «от руки» — <a href="/lab/Примеры/111">примеры Turtle</a> (Python) или <a href="/lab/Примеры/1114">p5.js</a> (браузер). Здесь — <strong>графики по числам</strong>: оси X и Y, подписи, легенда.
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Школьникам — график <code>y = x²</code>, синуса, температуры по дням. Студентам — scatter, гистограмма, box plot для лабораторных. Начинающим программистам — готовые шаблоны с разбором каждой строки: можно вставить в проект и поменять свои данные.
</div>
</div>
...
- [Примеры фигур Turtle на Python](/lab/Примеры/111) — 2D-рисование через turtle
- [Примеры фигур Panda3D на Python](/lab/Примеры/1111) — 3D-сцены
- [Tkinter — окна и виджеты](/lab/Примеры/1124) — формы и кнопки; график Matplotlib можно встроить в то же окно ([319](/encyclopedia/5-languages/5-02-python/319))
