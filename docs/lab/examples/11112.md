...
<div class="callout callout--tip">
  ...
  Полный справочник директив — <a href="/encyclopedia/8-infra-security/8-04-devops-ci-cd/3112">Nginx</a>. Как веб-сервер вписан в цепочку «DNS → HTTP → приложение» — <a href="/encyclopedia/2-system-network/2-04-kak-rabotayut-sayty-i-veb-sayty/112">веб-серверы</a>. Nginx в Docker — <a href="/lab/Примеры/11111">готовые стеки Compose</a>. Проверка ответов — <a href="/encyclopedia/2-system-network/2-05-terminal/1133">curl</a>.
</div>
</div>
