...
Одна задача — четыре языка. В каждом блоке: **цель**, **код**, **пояснение**, **типичная ошибка**. Так проще увидеть общую логику и отличия экосистем.
