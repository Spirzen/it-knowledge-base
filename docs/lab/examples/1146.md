...
| **Студенты** | Лабораторная «интерфейс на React», сравнение с [Tkinter](/lab/Примеры/1124) или [Swing](/lab/Примеры/1143) |
| **Самоучки** | Скопировать `.jsx` → `npm run dev` → разобрать таблицу под кодом |
| **После HTML/CSS** | Уже делали [макеты](/lab/Примеры/110) — те же формы, но state живёт в JavaScript |
...
<div class="callout callout--tip">
  ...
  Обзор React — <a href="/encyclopedia/5-languages/5-01-javascript/27">библиотека для пользовательских интерфейсов</a>. Пошаговый старт — <a href="/encyclopedia/5-languages/5-01-javascript/272">Первая программа на React</a>. Справочник API — <a href="/encyclopedia/5-languages/5-01-javascript/271">271</a>. HTTP-запросы — <a href="/lab/Примеры/1145">Fetch / axios</a> и <a href="/lab/Примеры/1133">curl / fetch</a>. Стили — <a href="/lab/Примеры/110">HTML + CSS — макеты</a>, <a href="/lab/Примеры/1117">Tailwind — готовые блоки</a>. Десктоп на Python — <a href="/lab/Примеры/1124">Tkinter — окна и виджеты</a>. Мобильный UI на Dart — <a href="/encyclopedia/5-languages/5-22-dart/311">Flutter</a> и <a href="/lab/Примеры/1154">Flutter — готовые виджеты</a>. Эта статья — практическая галерея, как <a href="/lab/Примеры/111">примеры Turtle</a> для рисования.
</div>
</div>
...
- Каждая секция — отдельный файл → параллельная работа в команде, проще искать код.
