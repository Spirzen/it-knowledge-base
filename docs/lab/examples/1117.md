...
Перед Tailwind полезно один раз пройти [HTML + CSS — готовые макеты](/lab/Примеры/110) — там те же задачи на чистом CSS. Тогда классы вроде `flex items-center` перестанут выглядеть «магией».
...
<div class="callout callout--tip">
  ...
  Теория по Flex/Grid — <a href="/encyclopedia/3-data-markup/3-10-css/2">отдельная глава</a>. Подключение CSS через CDN — <a href="/encyclopedia/3-data-markup/3-10-css/111">Подключение стилей</a>. Чистые макеты — <a href="/lab/Примеры/110">HTML + CSS — готовые макеты</a>. Анимации — <a href="/lab/Примеры/1116">CSS-анимации</a>. В React-проектах Tailwind часто идёт с Next.js — <a href="/encyclopedia/5-languages/5-01-javascript/271">экосистема React</a>.
</div>
</div>
...
**Аналог на чистом CSS** — [центрированная карточка в 110.md](/lab/Примеры/110#центрированная-карточка). Там `display: grid; place-items: center` — тот же эффект, другой синтаксис.
...
**Аналог на CSS** — [шапка и подвал в 110.md](/lab/Примеры/110#шапка-и-подвал--контент-между-ними-flexbox).
...
**Аналог на CSS** — [адаптивная сетка в 110.md](/lab/Примеры/110#адаптивная-сетка-карточек) с `auto-fit` и `minmax`.
