...
description: "Готовые docker-compose.yml с разбором каждой строки — nginx, PostgreSQL, Redis, WordPress, MongoDB. Примеры для школьников и студентов: postgres example, поднять базу локально, app + db."
...
<div class="callout callout--tip">
  ...
  Полный разбор Compose, команд CLI и типичных ошибок — <a href="/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/1111">Docker Compose</a>. Основы Docker и образов — <a href="/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/111">Docker</a>. Сборка своего образа — <a href="/encyclopedia/8-infra-security/8-06-konteynerizatsiya-i-orkestratsiya/116">Dockerfile</a> и <a href="/lab/Примеры/11113">галерея из 10 типовых Dockerfile</a>. Пошаговый стек Prometheus + Grafana — <a href="/encyclopedia/2-system-network/2-06-sistemnoe-administrirovanie/prometheus-grafana-praktikum/2">практикум</a>.
</div>
</div>
...
<div class="callout callout--info">
  ...
  Так же устроены популярные галереи вроде <a href="/lab/Примеры/111">Turtle</a> и <a href="/lab/Примеры/615">RegEx</a> — сначала код, потом объяснение.
</div>
</div>
