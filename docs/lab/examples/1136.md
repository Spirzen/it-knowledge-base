...
| **После Python** | Уже делали [Turtle](/lab/Примеры/111) или [Pygame](/lab/Примеры/1132) — те же идеи (цикл, ввод, счёт), другой синтаксис |

**Как работать с примером:**

1. Создайте скрипт в Unity (`Create` → `C# Script`).
2. Скопируйте код — **имя файла = имя класса** (`MoveWASD.cs` → `class MoveWASD`).
...
<div class="callout callout--tip">
  ...
  Установка редактора, окна, GameObject — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/3">Разработка на Unity</a>. Синтаксис C# — <a href="/encyclopedia/5-languages/5-05-csharp/1">первая программа</a>, <a href="/encyclopedia/5-languages/5-05-csharp/25">ООП в C#</a> (блок Unity). Lifecycle и API — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/301">Справочник по Unity</a>. 2D на Python без движка — <a href="/lab/Примеры/1132">Pygame — мини-игры</a>.
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  В примерах — классический <code>Input.GetAxis("Horizontal")</code> и <code>Input.GetKeyDown</code>. Он работает в большинстве учебных проектов (WASD и стрелки уже настроены). В новых шаблонах Unity может быть пакет <strong>Input System</strong> — тогда в <em>Project Settings → Player → Active Input Handling</em> выберите один подход. Подробнее — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/3">глава 3</a>.
</div>
</div>
