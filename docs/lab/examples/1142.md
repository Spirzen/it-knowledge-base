...
Подборка **рабочих команд** и **минимального datapack** для **Minecraft: Java Edition** — в том же формате, что популярная [галерея Turtle на Python](/lab/Примеры/111): **скопировали команду → прочитали разбор по частям → увидели результат в мире**.
...
теория и контекст — в [Разработка в Minecraft](/encyclopedia/9-spinoff/9-04-razrabotka-igr/21), здесь — **практика с разбором строк**.

**Как пользоваться страницей**

1. Найдите задачу в [таблице запросов](#chto-ishchut).
...
<div class="callout callout--tip">
  ...
  Моды, Python, ComputerCraft, сервер — <a href="/encyclopedia/9-spinoff/9-04-razrabotka-igr/21">Разработка в Minecraft</a>. Игры на Python вне мира — <a href="/lab/Примеры/1132">Pygame</a>, блоки Scratch — <a href="/lab/Примеры/112">Scratch</a>, Roblox Studio — <a href="/lab/Примеры/1141">Luau</a>.
</div>
</div>

<div class="callout callout--info">
  <div class="callout-title">Java Edition и Bedrock</div>

  <div class="callout-body">
  Все примеры — <strong>Java Edition</strong> (лаунчер Mojang на ПК). В Bedrock другие команды и нет datapack в этом виде.
</div>
</div>
...
Сохраните страницу в закладки и идите по таблице [запросов](#chto-ishchut) — так же удобно искать, как по [Turtle 111](/lab/Примеры/111) с готовыми фигурами.
