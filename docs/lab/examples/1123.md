...
- стажёры — ежедневный цикл `add` → `commit` → `push` без страха терминала.

Здесь — **сценарии с разбором**. Полный курс, симптомы «сломалось» и справочник всех флагов — в энциклопедии [4.13 «Основы Git»](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/intro).

<div class="callout callout--tip">
  <div class="callout-title">С чего начать в теории</div>

  <div class="callout-body">
  Цепочка <code>add → commit → push</code> и четыре уровня хранения — <a href="/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/112">Как работать с Git</a>. Ветки и Pull Request — <a href="/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/113">Ветвление и слияние</a>. Интерактивный тренажёр — <a href="https://learngitbranching.js.org/?locale=ru_RU">Learn Git Branching</a> (на русском).
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Если цель — <strong>портфолио или лендинг в интернете</strong>, одного push мало: нужны настройки Pages или workflow. Пошаговый кейс с HTTPS, Actions и доменом — <a href="/lab/Кейсы/3">Размещение своего сайта с GitHub Pages</a>. Базовые команды push — в блоке выше.
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  Добавьте <code>.gitignore</code>, чтобы в репозиторий не попали <code>node_modules/</code>, <code>.env</code>, <code>__pycache__/</code>, папки сборки. Шаблоны — <a href="/lab/Примеры/2">лабораторные шаблоны</a>, подробно — <a href="/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/116">руководство .gitignore</a>.
</div>
</div>
...
На общей ветке `main` в учебной группе согласуйте с одногруппниками. Подробнее — [1141](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/1141#push-отклонён-non-fast-forward).
...
Схема трёхстороннего слияния — [113](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/113#trehstoronnee-sliyanie).
...
| Pull Request, конфликты | [113](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/113) |
| Секреты, `.env` в репозитории | [1141](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/1141#секрет-или-конфиденциальный-файл-в-git), [116](/encyclopedia/4-code-dev/4-13-osnovy-raboty-s-git/116) |
