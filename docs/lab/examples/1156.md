...
Полная шпаргалка — [1123](/lab/Примеры/1123). Здесь — «застрял сейчас»:
...
Git Bash, [Coreutils for Windows](https://github.com/microsoft/coreutils), отдельные `.exe` — см. [104](/encyclopedia/2-system-network/2-05-terminal/104).
...
Подробнее — [1133](/lab/Примеры/1133).
