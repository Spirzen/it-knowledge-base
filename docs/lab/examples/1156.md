...
3. **Ctrl+C** в исходном терминале ([советы](/encyclopedia/1-basics/1-035-bazovaya-informatika/208#4-локальный-dev-сервер--окно-терминала-не-закрывать)).
...
Сервер **остановился**. Решение: снова открыть терминал в `WIN_ROOT`, запустить команду из README, не закрывать окно. См. [советы](/encyclopedia/1-basics/1-035-bazovaya-informatika/208).
...
Материал дополняет [Терминал — о разделе](/encyclopedia/2-system-network/2-05-terminal/intro) и [локальный dev-сервер](/encyclopedia/1-basics/1-035-bazovaya-informatika/208).
