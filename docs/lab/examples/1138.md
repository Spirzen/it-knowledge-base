...
<div class="callout callout--info">
  ...
  В курсовой и production свойства выносят во **ViewModel** с `INotifyPropertyChanged` — см. [119.md](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/119) и [практикум MVVM](/encyclopedia/4-code-dev/4-11-desktopnye-prilozheniya/wpf-praktikum/2).
</div>
</div>
