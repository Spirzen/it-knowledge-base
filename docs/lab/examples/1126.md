...
description: "Примеры Python для школьников и студентов — open, with, pathlib, чтение и запись txt, CSV, JSON, обработка строк; код с подробным разбором каждой строки и типичными запросами из Google."
...
- тех, кто уже решал [алгоритмы на Python](/lab/Примеры/1122) и хочет **читать вход из файла**, а не с клавиатуры.
...
<div class="callout callout--tip">
  ...
  Файловая система, HTTP и форматы данных — <a href="/encyclopedia/5-languages/5-02-python/31">Работа с файлами, сетью и внешними API</a>. Общая теория I/O — <a href="/encyclopedia/1-basics/1-10-bazovye-operatsii-s-dannymi/2">Чтение и запись</a>. Большие таблицы — <a href="/lab/Примеры/1113">Pandas</a>. Ввод для ЕГЭ и олимпиад — <a href="/lab/Примеры/1122">алгоритмы на Python</a>. Сложный поиск по тексту — <a href="/lab/Примеры/615">Regex</a>.
</div>
</div>
...
<div class="callout callout--info">
  ...
  <div class="callout-body">
  На диске файл — это <strong>байты</strong>. Режим <code>"r"</code> с <code>encoding="utf-8"</code> превращает байты в строку Python (<code>str</code>). Символ перевода строки хранится как <code>&#92;n</code> — его часто убирают через <code>strip()</code> перед сравнением или <code>int()</code>.
</div>
</div>
...
- [Примеры фигур Turtle](/lab/Примеры/111) — визуальные примеры для отдыха от файлов
