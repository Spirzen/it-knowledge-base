...
Готовые **примеры GitHub Actions** с **пошаговым разбором каждой строки YAML** — как в [галерее Turtle](/lab/Примеры/111) для Python и [curl / fetch](/lab/Примеры/1133) для API. Можно скопировать workflow, вставить в репозиторий и понять, **зачем нужна каждая строка**.
...
Бесплатного лимита GitHub Actions хватает для учебных репозиториев. Подробности — в [документации GitHub](https://docs.github.com/ru/billing/managing-billing-for-github-actions/about-billing-for-github-actions).

<div class="callout callout--tip">
  <div class="callout-title">Сначала теория</div>

  <div class="callout-body">
  Системное введение — <a href="/encyclopedia/8-infra-security/8-04-devops-ci-cd/2112">GitHub Actions</a>. Полный справочник по ключам YAML — <a href="/encyclopedia/8-infra-security/8-04-devops-ci-cd/3113">Справочник по GitHub Actions</a>. Связка Git и триггеров — <a href="/encyclopedia/8-infra-security/8-04-devops-ci-cd/12">Git и GitFlow в DevOps</a>. Пошаговый деплой сайта — <a href="/lab/cases/3">кейс GitHub Pages</a>.
</div>
</div>
...
<div class="callout callout--danger">
  ...
  <div class="callout-body">
  Токен в коммите остаётся в истории навсегда. Отзовите ключ, очистите историю (<code>git filter-repo</code> / BFG), создайте секрет заново. В YAML — только <code>$&#123;&#123; secrets.NAME &#125;&#125;</code>.
</div>
</div>
