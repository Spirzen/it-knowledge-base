...
`127.0.0.1 - - [10/Nov/2025:12:00:01 +0300] "GET /api/Данные HTTP/1.1" 200 1234 "-" "curl/7.68.0"`
...
seq 1 1000000 > Данные.txt
gzip Данные.txt

echo "Сжатие завершено. Нажмите Ctrl+C для прерывания."
sleep 10

echo "Работа завершена. Архив: $(ls -lh Данные.txt.gz)"
```
...
```
        ...
        Swaps: 0
        File Система inputs: 0
        File Система outputs: 0
...
#### 9.2.1. Извлечение значения по пути `$.Данные[0].id`
...
print(Данные.get('Данные', [{}])[0].get('id', ''))
"
```
...
### 10.2. Unit-тесты с `bats` (Bash Automated Тестирование Система)
