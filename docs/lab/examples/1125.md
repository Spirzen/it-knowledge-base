...
Текущая статья посвящена готовым заготовки C++17 для школьных олимпиад и Codeforces.
...
<div class="callout callout--tip">
  ...
  Алгоритмы в общем виде — [раздел «Алгоритмы»](/encyclopedia/4-code-dev/4-01-algoritmy/intro).

  Синтаксис C++ — [C++ — о разделе](/encyclopedia/5-languages/5-06-cpp/intro), первая программа — [Первая программа](/encyclopedia/5-languages/5-06-cpp/1002).

  Те же идеи на Python с разбором задач — [Алгоритмы на Python — ЕГЭ и олимпиадка](/lab/Примеры/1122).

  Визуальная пауза между задачами — [Turtle на Python](/lab/Примеры/111).
</div>
</div>
