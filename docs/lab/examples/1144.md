...
<div class="callout callout--tip">
  ...
  Перед практикой откройте <a href="/encyclopedia/5-languages/5-01-javascript/102">Работа с HTML в JavaScript</a> — дерево узлов, шпаргалка API, связь с CSSOM. События, всплытие и делегирование — <a href="/encyclopedia/5-languages/5-01-javascript/23">События в браузере</a>. Каркас страницы — <a href="/lab/Примеры/1153">HTML-страницы целиком</a> и <a href="/lab/Примеры/110">HTML + CSS — макеты</a>. Запросы к API — <a href="/lab/Примеры/1145">Fetch / axios</a>. Дальше по стеку — <a href="/lab/Примеры/1146">React</a> и <a href="/lab/Примеры/1147">Vue и Svelte</a> (как в <a href="/lab/Примеры/111">галерее Turtle</a> — сначала основы, потом готовые рецепты).
</div>
</div>
