...
title: Архитектура
description: >-
  Обзор многосервисной архитектуры проекта, паттерны интеграции контента, роли внешних сервисов и принципы взаимодействия между основными компонентами платформы.
sidebar_position: 1
