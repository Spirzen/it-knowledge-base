---
title: Перекрёстные ссылки в статьях
sidebar_label: Перекрёстные ссылки
description: Как связывать статьи энциклопедии с глоссарием и другими разделами, не меняя обычный текст.
---
