...
**Политика локализации:** проект `i18n-ready`, но `not i18n now` — новые языки не внедряются и не планируются, так как это нерационально при текущем объёме материалов.
