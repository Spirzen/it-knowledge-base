...
import {ROLLOUT_STAGES, SAMPLE_ORDERS} from './shared/lowCodeRolloutEngine';
import styles from './LowCodeRolloutPlay.module.css';
...
export default function LowCodeRolloutPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <LowCodeRolloutPlayInner />}
    </BrowserOnly>
  );
}
