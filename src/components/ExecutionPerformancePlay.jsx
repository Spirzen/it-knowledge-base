...
export default function ExecutionPerformancePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо производительности…')}>
      {() => <ExecutionPerformancePlayInner />}
    </BrowserOnly>
  );
}
