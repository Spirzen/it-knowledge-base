...
import {QUERY_PRESETS, SAMPLE_DOCS, runFind} from './shared/mongoExplorerEngine';
import styles from './MongoDbExplorerPlay.module.css';
...
export default function MongoDbExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>{() => <MongoDbExplorerPlayInner />}</BrowserOnly>
  );
}
