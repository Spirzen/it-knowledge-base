...
import styles from './OrgHierarchyPlay.module.css';
...
export default function OrgHierarchyPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка иерархии…')}>
      {() => <OrgHierarchyPlayInner />}
    </BrowserOnly>
  );
}
