...
import {
  ...
  classLevel,
  governanceScore,
} from './shared/dataGovernanceEngine';
import styles from './DataGovernancePlay.module.css';
...
export default function DataGovernancePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>{() => <DataGovernancePlayInner />}</BrowserOnly>
  );
}
