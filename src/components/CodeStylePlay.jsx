...
import styles from './CodeStylePlay.module.css';
...
export default function CodeStylePlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо стиля кода…')}>
      {() => <CodeStylePlayInner {...props} />}
    </BrowserOnly>
  );
}
