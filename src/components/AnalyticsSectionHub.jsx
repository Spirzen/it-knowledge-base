...
import styles from './AnalyticsSectionHub.module.css';
...
export default function AnalyticsSectionHub() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка навигатора аналитики…')}>
      {() => <AnalyticsSectionHubInner />}
    </BrowserOnly>
  );
}
