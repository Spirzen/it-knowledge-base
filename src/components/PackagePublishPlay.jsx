...
import {ECOSYSTEMS, PUBLISH_STEPS} from './shared/packagePublishEngine';
import styles from './PackagePublishPlay.module.css';
...
export default function PackagePublishPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <PackagePublishPlayInner />}
    </BrowserOnly>
  );
}
