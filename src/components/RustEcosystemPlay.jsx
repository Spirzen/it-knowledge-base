...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/rustEcosystemEngine';
import styles from './RustEcosystemPlay.module.css';
...
export default function RustEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Rust…')}>
      {() => <RustEcosystemPlayInner />}
    </BrowserOnly>
  );
}
