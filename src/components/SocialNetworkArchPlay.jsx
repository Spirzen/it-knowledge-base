...
import styles from './SocialNetworkArchPlay.module.css';
...
export default function SocialNetworkArchPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо соцсети…')}>
      {() => <SocialNetworkArchPlayInner />}
    </BrowserOnly>
  );
}
