...
import {
  ...
  SKILL_AXES,
  SUPPORT_CHANNELS,
} from './shared/authorProfileEngine';
import styles from './AuthorProfilePlay.module.css';
...
export default function AuthorProfilePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка профиля…')}>
      {() => <AuthorProfilePlayInner />}
    </BrowserOnly>
  );
}
