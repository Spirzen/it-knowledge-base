...
import {ITSM_BLOCKS, ITSM_FLOW} from './shared/techSupportEngines';
...
export default function TechSupportItsmPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо ITSM…')}>
      {() => <TechSupportItsmPlayInner />}
    </BrowserOnly>
  );
}
