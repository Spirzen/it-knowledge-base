...
} from './shared/gameArchitectureEngine';
import styles from './GameArchitecturePlay.module.css';
...
export default function GameArchitecturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры игры…')}>
      {() => <GameArchitecturePlayInner />}
    </BrowserOnly>
  );
}
