...
import {
  ...
  NAMING_STYLES,
  buildIdentifier,
} from './shared/namingConventionEngine';
import styles from './NamingConventionPlay.module.css';
...
export default function NamingConventionPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <NamingConventionPlayInner />}
    </BrowserOnly>
  );
}
