...
import {CICD_VALIDATION_LAYERS, simulateValidation} from './shared/devopsCiCdEngines';
...
export default function CicdValidationLayersPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <CicdValidationLayersPlayInner />}
    </BrowserOnly>
  );
}
