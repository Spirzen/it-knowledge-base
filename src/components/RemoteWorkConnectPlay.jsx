...
import {CONNECTION_SCENARIOS, getScenario} from './shared/remoteWorkConnectEngine';
import styles from './RemoteWorkConnectPlay.module.css';
...
export default function RemoteWorkConnectPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка схемы…')}>
      {() => <RemoteWorkConnectPlayInner />}
    </BrowserOnly>
  );
}
