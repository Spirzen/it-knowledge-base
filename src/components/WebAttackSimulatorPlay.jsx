...
import {
  ...
  simulateSqlLogin,
  simulateXssOutput,
} from './shared/webAttackSimulatorEngine';
import styles from './WebAttackSimulatorPlay.module.css';
...
export default function WebAttackSimulatorPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора…')}>
      {() => <WebAttackSimulatorPlayInner {...props} />}
    </BrowserOnly>
  );
}
