...
import {TEACHING_PATH, WEB_STACK_LANGUAGES} from './shared/beginnerWebStackData';
import {WebPageLayersPlayInner} from './WebPageLayersPlay';
import {CodeRunPlacePlayInner} from './CodeRunPlacePlay';
import {SyntaxComparePlayInner} from './SyntaxComparePlay';
import FirstProgramPlay from './FirstProgramPlay';
import styles from './BeginnerWebStackHub.module.css';
...
export default function BeginnerWebStackHub(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка учебного хаба…')}>
      {() => <BeginnerWebStackHubInner {...props} />}
    </BrowserOnly>
  );
}
