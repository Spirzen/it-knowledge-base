...
import {HOME_NODES, HOME_SCENARIOS} from './shared/homeNetworkEngine';
import styles from './HomeNetworkPlay.module.css';
...
export default function HomeNetworkPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка домашней сети…')}>
      {() => <HomeNetworkPlayInner />}
    </BrowserOnly>
  );
}
