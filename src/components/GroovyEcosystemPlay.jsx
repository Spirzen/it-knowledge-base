...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/groovyEcosystemEngine';
import styles from './GroovyEcosystemPlay.module.css';
...
export default function GroovyEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Groovy…')}>
      {() => <GroovyEcosystemPlayInner />}
    </BrowserOnly>
  );
}
