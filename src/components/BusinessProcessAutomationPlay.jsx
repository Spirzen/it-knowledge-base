...
import {
  ...
  formatDuration,
  totalMinutes,
} from './shared/businessProcessAutomationEngine';
import styles from './BusinessProcessAutomationPlay.module.css';
...
export default function BusinessProcessAutomationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <BusinessProcessAutomationPlayInner />}
    </BrowserOnly>
  );
}
