...
import styles from './ParallelSpeedupLab.module.css';
...
export default function ParallelSpeedupLab() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка лаборатории ускорения…')}>
      {() => <ParallelSpeedupLabInner />}
    </BrowserOnly>
  );
}
