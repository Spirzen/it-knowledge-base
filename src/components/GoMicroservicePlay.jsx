...
import {
  ...
  runMiddlewareChain,
  tickWorkers,
} from './shared/goMicroserviceEngine';
import styles from './GoMicroservicePlay.module.css';
...
export default function GoMicroservicePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Go…')}>
      {() => <GoMicroservicePlayInner />}
    </BrowserOnly>
  );
}
