...
import styles from './CloudServiceStackPlay.module.css';
...
export default function CloudServiceStackPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка моделей облака…')}>
      {() => <CloudServiceStackPlayInner />}
    </BrowserOnly>
  );
}
