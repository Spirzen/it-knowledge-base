...
import {computePercentiles, simulateRequestLatencies} from './shared/observabilityEngine';
import styles from './WebMetricsDemo.module.css';
...
export default function WebMetricsDemo() {
  return (
