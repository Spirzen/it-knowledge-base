...
import {ECOSYSTEM_LAYERS, HUB_SECTIONS} from './shared/gameIndustryEngine';
    ...
    <DemoShell className={styles.shell}>
      ...
      >
        ...
        <p className={styles.hint}>
          ...
          — 25 интерактивных серий с хронологией релизов.
        </p>
