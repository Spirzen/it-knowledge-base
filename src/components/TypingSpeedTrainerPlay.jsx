...
import styles from './TypingSpeedTrainerPlay.module.css';
...
export default function TypingSpeedTrainerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка тренажёра печати…')}>
      {() => <TypingSpeedTrainerPlayInner />}
    </BrowserOnly>
  );
}
