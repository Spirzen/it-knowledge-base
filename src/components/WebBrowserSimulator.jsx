...
import styles from './WebBrowserSimulator.module.css';
...
export default function WebBrowserSimulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка браузера…')}>
      {() => <WebBrowserSimulatorInner {...props} />}
    </BrowserOnly>
  );
}
