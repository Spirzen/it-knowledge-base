...
import styles from './BusinessPlatformsPlay.module.css';
...
export default function BusinessPlatformsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка платформ…')}>
      {() => <BusinessPlatformsPlayInner />}
    </BrowserOnly>
  );
}
