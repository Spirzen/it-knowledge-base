...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/haskellEcosystemEngine';
import styles from './HaskellEcosystemPlay.module.css';
...
export default function HaskellEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Haskell…')}>
      {() => <HaskellEcosystemPlayInner />}
    </BrowserOnly>
  );
}
