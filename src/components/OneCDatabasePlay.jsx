...
import {
  ...
  sqlForOp,
} from './shared/oneCDatabaseEngine';
import toolStyles from './shared/toolDemo.module.css';
import styles from './JavaDatabasePlay.module.css';
import oneCStyles from './OneCDatabasePlay.module.css';
...
export default function OneCDatabasePlay({defaultMode = 'storage'}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо 1С + БД…')}>
      {() => <OneCDatabasePlayInner defaultMode={defaultMode} />}
    </BrowserOnly>
  );
}
