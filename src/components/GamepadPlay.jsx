...
import styles from './GamepadPlay.module.css';
...
export default function GamepadPlay({variant}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо геймпада…')}>
      {() => <GamepadPlayInner variant={variant} />}
    </BrowserOnly>
  );
}
