...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/javaDatabaseEngine';
...
export default function JavaDatabasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Java + БД…')}>
      {() => <JavaDatabasePlayInner />}
    </BrowserOnly>
  );
}
