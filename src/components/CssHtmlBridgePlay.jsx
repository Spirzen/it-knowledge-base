...
import {
  ...
  resolveStyles,
  stylesToReact,
} from './shared/cssHtmlBridgeEngine';
import toolStyles from './shared/toolDemo.module.css';
import styles from './CssHtmlBridgePlay.module.css';
...
export default function CssHtmlBridgePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо CSS…')}>
      {() => <CssHtmlBridgePlayInner />}
    </BrowserOnly>
  );
}
