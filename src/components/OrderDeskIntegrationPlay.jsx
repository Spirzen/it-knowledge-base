...
} from './shared/orderDeskPlayEngine';
import styles from './OrderDeskIntegrationPlay.module.css';
...
export default function OrderDeskIntegrationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback}>
      {() => <OrderDeskIntegrationPlayInner />}
    </BrowserOnly>
  );
}
