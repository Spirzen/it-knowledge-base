...
import {FSHARP_LANGUAGE_REF_CATALOG} from './shared/fsharpLanguageRefCatalog';
...
export default function FsharpLanguageRefExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка справочника F#…')}>
      {() => <FsharpLanguageRefExplorerPlayInner />}
    </BrowserOnly>
  );
}
