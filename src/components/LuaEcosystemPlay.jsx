...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/luaEcosystemEngine';
import styles from './LuaEcosystemPlay.module.css';
...
export default function LuaEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Lua…')}>
      {() => <LuaEcosystemPlayInner />}
    </BrowserOnly>
  );
}
