...
import {DOTNET_API_CATALOG} from './shared/dotnetApiCatalog';
...
export default function DotNetApiExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка навигатора API…')}>
      {() => <DotNetApiExplorerPlayInner />}
    </BrowserOnly>
  );
}
