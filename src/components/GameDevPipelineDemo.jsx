...
import {PIPELINE_STAGES} from './shared/gameDevEngine';
...
export default function GameDevPipelineDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка конвейера геймдева…')}>
      {() => <GameDevPipelineDemoInner />}
    </BrowserOnly>
  );
}
