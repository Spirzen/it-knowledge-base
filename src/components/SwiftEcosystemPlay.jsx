...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/swiftEcosystemEngine';
import styles from './SwiftEcosystemPlay.module.css';
...
export default function SwiftEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Swift…')}>
      {() => <SwiftEcosystemPlayInner />}
    </BrowserOnly>
  );
}
