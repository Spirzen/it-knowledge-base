...
import styles from './WebPageLayersPlay.module.css';
...
export default function WebPageLayersPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо слоёв страницы…')}>
      {() => <WebPageLayersPlayInner {...props} />}
    </BrowserOnly>
  );
}
