...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/rubyDatabaseEngine';
...
export default function RubyDatabasePlay({defaultMode}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Ruby + БД…')}>
      {() => <RubyDatabasePlayInner defaultMode={defaultMode} />}
    </BrowserOnly>
  );
}
