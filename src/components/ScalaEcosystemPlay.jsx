...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/scalaEcosystemEngine';
import styles from './ScalaEcosystemPlay.module.css';
...
export default function ScalaEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры Scala…')}>
      {() => <ScalaEcosystemPlayInner />}
    </BrowserOnly>
  );
}
