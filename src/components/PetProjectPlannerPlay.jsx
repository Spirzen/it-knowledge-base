...
import {PET_TYPES} from './shared/petProjectPlannerEngine';
import styles from './PetProjectPlannerPlay.module.css';
...
export default function PetProjectPlannerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <PetProjectPlannerPlayInner />}
    </BrowserOnly>
  );
}
