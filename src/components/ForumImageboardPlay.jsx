...
import styles from './ForumImageboardPlay.module.css';
...
export default function ForumImageboardPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка сравнения…')}>
      {() => <ForumImageboardPlayInner />}
    </BrowserOnly>
  );
}
