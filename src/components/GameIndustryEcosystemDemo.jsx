...
import {
  ...
  RELEASE_FLOW,
  STUDIO_MODELS,
} from './shared/gameIndustryEngine';
import styles from './GameIndustryDemo.module.css';
...
export default function GameIndustryEcosystemDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка модели индустрии…')}>
      {() => <GameIndustryEcosystemDemoInner />}
    </BrowserOnly>
  );
}
