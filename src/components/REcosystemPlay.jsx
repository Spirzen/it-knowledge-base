...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/rEcosystemEngine';
import styles from './REcosystemPlay.module.css';
...
export default function REcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы R…')}>
      {() => <REcosystemPlayInner />}
    </BrowserOnly>
  );
}
