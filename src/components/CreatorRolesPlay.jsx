...
import styles from './CreatorRolesPlay.module.css';
...
export default function CreatorRolesPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка ролей…')}>
      {() => <CreatorRolesPlayInner />}
    </BrowserOnly>
  );
}
