...
import styles from './VerticalSoftwareExplorerPlay.module.css';
...
export default function VerticalSoftwareExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка карты…')}>
      {() => <VerticalSoftwareExplorerPlayInner />}
    </BrowserOnly>
  );
}
