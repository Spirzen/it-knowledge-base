...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/rustDatabaseEngine';
...
export default function RustDatabasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Rust + БД…')}>
      {() => <RustDatabasePlayInner />}
    </BrowserOnly>
  );
}
