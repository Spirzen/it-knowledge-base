...
import {SCENARIO_IDS, getScenario} from './shared/exceptionDemoEngine';
...
export default function ExceptionHandlingDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо исключений…')}>
      {() => <ExceptionHandlingDemoInner />}
    </BrowserOnly>
  );
}
