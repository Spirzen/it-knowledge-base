...
import {DISASTER_SCENARIOS, RECOVERY_TOOLS} from './shared/codeSafetyEngine';
import styles from './CodeSafetyPlay.module.css';
...
export default function CodeSafetyPlay() {
  return (
