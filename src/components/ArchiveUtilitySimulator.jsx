...
import styles from './ArchiveUtilitySimulator.module.css';
...
export default function ArchiveUtilitySimulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архиватора…')}>
      {() => <ArchiveUtilitySimulatorInner {...props} />}
    </BrowserOnly>
  );
}
