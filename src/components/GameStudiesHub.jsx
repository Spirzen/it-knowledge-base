...
import {FRANCHISES, GENRES} from './shared/gameFranchiseData';
...
export default function GameStudiesHub() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка каталога игр…')}>
      {() => <GameStudiesHubInner />}
    </BrowserOnly>
  );
}
