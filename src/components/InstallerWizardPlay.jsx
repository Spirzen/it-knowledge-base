...
import styles from './InstallerWizardPlay.module.css';
 ...
 */
export default function InstallerWizardPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка мастера установки…')}>
      {() => <InstallerWizardPlayInner {...props} />}
    </BrowserOnly>
  );
}
