...
import styles from './DisplayTechPlay.module.css';
...
export default function DisplayTechPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо дисплеев…')}>
      {() => <DisplayTechPlayInner />}
    </BrowserOnly>
  );
}
