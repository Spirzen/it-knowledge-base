...
import {
  ...
  KNOWLEDGE_LAYERS,
  MANIFEST_PRINCIPLES,
} from './shared/manifestPrinciplesEngine';
import styles from './ManifestPrinciplesPlay.module.css';
...
export default function ManifestPrinciplesPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка манифеста…')}>
      {() => <ManifestPrinciplesPlayInner />}
    </BrowserOnly>
  );
}
