...
import {
  ...
  symmetricDiff,
  union,
} from './shared/discreteMathEngine';
import styles from './DiscreteMathDemo.module.css';
...
export default function DiscreteMathDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Дискретная математика')}>
      {() => <DiscreteMathDemoInner />}
    </BrowserOnly>
  );
}
