...
import styles from './InternetCultureTimelinePlay.module.css';
...
export default function InternetCultureTimelinePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка хронологии…')}>
      {() => <InternetCultureTimelinePlayInner />}
    </BrowserOnly>
  );
}
