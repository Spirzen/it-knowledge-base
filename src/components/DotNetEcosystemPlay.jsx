...
import {
  ...
  STACK_SCENARIOS,
  getVariantMeta,
} from './shared/dotnetEcosystemEngine';
import baseStyles from './JavaDatabasePlay.module.css';
import styles from './DotNetEcosystemPlay.module.css';
...
export default function DotNetEcosystemPlay({variant = 'platform'}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка карты .NET…')}>
      {() => <DotNetEcosystemPlayInner variant={variant} />}
    </BrowserOnly>
  );
}
