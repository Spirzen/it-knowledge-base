...
import {
  ...
  runProcedure,
  runTriggerUpdate,
} from './shared/sqlProcedureTriggerEngine';
import styles from './SqlProcedureTriggerPlay.module.css';
...
export default function SqlProcedureTriggerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка процедур…')}>
      {() => <SqlProcedureTriggerPlayInner />}
    </BrowserOnly>
  );
}
