...
import {EMBEDDINGS, METRICS, nearest} from './shared/vectorSimilarityEngine';
import styles from './VectorSimilarityPlay.module.css';
...
export default function VectorSimilarityPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>{() => <VectorSimilarityPlayInner />}</BrowserOnly>
  );
}
