...
import styles from './ResponsiveViewportPlay.module.css';
...
export default function ResponsiveViewportPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка viewport…')}>
      {() => <ResponsiveViewportPlayInner />}
    </BrowserOnly>
  );
}
