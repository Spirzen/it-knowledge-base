...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/kotlinDatabaseEngine';
...
export default function KotlinDatabasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Kotlin + БД…')}>
      {() => <KotlinDatabasePlayInner />}
    </BrowserOnly>
  );
}
