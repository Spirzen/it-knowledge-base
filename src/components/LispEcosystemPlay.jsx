...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/lispEcosystemEngine';
import styles from './LispEcosystemPlay.module.css';
...
export default function LispEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Lisp…')}>
      {() => <LispEcosystemPlayInner />}
    </BrowserOnly>
  );
}
