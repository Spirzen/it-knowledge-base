...
import {DEFAULT_METRICS, scoreSupportHealth} from './shared/techSupportEngines';
...
export default function TechSupportMetricsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо метрик…')}>
      {() => <TechSupportMetricsPlayInner />}
    </BrowserOnly>
  );
}
