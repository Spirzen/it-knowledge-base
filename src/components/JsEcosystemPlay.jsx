...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/jsEcosystemEngine';
import styles from './JsEcosystemPlay.module.css';
...
export default function JsEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы JS…')}>
      {() => <JsEcosystemPlayInner />}
    </BrowserOnly>
  );
}
