...
import styles from './AttentionManipulationPlay.module.css';
...
export default function AttentionManipulationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка ленты…')}>
      {() => <AttentionManipulationPlayInner />}
    </BrowserOnly>
  );
}
