...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/elixirEcosystemEngine';
import styles from './ElixirEcosystemPlay.module.css';
...
export default function ElixirEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Elixir…')}>
      {() => <ElixirEcosystemPlayInner />}
    </BrowserOnly>
  );
}
