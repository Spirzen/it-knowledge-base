...
import {
  ...
  JS_IMPACTS,
} from './shared/jsRuntimeEngine';
import shared from './shared/runtimeDemo.module.css';
import styles from './JavaScriptRuntimePlay.module.css';
...
export default function JavaScriptRuntimePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо JavaScript…')}>
      {() => <JavaScriptRuntimePlayInner />}
    </BrowserOnly>
  );
}
