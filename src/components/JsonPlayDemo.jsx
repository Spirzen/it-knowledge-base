...
import {JSON_PRESETS, flattenJsonTree, parseJson} from './shared/jsonDemoEngine';
import styles from './JsonPlayDemo.module.css';
...
export default function JsonPlayDemo() {
  return (
