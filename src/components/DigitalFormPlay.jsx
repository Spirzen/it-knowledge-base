...
import styles from './DigitalFormPlay.module.css';
...
export default function DigitalFormPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка формы…')}>
      {() => <DigitalFormPlayInner />}
    </BrowserOnly>
  );
}
