...
import {
  ...
  startService,
  promoteHealth,
} from './shared/dockerComposeEngine';
import styles from './DockerComposePlay.module.css';
...
export default function DockerComposePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Compose…')}>
      {() => <DockerComposePlayInner />}
    </BrowserOnly>
  );
}
