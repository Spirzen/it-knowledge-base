...
import {GIT_TREE, flattenSelectable} from './shared/gitInternalsEngine';
import styles from './GitInternalsPlay.module.css';
...
export default function GitInternalsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <GitInternalsPlayInner />}
    </BrowserOnly>
  );
}
