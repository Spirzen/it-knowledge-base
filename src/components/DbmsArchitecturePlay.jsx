...
import styles from './DbmsArchitecturePlay.module.css';
...
export default function DbmsArchitecturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо СУБД…')}>
      {() => <DbmsArchitecturePlayInner />}
    </BrowserOnly>
  );
}
