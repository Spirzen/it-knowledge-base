...
import styles from './MobileDevicesPlay.module.css';
...
export default function MobileDevicesPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо мобильных устройств…')}>
      {() => <MobileDevicesPlayInner />}
    </BrowserOnly>
  );
}
