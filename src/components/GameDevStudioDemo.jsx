...
export default function GameDevStudioDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка студии геймдева…')}>
      {() => <GameDevStudioDemoInner />}
    </BrowserOnly>
  );
}
