...
import {GIT_WORKFLOW, applyWorkflowStep} from './shared/gitCommandsEngine';
import styles from './GitCommandsPlay.module.css';
...
export default function GitCommandsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <GitCommandsPlayInner />}
    </BrowserOnly>
  );
}
