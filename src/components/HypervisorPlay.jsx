...
import styles from './HypervisorPlay.module.css';
...
export default function HypervisorPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо виртуализации…')}>
      {() => <HypervisorPlayInner />}
    </BrowserOnly>
  );
}
