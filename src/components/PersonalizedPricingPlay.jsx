...
import {
  ...
  formatRub,
} from './shared/personalizedPricingEngine';
import styles from './PersonalizedPricingPlay.module.css';
...
export default function PersonalizedPricingPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <PersonalizedPricingPlayInner />}
    </BrowserOnly>
  );
}
