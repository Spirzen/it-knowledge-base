...
import styles from './ProcessorExecutionPlay.module.css';
...
export default function ProcessorExecutionPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка схемы процессора…')}>
      {() => <ProcessorExecutionPlayInner {...props} />}
    </BrowserOnly>
  );
}
