...
import styles from './TestingBasicsDemo.module.css';
...
export default function TestingBasicsDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо тестирования…')}>
      {() => <TestingBasicsDemoInner />}
    </BrowserOnly>
  );
}
