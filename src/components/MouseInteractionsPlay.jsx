...
import styles from './MouseInteractionsPlay.module.css';
...
export default function MouseInteractionsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо мыши…')}>
      {() => <MouseInteractionsPlayInner />}
    </BrowserOnly>
  );
}
