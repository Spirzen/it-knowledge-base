...
import {
  ...
  SOLUTION_TREE,
  TOOL_ITEMS,
} from './shared/aspnetArchitectureEngine';
import baseStyles from './JavaDatabasePlay.module.css';
import styles from './AspNetArchitecturePlay.module.css';
...
export default function AspNetArchitecturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка карты ASP.NET…')}>
      {() => <AspNetArchitecturePlayInner />}
    </BrowserOnly>
  );
}
