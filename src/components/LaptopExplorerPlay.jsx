...
import styles from './LaptopExplorerPlay.module.css';
...
export default function LaptopExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо ноутбуков…')}>
      {() => <LaptopExplorerPlayInner />}
    </BrowserOnly>
  );
}
