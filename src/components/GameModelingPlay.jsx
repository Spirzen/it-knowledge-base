...
import {
  ...
  drawModelPreview,
  modelingProgress,
} from './shared/gameModelingEngine';
import styles from './GameModelingPlay.module.css';
...
export default function GameModelingPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка моделирования…')}>
      {() => <GameModelingPlayInner />}
    </BrowserOnly>
  );
}
