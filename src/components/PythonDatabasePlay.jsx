...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/pythonDatabaseEngine';
...
export default function PythonDatabasePlay({variant = 'general', defaultMode}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Python + БД…')}>
      {() => <PythonDatabasePlayInner variant={variant} defaultMode={defaultMode} />}
    </BrowserOnly>
  );
}
