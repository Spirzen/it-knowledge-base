...
import styles from './VideoConferenceSimulator.module.css';
...
export default function VideoConferenceSimulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка видеосвязи…')}>
      {() => <VideoConferenceSimulatorInner {...props} />}
    </BrowserOnly>
  );
}
