...
import {
  ...
  drawGraphicsStage,
  stageProgress,
} from './shared/threeDGraphicsEngine';
import styles from './ThreeDGraphicsPlay.module.css';
...
export default function ThreeDGraphicsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка 3D-демо…')}>
      {() => <ThreeDGraphicsPlayInner />}
    </BrowserOnly>
  );
}
