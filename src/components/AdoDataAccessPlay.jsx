...
export default function AdoDataAccessPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо ADO / ADO.NET…')}>
      {() => <AdoDataAccessPlayInner />}
    </BrowserOnly>
  );
}
