...
import styles from './ConfluenceWikiDemo.module.css';
...
export default function ConfluenceWikiDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Confluence…')}>
      {() => <ConfluenceWikiDemoInner />}
    </BrowserOnly>
  );
}
