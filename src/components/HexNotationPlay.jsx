...
import styles from './HexNotationPlay.module.css';
...
export default function HexNotationPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка hex-демо…')}>
      {() => <HexNotationPlayInner {...props} />}
    </BrowserOnly>
  );
}
