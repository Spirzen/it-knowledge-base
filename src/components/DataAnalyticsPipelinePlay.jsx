...
import styles from './DataAnalyticsPipelinePlay.module.css';
...
export default function DataAnalyticsPipelinePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо анализа данных…')}>
      {() => <DataAnalyticsPipelinePlayInner />}
    </BrowserOnly>
  );
}
