...
import {PROCESS_DEMO, sleep} from './shared/concurrencyLifecycleEngine';
...
export default function ProcessLifecycleDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback}>{() => <ProcessLifecycleDemoInner />}</BrowserOnly>
  );
}
