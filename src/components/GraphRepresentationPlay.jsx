...
import {
  ...
  adjacencyMatrix,
  bfsSteps,
} from './shared/graphCodeEngine';
import styles from './GraphRepresentationPlay.module.css';
...
export default function GraphRepresentationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо графов…')}>
      {() => <GraphRepresentationPlayInner />}
    </BrowserOnly>
  );
}
