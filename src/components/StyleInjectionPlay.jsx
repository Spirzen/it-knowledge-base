...
import styles from './StyleInjectionPlay.module.css';
...
export default function StyleInjectionPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо инъекций…')}>
      {() => <StyleInjectionPlayInner />}
    </BrowserOnly>
  );
}
