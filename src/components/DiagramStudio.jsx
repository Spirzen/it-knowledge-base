...
import {
  ...
  loadTemplate,
  exportMermaid,
} from './shared/diagramStudioEngine';
...
export default function DiagramStudio(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка студии моделирования…')}>
      {() => <DiagramStudioInner {...props} />}
    </BrowserOnly>
  );
}
