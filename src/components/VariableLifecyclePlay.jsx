...
import styles from './VariableLifecyclePlay.module.css';
...
export default function VariableLifecyclePlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка жизненного цикла переменных…')}>
      {() => <VariableLifecyclePlayInner {...props} />}
    </BrowserOnly>
  );
}
