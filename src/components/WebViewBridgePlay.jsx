...
import styles from './WebViewBridgePlay.module.css';
...
export default function WebViewBridgePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка WebView…')}>
      {() => <WebViewBridgePlayInner />}
    </BrowserOnly>
  );
}
