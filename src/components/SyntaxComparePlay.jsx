...
import {SYNTAX_COMPARE_ROWS} from './shared/beginnerWebStackData';
import styles from './SyntaxComparePlay.module.css';
...
export default function SyntaxComparePlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка сравнения синтаксиса…')}>
      {() => <SyntaxComparePlayInner {...props} />}
    </BrowserOnly>
  );
}
