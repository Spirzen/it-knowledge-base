...
import styles from './CrossContextMemePlay.module.css';
...
export default function CrossContextMemePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка пайплайна…')}>
      {() => <CrossContextMemePlayInner />}
    </BrowserOnly>
  );
}
