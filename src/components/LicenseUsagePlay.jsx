...
import {
  ...
  LICENSE_BADGES,
  LICENSE_SCENARIOS,
} from './shared/licenseUsageEngine';
import styles from './LicenseUsagePlay.module.css';
...
export default function LicenseUsagePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка лицензии…')}>
      {() => <LicenseUsagePlayInner />}
    </BrowserOnly>
  );
}
