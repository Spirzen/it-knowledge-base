...
import {
  ...
  TURTLE_PROGRAMS,
  TURTLE_SPEEDS,
} from './shared/turtleEngine';
import shared from './shared/runtimeDemo.module.css';
import styles from './TurtleGraphicsSimulator.module.css';
...
export default function TurtleGraphicsSimulator() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <TurtleGraphicsSimulatorInner />}
    </BrowserOnly>
  );
}
