...
import {
  ...
  newBlock,
  publishSteps,
} from './shared/websiteBuilderEngine';
import styles from './WebsiteBuilderPlay.module.css';
...
export default function WebsiteBuilderPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка конструктора…')}>
      {() => <WebsiteBuilderPlayInner />}
    </BrowserOnly>
  );
}
