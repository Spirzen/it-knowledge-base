...
import styles from './PushNotificationPlay.module.css';
...
export default function PushNotificationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо push-уведомлений…')}>
      {() => <PushNotificationPlayInner />}
    </BrowserOnly>
  );
}
