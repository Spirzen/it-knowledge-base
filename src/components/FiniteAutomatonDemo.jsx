...
import {DFA_PRESETS, runDfa} from './shared/finiteAutomatonEngine';
import styles from './FiniteAutomatonDemo.module.css';
...
export default function FiniteAutomatonDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Конечный автомат')}>
      {() => <FiniteAutomatonDemoInner />}
    </BrowserOnly>
  );
}
