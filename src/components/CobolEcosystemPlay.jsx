...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/cobolEcosystemEngine';
import styles from './CobolEcosystemPlay.module.css';
...
export default function CobolEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры COBOL…')}>
      {() => <CobolEcosystemPlayInner />}
    </BrowserOnly>
  );
}
