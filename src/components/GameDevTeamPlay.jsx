...
import {DEV_ROLES, TEAM_HANDOFFS} from './shared/gameDevEngine';
...
export default function GameDevTeamPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка схемы команды…')}>
      {() => <GameDevTeamPlayInner />}
    </BrowserOnly>
  );
}
