...
import {FlowTrack} from './shared/flowTrack';
...
export default function SessionInteraction() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо сессий…')}>
      {() => <SessionInteractionInner />}
    </BrowserOnly>
  );
}
