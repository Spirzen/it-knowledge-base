...
import styles from './RequirementsAnalysisDemo.module.css';
...
export default function RequirementsAnalysisDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо анализа требований…')}>
      {() => <RequirementsAnalysisDemoInner />}
    </BrowserOnly>
  );
}
