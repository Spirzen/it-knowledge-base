...
import {
  ...
  signedFromTwos8,
  toU8,
} from './shared/bitRepresentationEngine';
...
export default function BitRepresentationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо битов…')}>
      {() => <BitRepresentationPlayInner />}
    </BrowserOnly>
  );
}
