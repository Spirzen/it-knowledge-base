...
import styles from './LanguageAbstractionPlay.module.css';
...
export default function LanguageAbstractionPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка башни абстракции…')}>
      {() => <LanguageAbstractionPlayInner {...props} />}
    </BrowserOnly>
  );
}
