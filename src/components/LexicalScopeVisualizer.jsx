...
import {
  ...
  formatValue,
  resolveVariable,
} from './shared/lexicalScopeEngine';
import shared from './shared/runtimeDemo.module.css';
import styles from './LexicalScopeVisualizer.module.css';
...
export default function LexicalScopeVisualizer() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <LexicalScopeVisualizerInner />}
    </BrowserOnly>
  );
}
