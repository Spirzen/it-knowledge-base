...
import {SCENARIOS, TOKEN_CLASS, getScenario, tokenizePythonLine} from './shared/ideWorkspaceEngine';
import styles from './IDEWorkspaceDemo.module.css';
...
export default function IDEWorkspaceDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <IDEWorkspaceDemoInner />}
    </BrowserOnly>
  );
}
