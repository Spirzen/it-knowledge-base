...
import {SUPPORT_CHANNELS, SUPPORT_TASKS} from './shared/techSupportEngines';
...
export default function TechSupportOverviewPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо техподдержки…')}>
      {() => <TechSupportOverviewPlayInner />}
    </BrowserOnly>
  );
}
