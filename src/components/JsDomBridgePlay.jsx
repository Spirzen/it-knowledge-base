...
import {
  ...
  getNodeText,
  getPathToNode,
} from './shared/jsDomBridgeEngine';
import toolStyles from './shared/toolDemo.module.css';
import styles from './JsDomBridgePlay.module.css';
...
export default function JsDomBridgePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо DOM…')}>
      {() => <JsDomBridgePlayInner />}
    </BrowserOnly>
  );
}
