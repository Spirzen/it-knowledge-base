...
import {
  ...
  minCodeLengthBits,
  shannonEntropy,
} from './shared/entropyEngine';
import styles from './InformationEntropyDemo.module.css';
...
export default function InformationEntropyDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Энтропия')}>
      {() => <InformationEntropyDemoInner />}
    </BrowserOnly>
  );
}
