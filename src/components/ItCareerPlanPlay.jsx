...
import {
  ...
  marketModifier,
  rankedRoles,
} from './shared/itCareerPlanEngine';
import styles from './ItCareerPlanPlay.module.css';
...
export default function ItCareerPlanPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка планировщика…')}>
      {() => <ItCareerPlanPlayInner />}
    </BrowserOnly>
  );
}
