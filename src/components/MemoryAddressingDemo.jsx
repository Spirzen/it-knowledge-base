...
import styles from './MemoryAddressingDemo.module.css';
...
export default function MemoryAddressingDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо адресации памяти…')}>
      {() => <MemoryAddressingDemoInner />}
    </BrowserOnly>
  );
}
