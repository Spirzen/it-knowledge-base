...
import DesktopAppChrome from './shared/DesktopAppChrome';
...
import {
  ...
  getModuleCode,
  runBslDemo,
} from './shared/oneCEngine';
import styles from './OneCPlatformEmulator.module.css';
...
export default function OneCPlatformEmulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка эмулятора 1С…')}>
      {() => <OneCPlatformEmulatorInner {...props} />}
    </BrowserOnly>
  );
}
