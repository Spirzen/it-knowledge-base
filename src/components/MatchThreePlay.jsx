...
import {
  ...
  isAdjacent,
  swapCells,
} from './shared/matchThreeEngine';
import styles from './MatchThreePlay.module.css';
...
export default function MatchThreePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка игры…')}>
      {() => <MatchThreePlayInner />}
    </BrowserOnly>
  );
}
