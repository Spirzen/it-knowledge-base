...
import {getFranchise, RELEASE_TYPES} from './shared/gameFranchiseData';
import styles from './gameStudiesPlays.module.css';
...
export default function GameFranchisePlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка обзора серии…')}>
      {() => <GameFranchisePlayInner {...props} />}
    </BrowserOnly>
  );
}
