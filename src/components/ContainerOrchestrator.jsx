...
import {
  ...
  makeContainer,
  scalePods,
} from './shared/orchestratorEngine';
import styles from './ContainerOrchestrator.module.css';
...
export default function ContainerOrchestrator() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо контейнеризации…')}>
      {() => <ContainerOrchestratorInner />}
    </BrowserOnly>
  );
}
