...
import styles from './OutlookMailPlay.module.css';
...
export default function OutlookMailPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Outlook…')}>
      {() => <OutlookMailPlayInner />}
    </BrowserOnly>
  );
}
