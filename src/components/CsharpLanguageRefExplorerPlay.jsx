...
import {CSHARP_LANGUAGE_REF_CATALOG} from './shared/csharpLanguageRefCatalog';
...
export default function CsharpLanguageRefExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка справочника C#…')}>
      {() => <CsharpLanguageRefExplorerPlayInner />}
    </BrowserOnly>
  );
}
