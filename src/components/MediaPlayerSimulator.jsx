...
import styles from './MediaPlayerSimulator.module.css';
...
export default function MediaPlayerSimulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка плеера…')}>
      {() => <MediaPlayerSimulatorInner {...props} />}
    </BrowserOnly>
  );
}
