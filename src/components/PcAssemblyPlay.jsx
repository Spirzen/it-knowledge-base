...
import {BUILD_STEPS, PART_LABELS, stepProgress} from './shared/pcAssemblyEngine';
import styles from './PcAssemblyPlay.module.css';
...
export default function PcAssemblyPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо сборки ПК…')}>
      {() => <PcAssemblyPlayInner />}
    </BrowserOnly>
  );
}
