...
import {
  ...
  hitRatioSimulation,
  totalLatencyForStep,
} from './shared/cdnCacheEmulatorEngine';
import styles from './CdnCacheEmulatorPlay.module.css';
...
export default function CdnCacheEmulatorPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка эмулятора CDN…')}>
      {() => <CdnCacheEmulatorPlayInner />}
    </BrowserOnly>
  );
}
