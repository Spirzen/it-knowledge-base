...
import {
  ...
  pickQuizOptions,
  shuffleArray,
} from './shared/englishVocabulary';
import widgetStyles from './shared/articleWidgets.module.css';
import toolStyles from './shared/toolDemo.module.css';
import styles from './EnglishVocabularyTrainer.module.css';
...
export default function EnglishVocabularyTrainer() {
  return (
    <BrowserOnly fallback={demoSkeletonFallback()}>
      {() => <EnglishVocabularyTrainerInner />}
    </BrowserOnly>
  );
}
