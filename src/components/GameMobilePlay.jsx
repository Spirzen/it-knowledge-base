...
import {GAME_ENGINES, MOBILE_OS} from './shared/gameDevEngine';
...
export default function GameMobilePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка мобильных платформ…')}>
      {() => <GameMobilePlayInner />}
    </BrowserOnly>
  );
}
