...
import {PNL_PRESETS, calcPnL, formatRub} from './shared/businessFinanceEngine';
import styles from './BusinessFinancePlay.module.css';
...
export default function BusinessFinancePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <BusinessFinancePlayInner />}
    </BrowserOnly>
  );
}
