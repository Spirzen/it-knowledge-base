...
export const ECOSYSTEM_LAYERS = [
  {
    ...
    detail:
      'Исходники (.cpp/.h) проходят препроцессор, компиляцию в объектные файлы (.o/.obj) и линковку в исполняемый файл или библиотеку (.a/.so/.dll). CMake — де-факто стандарт описания сборки кроссплатформенно.',
  },
  {
    id: 'stdlib',
    tag: 'Стандарт',
