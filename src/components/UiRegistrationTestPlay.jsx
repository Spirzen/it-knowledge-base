...
import {REGISTRATION_SCENARIOS, validateRegistration} from './shared/testingPlayEngines';
import styles from './shared/testingDemo.module.css';
...
export default function UiRegistrationTestPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback}>
      {() => <UiRegistrationTestPlayInner />}
    </BrowserOnly>
  );
}
