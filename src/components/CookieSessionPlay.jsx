...
import {SCENARIOS} from './shared/cookieSessionEngine';
import styles from './CookieSessionPlay.module.css';
...
export default function CookieSessionPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо cookie…')}>
      {() => <CookieSessionPlayInner />}
    </BrowserOnly>
  );
}
