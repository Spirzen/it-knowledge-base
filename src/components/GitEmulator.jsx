...
import {
  ...
  switchBranch,
  unstageFile,
} from './shared/gitEngine';
import styles from './GitEmulator.module.css';
...
export default function GitEmulator() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Git Emulator…')}>
      {() => <GitEmulatorInner />}
    </BrowserOnly>
  );
}
