...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/groovyDatabaseEngine';
...
export default function GroovyDatabasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Groovy + БД…')}>
      {() => <GroovyDatabasePlayInner />}
    </BrowserOnly>
  );
}
