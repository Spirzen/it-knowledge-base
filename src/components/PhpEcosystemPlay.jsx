...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/phpEcosystemEngine';
import styles from './PhpEcosystemPlay.module.css';
...
export default function PhpEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы PHP…')}>
      {() => <PhpEcosystemPlayInner />}
    </BrowserOnly>
  );
}
