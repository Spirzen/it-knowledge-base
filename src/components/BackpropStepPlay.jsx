...
import styles from './BackpropStepPlay.module.css';
...
export default function BackpropStepPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка backprop…')}>
      {() => <BackpropStepPlayInner />}
    </BrowserOnly>
  );
}
