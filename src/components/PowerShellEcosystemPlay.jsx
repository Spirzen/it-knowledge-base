...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/powershellEcosystemEngine';
import styles from './PowerShellEcosystemPlay.module.css';
...
export default function PowerShellEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы PowerShell…')}>
      {() => <PowerShellEcosystemPlayInner />}
    </BrowserOnly>
  );
}
