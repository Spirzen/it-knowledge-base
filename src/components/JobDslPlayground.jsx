...
import {JOB_DSL_PRESETS, SEED_FLOW, getPreset} from './shared/groovyJobDslEngine';
import toolStyles from './shared/toolDemo.module.css';
import styles from './JobDslPlayground.module.css';
...
export default function JobDslPlayground() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Job DSL Playground')}>
      {() => <JobDslPlaygroundInner />}
    </BrowserOnly>
  );
}
