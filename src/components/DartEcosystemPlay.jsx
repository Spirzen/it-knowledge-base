...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/dartEcosystemEngine';
import styles from './DartEcosystemPlay.module.css';
...
export default function DartEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры Dart…')}>
      {() => <DartEcosystemPlayInner />}
    </BrowserOnly>
  );
}
