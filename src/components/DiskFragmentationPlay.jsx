...
import {
  ...
  presetDisk,
  simulateRead,
} from './shared/diskFragmentationEngine';
import styles from './DiskFragmentationPlay.module.css';
...
export default function DiskFragmentationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора диска…')}>
      {() => <DiskFragmentationPlayInner />}
    </BrowserOnly>
  );
}
