...
import {
  ...
  tryDirectNameAccess,
  tryExternalAccess,
} from './shared/oopEncapsulationEngine';
import shared from './shared/runtimeDemo.module.css';
import styles from './OopEncapsulationDemo.module.css';
...
export default function OopEncapsulationDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <OopEncapsulationDemoInner />}
    </BrowserOnly>
  );
}
