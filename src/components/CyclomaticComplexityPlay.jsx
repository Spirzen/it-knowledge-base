...
import {
  ...
  complexityZone,
  minTestsNeeded,
} from './shared/cyclomaticEngine';
import styles from './CyclomaticComplexityPlay.module.css';
...
export default function CyclomaticComplexityPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <CyclomaticComplexityPlayInner />}
    </BrowserOnly>
  );
}
