...
import {VIDEO_FILTERS, VIDEO_TOOLS} from './shared/toolsNetworkData';
...
export default function VideoConferencingCatalogPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка каталога…')}>
      {() => <VideoConferencingCatalogPlayInner />}
    </BrowserOnly>
  );
}
