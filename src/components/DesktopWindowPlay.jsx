...
import styles from './DesktopWindowPlay.module.css';
...
export default function DesktopWindowPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка окна ОС…')}>
      {() => <DesktopWindowPlayInner />}
    </BrowserOnly>
  );
}
