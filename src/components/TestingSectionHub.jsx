...
import styles from './TestingSectionHub.module.css';
...
export default function TestingSectionHub() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка хаба тестирования…')}>
      {() => <TestingSectionHubInner />}
    </BrowserOnly>
  );
}
