...
import styles from './FigmaPrototypeStudio.module.css';
...
export default function FigmaPrototypeStudio() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора Figma…')}>
      {() => <FigmaPrototypeStudioInner />}
    </BrowserOnly>
  );
}
