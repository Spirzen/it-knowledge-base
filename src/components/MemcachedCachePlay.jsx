...
import styles from './MemcachedCachePlay.module.css';
...
export default function MemcachedCachePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>{() => <MemcachedCachePlayInner />}</BrowserOnly>
  );
}
