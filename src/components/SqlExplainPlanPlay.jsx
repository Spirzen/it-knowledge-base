...
import {
  ...
  buildIndexEntries,
  simulatePlan,
} from './shared/sqlExplainPlanEngine';
import styles from './SqlExplainPlanPlay.module.css';
...
export default function SqlExplainPlanPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка плана запроса…')}>
      {() => <SqlExplainPlanPlayInner />}
    </BrowserOnly>
  );
}
