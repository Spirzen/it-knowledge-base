...
import {BROWSER_ENGINE_FILTERS, BROWSERS} from './shared/toolsNetworkData';
...
export default function BrowserCatalogPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка каталога браузеров…')}>
      {() => <BrowserCatalogPlayInner />}
    </BrowserOnly>
  );
}
