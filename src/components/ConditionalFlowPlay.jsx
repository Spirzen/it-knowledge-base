...
import styles from './ConditionalFlowPlay.module.css';
...
export default function ConditionalFlowPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора условий…')}>
      {() => <ConditionalFlowPlayInner {...props} />}
    </BrowserOnly>
  );
}
