...
} from './shared/undefinedBehaviorEngine';
import styles from './UndefinedBehaviorDemo.module.css';
...
export default function UndefinedBehaviorDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо неопределённого поведения…')}>
      {() => <UndefinedBehaviorDemoInner />}
    </BrowserOnly>
  );
}
