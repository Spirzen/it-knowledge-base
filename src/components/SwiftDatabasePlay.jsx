...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/swiftDatabaseEngine';
...
export default function SwiftDatabasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Swift + БД…')}>
      {() => <SwiftDatabasePlayInner />}
    </BrowserOnly>
  );
}
