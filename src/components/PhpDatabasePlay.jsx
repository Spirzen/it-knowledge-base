...
export default function PhpDatabasePlay({defaultMode = 'form'}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо PHP + БД…')}>
      {() => <PhpDatabasePlayInner defaultMode={defaultMode} />}
    </BrowserOnly>
  );
}
