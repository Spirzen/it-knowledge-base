...
import {KB_COMPONENTS, searchKb} from './shared/techSupportEngines';
import styles from './shared/techSupportDemo.module.css';
...
export default function TechSupportKnowledgeBasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо базы знаний…')}>
      {() => <TechSupportKnowledgeBasePlayInner />}
    </BrowserOnly>
  );
}
