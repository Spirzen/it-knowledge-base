...
import {INFRA_LAYERS, INFRA_LINKS, describeLayer} from './shared/itInfrastructureEngine';
import styles from './ItInfrastructurePlay.module.css';
...
export default function ItInfrastructurePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка инфраструктуры…')}>
      {() => <ItInfrastructurePlayInner />}
    </BrowserOnly>
  );
}
