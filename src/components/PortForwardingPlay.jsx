...
import styles from './PortForwardingPlay.module.css';
...
export default function PortForwardingPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо NAT…')}>
      {() => <PortForwardingPlayInner />}
    </BrowserOnly>
  );
}
