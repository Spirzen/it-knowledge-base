...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/bashEcosystemEngine';
import styles from './BashEcosystemPlay.module.css';
...
export default function BashEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Bash…')}>
      {() => <BashEcosystemPlayInner />}
    </BrowserOnly>
  );
}
