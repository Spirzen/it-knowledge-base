...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/cEcosystemEngine';
import styles from './CEcosystemPlay.module.css';
...
export default function CEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы С…')}>
      {() => <CEcosystemPlayInner />}
    </BrowserOnly>
  );
}
