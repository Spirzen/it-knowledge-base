...
export default function DeadCodeScannerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка анализатора…')}>
      {() => <DeadCodeScannerPlayInner />}
    </BrowserOnly>
  );
}
