...
import {
  ...
  describePanel,
  drawBlenderViewport,
} from './shared/blenderWorkspaceEngine';
import styles from './BlenderWorkspacePlay.module.css';
...
export default function BlenderWorkspacePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Blender…')}>
      {() => <BlenderWorkspacePlayInner />}
    </BrowserOnly>
  );
}
