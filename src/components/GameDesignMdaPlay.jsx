...
import {MDA_EXAMPLES, MDA_LOOP} from './shared/gameDevEngine';
...
export default function GameDesignMdaPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка MDA…')}>
      {() => <GameDesignMdaPlayInner />}
    </BrowserOnly>
  );
}
