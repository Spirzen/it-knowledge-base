...
import {normalizeCode} from './shared/keyboardLayout';
import {
  BUMP_KEYS,
  DRILL_KEYS,
  FINGER_META,
  ...
  fingerForKey,
  labelForKey,
} from './shared/touchTypingLayout';
import styles from './TouchTypingFingerPlay.module.css';
...
export default function TouchTypingFingerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка схемы пальцев…')}>
      {() => <TouchTypingFingerPlayInner />}
    </BrowserOnly>
  );
}
