...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/cppEcosystemEngine';
import styles from './CppEcosystemPlay.module.css';
...
export default function CppEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы C++…')}>
      {() => <CppEcosystemPlayInner />}
    </BrowserOnly>
  );
}
