...
import {INSTALL_STEPS, installProgress} from './shared/osInstallFlowEngine';
import styles from './OsInstallFlowPlay.module.css';
...
export default function OsInstallFlowPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка установки ОС…')}>
      {() => <OsInstallFlowPlayInner />}
    </BrowserOnly>
  );
}
