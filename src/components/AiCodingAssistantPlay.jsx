...
import styles from './AiCodingAssistantPlay.module.css';
...
export default function AiCodingAssistantPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо AI-ассистента…')}>
      {() => <AiCodingAssistantPlayInner />}
    </BrowserOnly>
  );
}
