...
import {
  ...
  computeSalesSummary,
  bumpSourceSales,
} from './shared/sqlViewEngine';
import styles from './SqlViewPlay.module.css';
...
export default function SqlViewPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка VIEW…')}>
      {() => <SqlViewPlayInner />}
    </BrowserOnly>
  );
}
