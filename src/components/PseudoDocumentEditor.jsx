...
import styles from './PseudoDocumentEditor.module.css';
...
export default function PseudoDocumentEditor() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка редактора…')}>
      {() => <PseudoDocumentEditorInner />}
    </BrowserOnly>
  );
}
