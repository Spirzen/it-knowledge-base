...
import {LINTER_LANGS, LINTER_SAMPLES, LINTERS} from './shared/toolsTestingData';
...
export default function LinterLivePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка линтера…')}>
      {() => <LinterLivePlayInner />}
    </BrowserOnly>
  );
}
