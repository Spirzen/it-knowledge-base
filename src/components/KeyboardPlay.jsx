...
import styles from './KeyboardPlay.module.css';
...
export default function KeyboardPlay({variant = 'explorer'}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка клавиатуры…')}>
      {() => <KeyboardPlayInner variant={variant} />}
    </BrowserOnly>
  );
}
