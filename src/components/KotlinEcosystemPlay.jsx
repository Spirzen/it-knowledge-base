...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/kotlinEcosystemEngine';
import styles from './KotlinEcosystemPlay.module.css';
...
export default function KotlinEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Kotlin…')}>
      {() => <KotlinEcosystemPlayInner />}
    </BrowserOnly>
  );
}
