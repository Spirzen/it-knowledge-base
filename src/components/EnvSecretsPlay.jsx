...
import {MODES, SECRET_KEYS, scanText} from './shared/envSecretsEngine';
import styles from './EnvSecretsPlay.module.css';
...
export default function EnvSecretsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо секретов…')}>
      {() => <EnvSecretsPlayInner />}
    </BrowserOnly>
  );
}
