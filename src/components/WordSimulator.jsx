...
import styles from './WordSimulator.module.css';
...
export default function WordSimulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Word…')}>
      {() => <WordSimulatorInner {...props} />}
    </BrowserOnly>
  );
}
