...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/goEcosystemEngine';
import styles from './GoEcosystemPlay.module.css';
...
export default function GoEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Go…')}>
      {() => <GoEcosystemPlayInner />}
    </BrowserOnly>
  );
}
