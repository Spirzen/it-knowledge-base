...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/vbArchitectureEngine';
import styles from './VbArchitecturePlay.module.css';
...
export default function VbArchitecturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры Visual Basic…')}>
      {() => <VbArchitecturePlayInner />}
    </BrowserOnly>
  );
}
