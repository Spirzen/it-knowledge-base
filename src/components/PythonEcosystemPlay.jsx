...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/pythonEcosystemEngine';
import styles from './PythonEcosystemPlay.module.css';
...
export default function PythonEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Python…')}>
      {() => <PythonEcosystemPlayInner />}
    </BrowserOnly>
  );
}
