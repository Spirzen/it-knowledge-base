...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/juliaEcosystemEngine';
import styles from './JuliaEcosystemPlay.module.css';
...
export default function JuliaEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Julia…')}>
      {() => <JuliaEcosystemPlayInner />}
    </BrowserOnly>
  );
}
