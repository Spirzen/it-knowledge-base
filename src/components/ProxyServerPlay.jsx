...
import {SCENARIOS} from './shared/proxyServerEngine';
import styles from './ProxyServerPlay.module.css';
...
export default function ProxyServerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо прокси…')}>
      {() => <ProxyServerPlayInner />}
    </BrowserOnly>
  );
}
