...
import styles from './DocumentationArchitecturePlay.module.css';
...
export default function DocumentationArchitecturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка…')}>
      {() => <DocumentationArchitecturePlayInner />}
    </BrowserOnly>
  );
}
