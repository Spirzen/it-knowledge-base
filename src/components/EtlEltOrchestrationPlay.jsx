...
import styles from './IntegrationDataFlowPlay.module.css';
...
export default function EtlEltOrchestrationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка ETL/ELT…')}>
      {() => <EtlEltOrchestrationPlayInner />}
    </BrowserOnly>
  );
}
