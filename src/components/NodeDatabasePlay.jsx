...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/nodeDatabaseEngine';
...
export default function NodeDatabasePlay({defaultMode}) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо Node.js + БД…')}>
      {() => <NodeDatabasePlayInner defaultMode={defaultMode} />}
    </BrowserOnly>
  );
}
