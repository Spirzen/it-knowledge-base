...
import styles from './CssTransitionPlay.module.css';
...
export default function CssTransitionPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка transitions…')}>
      {() => <CssTransitionPlayInner />}
    </BrowserOnly>
  );
}
