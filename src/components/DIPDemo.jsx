...
import {BENEFITS, CODE_BAD, CODE_GOOD, DEVICES, getDevice} from './shared/dipEngine';
import styles from './DIPDemo.module.css';
...
export default function DIPDemo() {
  return <BrowserOnly fallback={demoLoadingFallback()}>{() => <DIPDemoInner />}</BrowserOnly>;
}
