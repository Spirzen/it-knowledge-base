...
import {FRAME_BUDGET_MS, OPT_TECHNIQUES} from './shared/gameDevEngine';
...
export default function GameOptimizationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора FPS…')}>
      {() => <GameOptimizationPlayInner />}
    </BrowserOnly>
  );
}
