...
import {
  ...
  SCAFFOLD_TEMPLATES,
  WATCH_SCENARIOS,
} from './shared/devAutomationEngine';
...
export default function DevAutomationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо автоматизации…')}>
      {() => <DevAutomationPlayInner />}
    </BrowserOnly>
  );
}
