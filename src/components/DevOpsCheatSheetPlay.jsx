...
import {CHEAT_CATEGORIES} from './shared/devOpsCheatSheetEngine';
import styles from './DevOpsCheatSheetPlay.module.css';
...
export default function DevOpsCheatSheetPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка шпаргалки…')}>
      {() => <DevOpsCheatSheetPlayInner />}
    </BrowserOnly>
  );
}
