...
import styles from './TechSupportLevelsPlay.module.css';
...
export default function TechSupportLevelsPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо уровней поддержки…')}>
      {() => <TechSupportLevelsPlayInner />}
    </BrowserOnly>
  );
}
