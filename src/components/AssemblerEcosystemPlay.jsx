...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/assemblerEcosystemEngine';
import styles from './AssemblerEcosystemPlay.module.css';
...
export default function AssemblerEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры ассемблера…')}>
      {() => <AssemblerEcosystemPlayInner />}
    </BrowserOnly>
  );
}
