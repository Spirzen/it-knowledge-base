...
import styles from './MemeLifecyclePlay.module.css';
...
export default function MemeLifecyclePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка цикла…')}>
      {() => <MemeLifecyclePlayInner />}
    </BrowserOnly>
  );
}
