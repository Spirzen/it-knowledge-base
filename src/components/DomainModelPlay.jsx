...
import styles from './DomainModelPlay.module.css';
...
export default function DomainModelPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка DDD…')}>
      {() => <DomainModelPlayInner />}
    </BrowserOnly>
  );
}
