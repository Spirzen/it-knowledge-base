...
import {
  ...
  TYPE_LABELS,
  formatDuration,
} from './shared/microsoftLearnCatalog';
...
export default function MicrosoftLearnExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка навигатора Learn…')}>
      {() => <MicrosoftLearnExplorerPlayInner />}
    </BrowserOnly>
  );
}
