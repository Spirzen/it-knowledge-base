...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/pascalEcosystemEngine';
import styles from './PascalEcosystemPlay.module.css';
...
export default function PascalEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Pascal…')}>
      {() => <PascalEcosystemPlayInner />}
    </BrowserOnly>
  );
}
