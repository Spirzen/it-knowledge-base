...
import {
  ...
  buildRecursiveTree,
  computeCteStep,
} from './shared/sqlCteEngine';
import styles from './SqlCtePlay.module.css';
...
export default function SqlCtePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка CTE…')}>
      {() => <SqlCtePlayInner />}
    </BrowserOnly>
  );
}
