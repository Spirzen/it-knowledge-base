...
import {
  ...
  VERSION_STRATEGIES,
  buildVersionPreview,
} from './shared/apiDesignEngine';
import styles from './ApiDesignPlay.module.css';
...
export default function ApiDesignPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо API…')}>
      {() => <ApiDesignPlayInner />}
    </BrowserOnly>
  );
}
