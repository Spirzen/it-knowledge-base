...
import {
  ...
  getFileContent,
  getStep,
} from './shared/refactoringEngine';
import styles from './RefactoringDemo.module.css';
...
export default function RefactoringDemo() {
  return <BrowserOnly fallback={demoLoadingFallback()}>{() => <RefactoringDemoInner />}</BrowserOnly>;
}
