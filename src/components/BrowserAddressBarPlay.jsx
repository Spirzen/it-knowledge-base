...
import styles from './BrowserAddressBarPlay.module.css';
...
export default function BrowserAddressBarPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо адресной строки…')}>
      {() => <BrowserAddressBarPlayInner />}
    </BrowserOnly>
  );
}
