...
import {LAYERS, isDependencyAllowed} from './shared/cleanArchLayersEngine';
import styles from './CleanArchitectureLayersPlay.module.css';
...
export default function CleanArchitectureLayersPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <CleanArchitectureLayersPlayInner />}
    </BrowserOnly>
  );
}
