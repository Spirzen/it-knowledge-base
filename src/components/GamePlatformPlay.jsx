...
import {GAME_PLATFORMS} from './shared/gameDevEngine';
import {PlatformVisual} from './GamePlatformVisuals';
...
export default function GamePlatformPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка платформы…')}>
      {() => <GamePlatformPlayInner {...props} />}
    </BrowserOnly>
  );
}
