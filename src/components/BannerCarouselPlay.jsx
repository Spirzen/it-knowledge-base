...
import {
  ...
  DEFAULT_AUTOPLAY_MS,
  PromoCarousel,
} from './shared/bannerCarouselEngine';
import styles from './BannerCarouselPlay.module.css';
...
export default function BannerCarouselPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка карусели…')}>
      {() => <BannerCarouselPlayInner />}
    </BrowserOnly>
  );
}
