...
import {
  ...
  runCrud,
  sqlForOp,
} from './shared/csharpDatabaseEngine';
...
export default function CsharpDatabasePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо C# + БД…')}>
      {() => <CsharpDatabasePlayInner />}
    </BrowserOnly>
  );
}
