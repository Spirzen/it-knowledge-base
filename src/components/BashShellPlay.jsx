...
import {
  ...
  getLesson,
  getWelcomeLines,
} from './shared/bashShellEngine';
import terminalStyles from './TerminalEmulator.module.css';
import styles from './BashShellPlay.module.css';
...
export default function BashShellPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Bash…')}>
      {() => <BashShellPlayInner {...props} />}
    </BrowserOnly>
  );
}
