...
import styles from './PacketCapturePlay.module.css';
...
export default function PacketCapturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо захвата пакетов…')}>
      {() => <PacketCapturePlayInner />}
    </BrowserOnly>
  );
}
