...
import styles from './CpuRegistersPlay.module.css';
...
export default function CpuRegistersPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка регистров CPU…')}>
      {() => <CpuRegistersPlayInner {...props} />}
    </BrowserOnly>
  );
}
