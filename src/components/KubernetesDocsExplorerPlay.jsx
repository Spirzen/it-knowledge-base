...
import {K8S_DOC_FILTERS, KUBERNETES_DOC_ITEMS} from './shared/kubernetesDocsCatalog';
...
export default function KubernetesDocsExplorerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка навигатора Kubernetes…')}>
      {() => <KubernetesDocsExplorerPlayInner />}
    </BrowserOnly>
  );
}
