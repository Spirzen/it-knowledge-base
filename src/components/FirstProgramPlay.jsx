...
import {
  ...
  getLangConfig,
  stepIndexForId,
} from './shared/firstProgramEngine';
import styles from './FirstProgramPlay.module.css';
...
export default function FirstProgramPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора первой программы…')}>
      {() => <FirstProgramPlayInner {...props} />}
    </BrowserOnly>
  );
}
