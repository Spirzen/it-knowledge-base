...
import styles from './JiraTaskTrackerDemo.module.css';
...
export default function JiraTaskTrackerDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка симулятора Jira…')}>
      {() => <JiraTaskTrackerDemoInner />}
    </BrowserOnly>
  );
}
