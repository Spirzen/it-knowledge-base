...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/fortranEcosystemEngine';
import styles from './FortranEcosystemPlay.module.css';
...
export default function FortranEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка архитектуры Fortran…')}>
      {() => <FortranEcosystemPlayInner />}
    </BrowserOnly>
  );
}
