...
import {ENGINE_SUBSYSTEMS, FRAME_BUDGET_MS} from './shared/gameDevEngine';
...
export default function GameEnginePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка схемы движка…')}>
      {() => <GameEnginePlayInner />}
    </BrowserOnly>
  );
}
