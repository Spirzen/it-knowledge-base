...
import styles from './CommunityCoordinationPlay.module.css';
...
export default function CommunityCoordinationPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка модели…')}>
      {() => <CommunityCoordinationPlayInner />}
    </BrowserOnly>
  );
}
