...
import {META_PHASES} from './shared/metaprogrammingPhasesEngine';
import styles from './MetaprogrammingPhasesPlay.module.css';
...
export default function MetaprogrammingPhasesPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо метапрограммирования…')}>
      {() => <MetaprogrammingPhasesPlayInner />}
    </BrowserOnly>
  );
}
