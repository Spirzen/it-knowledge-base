...
import {CLUSTER_NODES, QUERY_SCENARIOS, simulateQuery} from './shared/cassandraPartitionEngine';
import styles from './CassandraPartitionPlay.module.css';
...
export default function CassandraPartitionPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>{() => <CassandraPartitionPlayInner />}</BrowserOnly>
  );
}
