...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/rubyEcosystemEngine';
import styles from './RubyEcosystemPlay.module.css';
...
export default function RubyEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Ruby…')}>
      {() => <RubyEcosystemPlayInner />}
    </BrowserOnly>
  );
}
