...
import {SAMPLE_PROJECTS} from './shared/petProjectPlannerEngine';
import styles from './DeveloperPortfolioPlay.module.css';
...
export default function DeveloperPortfolioPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <DeveloperPortfolioPlayInner />}
    </BrowserOnly>
  );
}
