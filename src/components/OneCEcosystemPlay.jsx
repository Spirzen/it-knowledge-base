...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/oneCEcosystemEngine';
import styles from './OneCEcosystemPlay.module.css';
...
export default function OneCEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы 1С…')}>
      {() => <OneCEcosystemPlayInner />}
    </BrowserOnly>
  );
}
