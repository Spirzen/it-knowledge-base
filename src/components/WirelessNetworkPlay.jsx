...
import {SCENARIOS, TECH} from './shared/wirelessNetworkEngine';
import styles from './WirelessNetworkPlay.module.css';
...
export default function WirelessNetworkPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо беспроводных сетей…')}>
      {() => <WirelessNetworkPlayInner />}
    </BrowserOnly>
  );
}
