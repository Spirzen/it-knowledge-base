...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/zigEcosystemEngine';
import styles from './ZigEcosystemPlay.module.css';
...
export default function ZigEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Zig…')}>
      {() => <ZigEcosystemPlayInner />}
    </BrowserOnly>
  );
}
