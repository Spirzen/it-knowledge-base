...
import {RCA_CAUSES, TICKET_FLOW_STEPS} from './shared/techSupportEngines';
...
export default function TechSupportTicketFlowPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо тикета…')}>
      {() => <TechSupportTicketFlowPlayInner />}
    </BrowserOnly>
  );
}
