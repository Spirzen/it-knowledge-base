...
import {
  ...
  rollRogueEvent,
  tryPuzzleMove,
} from './shared/gameGenreToysEngine';
import styles from './GameGenreToysPlay.module.css';
...
export default function GameGenreToyPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка мини-игры…')}>
      {() => <GameGenreToyPlayInner {...props} />}
    </BrowserOnly>
  );
}
