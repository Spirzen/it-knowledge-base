...
import {PROMISE_DEMO, sleep} from './shared/concurrencyLifecycleEngine';
...
export default function PromiseAsyncDemo() {
  return <BrowserOnly fallback={demoLoadingFallback}>{() => <PromiseAsyncDemoInner />}</BrowserOnly>;
}
