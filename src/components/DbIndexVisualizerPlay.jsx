...
import {
  ...
  simulateInsert,
  simulateQuery,
} from './shared/dbIndexVisualizerEngine';
import styles from './DbIndexVisualizerPlay.module.css';
...
export default function DbIndexVisualizerPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <DbIndexVisualizerPlayInner />}
    </BrowserOnly>
  );
}
