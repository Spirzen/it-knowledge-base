...
import {PROTOCOLS, SCENARIOS} from './shared/vpnTunnelEngine';
import styles from './VpnTunnelPlay.module.css';
...
export default function VpnTunnelPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо VPN…')}>
      {() => <VpnTunnelPlayInner />}
    </BrowserOnly>
  );
}
