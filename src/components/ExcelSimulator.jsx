...
import styles from './ExcelSimulator.module.css';
...
export default function ExcelSimulator(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка Excel…')}>
      {() => <ExcelSimulatorInner {...props} />}
    </BrowserOnly>
  );
}
