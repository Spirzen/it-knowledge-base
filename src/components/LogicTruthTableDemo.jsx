...
import styles from './LogicTruthTableDemo.module.css';
...
export default function LogicTruthTableDemo() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Таблица истинности')}>
      {() => <LogicTruthTableDemoInner />}
    </BrowserOnly>
  );
}
