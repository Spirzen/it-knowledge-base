...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from './shared/nimEcosystemEngine';
import styles from './NimEcosystemPlay.module.css';
...
export default function NimEcosystemPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка экосистемы Nim…')}>
      {() => <NimEcosystemPlayInner />}
    </BrowserOnly>
  );
}
