...
import styles from './ProgrammingTasksPlay.module.css';
...
export default function ProgrammingTasksPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка карты задач…')}>
      {() => <ProgrammingTasksPlayInner {...props} />}
    </BrowserOnly>
  );
}
