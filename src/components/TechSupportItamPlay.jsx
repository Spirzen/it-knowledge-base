...
import {ITAM_LIFECYCLE, licenseBalance} from './shared/techSupportEngines';
...
export default function TechSupportItamPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо ITAM…')}>
      {() => <TechSupportItamPlayInner />}
    </BrowserOnly>
  );
}
