...
import styles from './SystemRequirementsComparePlay.module.css';
...
export default function SystemRequirementsComparePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка калькулятора требований…')}>
      {() => <SystemRequirementsComparePlayInner />}
    </BrowserOnly>
  );
}
