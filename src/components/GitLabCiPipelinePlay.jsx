...
import {GITLAB_EXECUTORS, GITLAB_STAGES, gitlabStageStatus} from './shared/devopsCiCdEngines';
...
export default function GitLabCiPipelinePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback()}>
      {() => <GitLabCiPipelinePlayInner />}
    </BrowserOnly>
  );
}
