...
import styles from './WebAppArchitecturePlay.module.css';
...
export default function WebAppArchitecturePlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо архитектуры…')}>
      {() => <WebAppArchitecturePlayInner />}
    </BrowserOnly>
  );
}
