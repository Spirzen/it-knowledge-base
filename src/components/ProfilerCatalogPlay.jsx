...
import {PROFILER_FILTERS, PROFILERS} from './shared/toolsTestingData';
...
export default function ProfilerCatalogPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка профилировщиков…')}>
      {() => <ProfilerCatalogPlayInner />}
    </BrowserOnly>
  );
}
