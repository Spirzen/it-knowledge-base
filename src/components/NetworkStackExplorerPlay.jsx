...
import {
  ...
  getPathSteps,
  getVariantMeta,
} from './shared/networkStackExplorerEngine';
import styles from './NetworkStackExplorerPlay.module.css';
...
export default function NetworkStackExplorerPlay(props) {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка демо…')}>
      {() => <NetworkStackExplorerPlayInner {...props} />}
    </BrowserOnly>
  );
}
