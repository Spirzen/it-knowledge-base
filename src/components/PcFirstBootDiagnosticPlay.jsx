...
import {SYMPTOMS, checksForSymptom} from './shared/pcBootDiagnosticEngine';
import styles from './PcFirstBootDiagnosticPlay.module.css';
...
export default function PcFirstBootDiagnosticPlay() {
  return (
    <BrowserOnly fallback={demoLoadingFallback('Загрузка диагностики…')}>
      {() => <PcFirstBootDiagnosticPlayInner />}
    </BrowserOnly>
  );
}
