  ...
  return (
    <header className={clsx('hero', styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          Это бесплатный и открытый <Link to="/about/project">проект</Link>, который я веду в одиночку, на чистом энтузиазме, уже несколько лет.
...
function HomepageTabs() {
  return (
    <section className="margin-vert--xl container">
      ...
      <details>
        <summary><strong>Система и сеть</strong></summary>
      ...
      <details>
        <summary><strong>Программирование</strong></summary>
