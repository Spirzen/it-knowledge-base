    ...
    <header className={clsx('hero', styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          Единый и ультимативный гайд, который позволит изучить сферу IT в максимально полном объёме. 
          Здесь можно научиться всем аспектам компьютеров, приложений и технологий, читать и писать код 
          на нескольких языках, обучиться анализу, тестированию и даже информационной безопасности.
        </p>
        <div className={styles.buttons}>
          <Link
            className="button button--primary button--lg"
            to="/docs/1. Основы/1.01. Давайте познакомимся">
            🚀 Начать изучение
          </Link>
          <Link
        ...
        <div className={styles.author}>
          ...
          <p>📚 Открытая база знаний для всех</p>
        </div>
      </div>
    </header>
  );
